...
type ItemUseBuffData struct {
	...
	ConsumeTag               []string `json:"ConsumeTag"`  // 增益效果
	...
	PreviewHPRecoveryPercent float32  `json:"PreviewHPRecoveryPercent"` // 回血百分比
	PreviewHPRecoveryValue   uint32   `json:"PreviewHPRecoveryValue"`   // 回血数值
