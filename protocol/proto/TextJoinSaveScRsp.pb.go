...
type TextJoinSaveScRsp struct {
	...
	TextItemConfigId uint32 `protobuf:"varint,12,opt,name=text_item_config_id,json=textItemConfigId,proto3" json:"text_item_config_id,omitempty"`
	TextItemId       uint32 `protobuf:"varint,13,opt,name=text_item_id,json=textItemId,proto3" json:"text_item_id,omitempty"`
	Retcode          uint32 `protobuf:"varint,15,opt,name=retcode,proto3" json:"retcode,omitempty"`
	FJFBPABNBBL      string `protobuf:"bytes,8,opt,name=FJFBPABNBBL,proto3" json:"FJFBPABNBBL,omitempty"`
}
...
func (x *TextJoinSaveScRsp) GetFJFBPABNBBL() string {
	if x != nil {
...
var file_TextJoinSaveScRsp_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x74, 0x65,
	0x78, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x64, 0x12, 0x20,
	0x0a, 0x0c, 0x74, 0x65, 0x78, 0x74, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x0d,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x74, 0x65, 0x78, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x64,
	...
	0x46, 0x42, 0x50, 0x41, 0x42, 0x4e, 0x42, 0x42, 0x4c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x46, 0x4a, 0x46, 0x42, 0x50, 0x41, 0x42, 0x4e, 0x42, 0x42, 0x4c, 0x42, 0x2e, 0x5a, 0x0e,
