...
type RevcMsgScNotify struct {
	...
	ExtraId     uint32       `protobuf:"varint,2,opt,name=extra_id,json=extraId,proto3" json:"extra_id,omitempty"`
	SourceUid   uint32       `protobuf:"varint,12,opt,name=source_uid,json=sourceUid,proto3" json:"source_uid,omitempty"`
	OHINLDBELBA *MNMEBDFAJJP `protobuf:"bytes,8,opt,name=OHINLDBELBA,proto3" json:"OHINLDBELBA,omitempty"`
	TargetUid   uint32       `protobuf:"varint,9,opt,name=target_uid,json=targetUid,proto3" json:"target_uid,omitempty"`
	ChatType    ChatType     `protobuf:"varint,5,opt,name=chat_type,json=chatType,proto3,enum=ChatType" json:"chat_type,omitempty"`
}
...
func (x *RevcMsgScNotify) GetOHINLDBELBA() *MNMEBDFAJJP {
	if x != nil {
...
var file_RevcMsgScNotify_proto_rawDesc = []byte{
	...
	0x4a, 0x4a, 0x50, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x92, 0x02, 0x0a, 0x0f, 0x52, 0x65,
	...
	,
...
var file_RevcMsgScNotify_proto_depIdxs = []int32{
	...
	2, // 1: RevcMsgScNotify.OHINLDBELBA:type_name -> MNMEBDFAJJP
