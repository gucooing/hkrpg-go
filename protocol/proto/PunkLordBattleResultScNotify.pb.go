...
type PunkLordBattleResultScNotify struct {
	...
	CDAJGLIIBII *PunkLordBattleRecord     `protobuf:"bytes,14,opt,name=CDAJGLIIBII,proto3" json:"CDAJGLIIBII,omitempty"`
	JHGANKBJGCG uint32                    `protobuf:"varint,6,opt,name=JHGANKBJGCG,proto3" json:"JHGANKBJGCG,omitempty"`
	GPIPJMPLECH uint32                    `protobuf:"varint,9,opt,name=GPIPJMPLECH,proto3" json:"GPIPJMPLECH,omitempty"`
	IOEBEBCENHO *PunkLordMonsterBasicInfo `protobuf:"bytes,1,opt,name=IOEBEBCENHO,proto3" json:"IOEBEBCENHO,omitempty"`
	GOCJFIAEMKB uint32                    `protobuf:"varint,12,opt,name=GOCJFIAEMKB,proto3" json:"GOCJFIAEMKB,omitempty"`
}
...
func (x *PunkLordBattleResultScNotify) GetCDAJGLIIBII() *PunkLordBattleRecord {
	if x != nil {
...
func (x *PunkLordBattleResultScNotify) GetJHGANKBJGCG() uint32 {
	if x != nil {
		return x.JHGANKBJGCG
	}
	return 0
}

func (x *PunkLordBattleResultScNotify) GetGPIPJMPLECH() uint32 {
	if x != nil {
		return x.GPIPJMPLECH
	}
	return 0
}

func (x *PunkLordBattleResultScNotify) GetIOEBEBCENHO() *PunkLordMonsterBasicInfo {
	if x != nil {
...
func (x *PunkLordBattleResultScNotify) GetGOCJFIAEMKB() uint32 {
	if x != nil {
...
var file_PunkLordBattleResultScNotify_proto_rawDesc = []byte{
	...
	,
...
var file_PunkLordBattleResultScNotify_proto_depIdxs = []int32{
	1, // 0: PunkLordBattleResultScNotify.CDAJGLIIBII:type_name -> PunkLordBattleRecord
	2, // 1: PunkLordBattleResultScNotify.IOEBEBCENHO:type_name -> PunkLordMonsterBasicInfo
