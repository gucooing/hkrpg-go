...
type PunkLordBattleResultScNotify struct {
	...
	CDEHHIICPNL *IIJAAJCJNJI          `protobuf:"bytes,2,opt,name=CDEHHIICPNL,proto3" json:"CDEHHIICPNL,omitempty"`
	AIGDHIJOGKG *PunkLordBattleRecord `protobuf:"bytes,15,opt,name=AIGDHIJOGKG,proto3" json:"AIGDHIJOGKG,omitempty"`
	EINPOOOCFJD uint32                `protobuf:"varint,14,opt,name=EINPOOOCFJD,proto3" json:"EINPOOOCFJD,omitempty"`
	DEBJINDCIBB uint32                `protobuf:"varint,12,opt,name=DEBJINDCIBB,proto3" json:"DEBJINDCIBB,omitempty"`
	HHAACPNMAOL uint32                `protobuf:"varint,1,opt,name=HHAACPNMAOL,proto3" json:"HHAACPNMAOL,omitempty"`
}
...
func (x *PunkLordBattleResultScNotify) GetCDEHHIICPNL() *IIJAAJCJNJI {
	if x != nil {
...
func (x *PunkLordBattleResultScNotify) GetAIGDHIJOGKG() *PunkLordBattleRecord {
	if x != nil {
...
func (x *PunkLordBattleResultScNotify) GetEINPOOOCFJD() uint32 {
	if x != nil {
		return x.EINPOOOCFJD
	}
	return 0
}

func (x *PunkLordBattleResultScNotify) GetDEBJINDCIBB() uint32 {
	if x != nil {
		return x.DEBJINDCIBB
	}
	return 0
}

func (x *PunkLordBattleResultScNotify) GetHHAACPNMAOL() uint32 {
	if x != nil {
		return x.HHAACPNMAOL
	}
	return 0
}
...
var file_PunkLordBattleResultScNotify_proto_rawDesc = []byte{
	...
	0x49, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1a, 0x50, 0x75, 0x6e, 0x6b, 0x4c, 0x6f, 0x72,
	0x64, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x70, 0x72,
	...
	,
...
var file_PunkLordBattleResultScNotify_proto_depIdxs = []int32{
	1, // 0: PunkLordBattleResultScNotify.CDEHHIICPNL:type_name -> IIJAAJCJNJI
	2, // 1: PunkLordBattleResultScNotify.AIGDHIJOGKG:type_name -> PunkLordBattleRecord
