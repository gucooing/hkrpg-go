...
type RogueScoreRewardInfo struct {
	...
	PoolRefreshed        bool     `protobuf:"varint,14,opt,name=pool_refreshed,json=poolRefreshed,proto3" json:"pool_refreshed,omitempty"` //guess
	BeginTime            int64    `protobuf:"varint,2,opt,name=begin_time,json=beginTime,proto3" json:"begin_time,omitempty"`              // guess, either this or end_time
	EndTime              int64    `protobuf:"varint,5,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`                    // guess, either this or begin_time
	HasTakenReward       []uint32 `protobuf:"varint,3,rep,packed,name=has_taken_reward,json=hasTakenReward,proto3" json:"has_taken_reward,omitempty"`
	...
	HasTakenInitialScore bool     `protobuf:"varint,7,opt,name=has_taken_initial_score,json=hasTakenInitialScore,proto3" json:"has_taken_initial_score,omitempty"` //guess
}
...
var file_RogueScoreRewardInfo_proto_rawDesc = []byte{
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x70,
	0x6f, 0x6f, 0x6c, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x68, 0x61, 0x73, 0x5f, 0x74, 0x61,
	0x6b, 0x65, 0x6e, 0x5f, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d,
	...
	0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x69,
	0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x70, 0x6f, 0x6f, 0x6c, 0x49, 0x64, 0x12,
	0x35, 0x0a, 0x17, 0x68, 0x61, 0x73, 0x5f, 0x74, 0x61, 0x6b, 0x65, 0x6e, 0x5f, 0x69, 0x6e, 0x69,
	0x74, 0x69, 0x61, 0x6c, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x14, 0x68, 0x61, 0x73, 0x54, 0x61, 0x6b, 0x65, 0x6e, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61,
