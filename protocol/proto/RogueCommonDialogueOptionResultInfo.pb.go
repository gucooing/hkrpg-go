...
type RogueCommonDialogueOptionResultInfo struct {
	...
	// Types that are assignable to OptionResultInfo:
	//
	//	*RogueCommonDialogueOptionResultInfo_BattleResultInfo
	//	*RogueCommonDialogueOptionResultInfo_OFOOEMCPEKH
	OptionResultInfo isRogueCommonDialogueOptionResultInfo_OptionResultInfo `protobuf_oneof:"option_result_info"`
}
...
func (m *RogueCommonDialogueOptionResultInfo) GetOptionResultInfo() isRogueCommonDialogueOptionResultInfo_OptionResultInfo {
	if m != nil {
		return m.OptionResultInfo
	}
	return nil
}

func (x *RogueCommonDialogueOptionResultInfo) GetBattleResultInfo() *RogueCommonDialogueOptionBattleResultInfo {
	if x, ok := x.GetOptionResultInfo().(*RogueCommonDialogueOptionResultInfo_BattleResultInfo); ok {
		return x.BattleResultInfo
	}
	return nil
}

func (x *RogueCommonDialogueOptionResultInfo) GetOFOOEMCPEKH() *GBIJFBKMOHL {
	if x, ok := x.GetOptionResultInfo().(*RogueCommonDialogueOptionResultInfo_OFOOEMCPEKH); ok {
		return x.OFOOEMCPEKH
	}
	return nil
}

type isRogueCommonDialogueOptionResultInfo_OptionResultInfo interface {
	isRogueCommonDialogueOptionResultInfo_OptionResultInfo()
}

type RogueCommonDialogueOptionResultInfo_BattleResultInfo struct {
	BattleResultInfo *RogueCommonDialogueOptionBattleResultInfo `protobuf:"bytes,1,opt,name=battle_result_info,json=battleResultInfo,proto3,oneof"`
}

type RogueCommonDialogueOptionResultInfo_OFOOEMCPEKH struct {
	OFOOEMCPEKH *GBIJFBKMOHL `protobuf:"bytes,12,opt,name=OFOOEMCPEKH,proto3,oneof"`
}

func (*RogueCommonDialogueOptionResultInfo_BattleResultInfo) isRogueCommonDialogueOptionResultInfo_OptionResultInfo() {
}

func (*RogueCommonDialogueOptionResultInfo_OFOOEMCPEKH) isRogueCommonDialogueOptionResultInfo_OptionResultInfo() {
}
...
var file_RogueCommonDialogueOptionResultInfo_proto_rawDesc = []byte{
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x47, 0x42, 0x49,
	0x4a, 0x46, 0x42, 0x4b, 0x4d, 0x4f, 0x48, 0x4c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2f,
	...
	0xc9, 0x01, 0x0a, 0x23, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x44,
	...
	0x65, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20,
	...
	0x6e, 0x66, 0x6f, 0x12, 0x30, 0x0a, 0x0b, 0x4f, 0x46, 0x4f, 0x4f, 0x45, 0x4d, 0x43, 0x50, 0x45,
	0x4b, 0x48, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x47, 0x42, 0x49, 0x4a, 0x46,
	0x42, 0x4b, 0x4d, 0x4f, 0x48, 0x4c, 0x48, 0x00, 0x52, 0x0b, 0x4f, 0x46, 0x4f, 0x4f, 0x45, 0x4d,
	0x43, 0x50, 0x45, 0x4b, 0x48, 0x42, 0x14, 0x0a, 0x12, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x42, 0x2e, 0x5a, 0x0e, 0x2e,
...
var file_RogueCommonDialogueOptionResultInfo_proto_depIdxs = []int32{
	...
	2, // 1: RogueCommonDialogueOptionResultInfo.OFOOEMCPEKH:type_name -> GBIJFBKMOHL
...
func file_RogueCommonDialogueOptionResultInfo_proto_init() {
	...
	file_RogueCommonDialogueOptionResultInfo_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*RogueCommonDialogueOptionResultInfo_OFOOEMCPEKH)(nil),
	}
	type x struct{}
