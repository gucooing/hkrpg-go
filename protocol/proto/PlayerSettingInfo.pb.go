...
type PlayerSettingInfo struct {
	...
	NODHLKCFLPA bool `protobuf:"varint,8,opt,name=NODHLKCFLPA,proto3" json:"NODHLKCFLPA,omitempty"`
	HMAMGFJANGO bool `protobuf:"varint,14,opt,name=HMAMGFJANGO,proto3" json:"HMAMGFJANGO,omitempty"`
	PMBBEIEHBML bool `protobuf:"varint,7,opt,name=PMBBEIEHBML,proto3" json:"PMBBEIEHBML,omitempty"`
}
...
func (x *PlayerSettingInfo) GetNODHLKCFLPA() bool {
	if x != nil {
		return x.NODHLKCFLPA
	}
	return false
}

func (x *PlayerSettingInfo) GetHMAMGFJANGO() bool {
	if x != nil {
		return x.HMAMGFJANGO
	}
	return false
}

func (x *PlayerSettingInfo) GetPMBBEIEHBML() bool {
	if x != nil {
		return x.PMBBEIEHBML
	}
	return false
}
...
var file_PlayerSettingInfo_proto_rawDesc = []byte{
	...
	,
