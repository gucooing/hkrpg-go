...
type ChessRogueSelectCellScRsp struct {
	...
	SelectMonsterId uint32       `protobuf:"varint,3,opt,name=select_monster_id,json=selectMonsterId,proto3" json:"select_monster_id,omitempty"`
	...
	LKDPIFPCPCO     *MHFCAOLCAHC `protobuf:"bytes,11,opt,name=LKDPIFPCPCO,proto3" json:"LKDPIFPCPCO,omitempty"`
}
...
func (x *ChessRogueSelectCellScRsp) GetLKDPIFPCPCO() *MHFCAOLCAHC {
	if x != nil {
		return x.LKDPIFPCPCO
	}
	return nil
}
...
var file_ChessRogueSelectCellScRsp_proto_rawDesc = []byte{
	...
	0x6f, 0x1a, 0x11, 0x4d, 0x48, 0x46, 0x43, 0x41, 0x4f, 0x4c, 0x43, 0x41, 0x48, 0x43, 0x2e, 0x70,
	...
	0x73, 0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x73,
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x4d, 0x6f, 0x6e, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x12, 0x17,
	0x0a, 0x07, 0x63, 0x65, 0x6c, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x65, 0x12, 0x2e, 0x0a, 0x0b, 0x4c, 0x4b, 0x44, 0x50, 0x49, 0x46, 0x50, 0x43, 0x50, 0x43, 0x4f,
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x4d, 0x48, 0x46, 0x43, 0x41, 0x4f, 0x4c,
	0x43, 0x41, 0x48, 0x43, 0x52, 0x0b, 0x4c, 0x4b, 0x44, 0x50, 0x49, 0x46, 0x50, 0x43, 0x50, 0x43,
...
var file_ChessRogueSelectCellScRsp_proto_goTypes = []interface{}{
	...
	(*MHFCAOLCAHC)(nil),               // 1: MHFCAOLCAHC
}
var file_ChessRogueSelectCellScRsp_proto_depIdxs = []int32{
	1, // 0: ChessRogueSelectCellScRsp.LKDPIFPCPCO:type_name -> MHFCAOLCAHC
