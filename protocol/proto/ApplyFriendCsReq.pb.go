...
type ApplyFriendCsReq struct {
	...
	Source FriendApplySource `protobuf:"varint,8,opt,name=source,proto3,enum=FriendApplySource" json:"source,omitempty"`
...
var file_ApplyFriendCsReq_proto_rawDesc = []byte{
	...
	0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x41, 0x70,
