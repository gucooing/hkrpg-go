...
type GetRaidInfoScRsp struct {
	...
	ChallengeTakenRewardIdList []uint32            `protobuf:"varint,11,rep,packed,name=challenge_taken_reward_id_list,json=challengeTakenRewardIdList,proto3" json:"challenge_taken_reward_id_list,omitempty"`
	ChallengeRaidList          []*ChallengeRaid    `protobuf:"bytes,6,rep,name=challenge_raid_list,json=challengeRaidList,proto3" json:"challenge_raid_list,omitempty"`
	FinishedRaidInfoList       []*FinishedRaidInfo `protobuf:"bytes,10,rep,name=finished_raid_info_list,json=finishedRaidInfoList,proto3" json:"finished_raid_info_list,omitempty"`
...
var file_GetRaidInfoScRsp_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x43, 0x68,
