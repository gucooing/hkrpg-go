...
type OpenRogueChestScRsp struct {
	...
	DropData *ItemList `protobuf:"bytes,15,opt,name=drop_data,json=dropData,proto3" json:"drop_data,omitempty"`
...
var file_OpenRogueChestScRsp_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x64, 0x65, 0x12, 0x21, 0x0a, 0x06, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x18, 0x06,
