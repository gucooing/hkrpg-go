...
type RogueAeonInfo struct {
	...
	IsUnlocked    bool     `protobuf:"varint,1,opt,name=is_unlocked,json=isUnlocked,proto3" json:"is_unlocked,omitempty"`             // guess
	UnlockAeonNum uint32   `protobuf:"varint,15,opt,name=unlock_aeon_num,json=unlockAeonNum,proto3" json:"unlock_aeon_num,omitempty"` // 9
	JPEBPGIEGPO   uint32   `protobuf:"varint,14,opt,name=JPEBPGIEGPO,proto3" json:"JPEBPGIEGPO,omitempty"`                            // 3
}
...
func (x *RogueAeonInfo) GetJPEBPGIEGPO() uint32 {
	if x != nil {
		return x.JPEBPGIEGPO
	}
	return 0
}
...
var file_RogueAeonInfo_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x55, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x75, 0x6e,
	...
	0x75, 0x6d, 0x12, 0x20, 0x0a, 0x0b, 0x4a, 0x50, 0x45, 0x42, 0x50, 0x47, 0x49, 0x45, 0x47, 0x50,
	0x4f, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x50, 0x45, 0x42, 0x50, 0x47, 0x49,
	0x45, 0x47, 0x50, 0x4f, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f,
