...
type RogueTournDifficultyCompNotify struct {
	...
	PFMBJEOIPBM []uint32 `protobuf:"varint,3,rep,packed,name=PFMBJEOIPBM,proto3" json:"PFMBJEOIPBM,omitempty"`
}
...
func (x *RogueTournDifficultyCompNotify) GetPFMBJEOIPBM() []uint32 {
	if x != nil {
		return x.PFMBJEOIPBM
	}
	return nil
}
...
var file_RogueTournDifficultyCompNotify_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x46, 0x4d, 0x42,
	0x4a, 0x45, 0x4f, 0x49, 0x50, 0x42, 0x4d, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x50,
	0x46, 0x4d, 0x42, 0x4a, 0x45, 0x4f, 0x49, 0x50, 0x42, 0x4d, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e,
