...
type RogueWorkbenchSelectFuncScRsp struct {
	...
	TargetFuncInfo  *WorkbenchFuncInfo `protobuf:"bytes,7,opt,name=target_func_info,json=targetFuncInfo,proto3" json:"target_func_info,omitempty"`
	WorkbenchFuncId uint32             `protobuf:"varint,15,opt,name=workbench_func_id,json=workbenchFuncId,proto3" json:"workbench_func_id,omitempty"`
...
func (x *RogueWorkbenchSelectFuncScRsp) GetTargetFuncInfo() *WorkbenchFuncInfo {
	if x != nil {
...
func (x *RogueWorkbenchSelectFuncScRsp) GetWorkbenchFuncId() uint32 {
	if x != nil {
...
var file_RogueWorkbenchSelectFuncScRsp_proto_rawDesc = []byte{
	...
	0x68, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x46, 0x75, 0x6e, 0x63, 0x53, 0x63, 0x52, 0x73, 0x70,
	0x12, 0x3c, 0x0a, 0x10, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x66, 0x75, 0x6e, 0x63, 0x5f,
	0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x57, 0x6f, 0x72,
	...
	0x5f, 0x69, 0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x77, 0x6f, 0x72, 0x6b, 0x62,
...
var file_RogueWorkbenchSelectFuncScRsp_proto_depIdxs = []int32{
	1, // 0: RogueWorkbenchSelectFuncScRsp.target_func_info:type_name -> WorkbenchFuncInfo
