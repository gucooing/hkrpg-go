...
type GetMultiPathAvatarInfoScRsp struct {
	...
	MultiPathAvatarInfoList []*MultiPathAvatarInfo         `protobuf:"bytes,7,rep,name=multi_path_avatar_info_list,json=multiPathAvatarInfoList,proto3" json:"multi_path_avatar_info_list,omitempty"`
	Retcode                 uint32                         `protobuf:"varint,8,opt,name=retcode,proto3" json:"retcode,omitempty"`
	CurAvatarPath           map[uint32]MultiPathAvatarType `protobuf:"bytes,5,rep,name=cur_avatar_path,json=curAvatarPath,proto3" json:"cur_avatar_path,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=MultiPathAvatarType"`
}
...
var file_GetMultiPathAvatarInfoScRsp_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0f, 0x62, 0x61, 0x73, 0x69, 0x63, 0x54, 0x79, 0x70, 0x65,
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x4d, 0x75,
	...
	0x61, 0x72, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e,
