...
type GetPhoneDataScRsp struct {
	...
	OwnedPhoneThemes []uint32 `protobuf:"varint,8,rep,packed,name=owned_phone_themes,json=ownedPhoneThemes,proto3" json:"owned_phone_themes,omitempty"` // 1
	CurPhoneTheme    uint32   `protobuf:"varint,6,opt,name=cur_phone_theme,json=curPhoneTheme,proto3" json:"cur_phone_theme,omitempty"`
	Retcode          uint32   `protobuf:"varint,4,opt,name=retcode,proto3" json:"retcode,omitempty"`
	OwnedChatBubbles []uint32 `protobuf:"varint,1,rep,packed,name=owned_chat_bubbles,json=ownedChatBubbles,proto3" json:"owned_chat_bubbles,omitempty"` // 8
}
...
var file_GetPhoneDataScRsp_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x63, 0x75, 0x72, 0x43, 0x68, 0x61,
	0x74, 0x42, 0x75, 0x62, 0x62, 0x6c, 0x65, 0x12, 0x2c, 0x0a, 0x12, 0x6f, 0x77, 0x6e, 0x65, 0x64,
	0x5f, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x5f, 0x74, 0x68, 0x65, 0x6d, 0x65, 0x73, 0x18, 0x08, 0x20,
	...
	0x6e, 0x65, 0x5f, 0x74, 0x68, 0x65, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d,
	...
	0x5f, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x62, 0x75, 0x62, 0x62, 0x6c, 0x65, 0x73, 0x18, 0x01, 0x20,
