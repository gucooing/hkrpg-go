...
type MultiplayerMatch3FinishScNotify struct {
	...
	HPMEBECHEEN uint32       `protobuf:"varint,11,opt,name=HPMEBECHEEN,proto3" json:"HPMEBECHEEN,omitempty"`
	JOKEIGFCDOI *MLBKADJEBNA `protobuf:"bytes,3,opt,name=JOKEIGFCDOI,proto3" json:"JOKEIGFCDOI,omitempty"`
	GIBBAHJJDIJ uint32       `protobuf:"varint,2,opt,name=GIBBAHJJDIJ,proto3" json:"GIBBAHJJDIJ,omitempty"`
	Reason      JPEDGMMIIFJ  `protobuf:"varint,6,opt,name=reason,proto3,enum=JPEDGMMIIFJ" json:"reason,omitempty"`
}
...
func (x *MultiplayerMatch3FinishScNotify) GetHPMEBECHEEN() uint32 {
	if x != nil {
		return x.HPMEBECHEEN
	}
	return 0
}

func (x *MultiplayerMatch3FinishScNotify) GetJOKEIGFCDOI() *MLBKADJEBNA {
	if x != nil {
...
func (x *MultiplayerMatch3FinishScNotify) GetGIBBAHJJDIJ() uint32 {
	if x != nil {
		return x.GIBBAHJJDIJ
	}
	return 0
}

func (x *MultiplayerMatch3FinishScNotify) GetReason() JPEDGMMIIFJ {
	if x != nil {
		return x.Reason
	}
	return JPEDGMMIIFJ_MATCH3_FINISH_REASON_DEFAULT
}
...
var file_MultiplayerMatch3FinishScNotify_proto_rawDesc = []byte{
	...
	,
...
var file_MultiplayerMatch3FinishScNotify_proto_goTypes = []interface{}{
	...
	(*MLBKADJEBNA)(nil),                     // 1: MLBKADJEBNA
	(JPEDGMMIIFJ)(0),                        // 2: JPEDGMMIIFJ
}
var file_MultiplayerMatch3FinishScNotify_proto_depIdxs = []int32{
	1, // 0: MultiplayerMatch3FinishScNotify.JOKEIGFCDOI:type_name -> MLBKADJEBNA
	2, // 1: MultiplayerMatch3FinishScNotify.reason:type_name -> JPEDGMMIIFJ
