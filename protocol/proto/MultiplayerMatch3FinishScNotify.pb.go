...
type MultiplayerMatch3FinishScNotify struct {
	...
	Reason      Match3FinishReason `protobuf:"varint,1,opt,name=reason,proto3,enum=Match3FinishReason" json:"reason,omitempty"`
	GDLOCKKLLIK uint32             `protobuf:"varint,9,opt,name=GDLOCKKLLIK,proto3" json:"GDLOCKKLLIK,omitempty"`
	IMKELKMHOIK *DHPIFKICOPP       `protobuf:"bytes,8,opt,name=IMKELKMHOIK,proto3" json:"IMKELKMHOIK,omitempty"`
	GBGHPFLHDBP uint32             `protobuf:"varint,7,opt,name=GBGHPFLHDBP,proto3" json:"GBGHPFLHDBP,omitempty"`
}
...
func (x *MultiplayerMatch3FinishScNotify) GetGDLOCKKLLIK() uint32 {
	if x != nil {
		return x.GDLOCKKLLIK
	}
	return 0
}

func (x *MultiplayerMatch3FinishScNotify) GetIMKELKMHOIK() *DHPIFKICOPP {
	if x != nil {
...
func (x *MultiplayerMatch3FinishScNotify) GetGBGHPFLHDBP() uint32 {
	if x != nil {
		return x.GBGHPFLHDBP
	}
	return 0
}
...
var file_MultiplayerMatch3FinishScNotify_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x44, 0x48, 0x50, 0x49, 0x46, 0x4b, 0x49,
	0x43, 0x4f, 0x50, 0x50, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x18, 0x4d, 0x61, 0x74, 0x63,
	...
	,
...
var file_MultiplayerMatch3FinishScNotify_proto_depIdxs = []int32{
	...
	2, // 1: MultiplayerMatch3FinishScNotify.IMKELKMHOIK:type_name -> DHPIFKICOPP
