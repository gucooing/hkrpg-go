...
type UpdatePsnSettingsInfoCsReq struct {
	...
	// Types that are assignable to KIJAALEBHPJ:
	//
	//	*UpdatePsnSettingsInfoCsReq_AKJFADFKBDJ
	//	*UpdatePsnSettingsInfoCsReq_NFAMEILPPGI
	KIJAALEBHPJ isUpdatePsnSettingsInfoCsReq_KIJAALEBHPJ `protobuf_oneof:"KIJAALEBHPJ"`
}
...
func (m *UpdatePsnSettingsInfoCsReq) GetKIJAALEBHPJ() isUpdatePsnSettingsInfoCsReq_KIJAALEBHPJ {
	if m != nil {
		return m.KIJAALEBHPJ
	}
	return nil
}

func (x *UpdatePsnSettingsInfoCsReq) GetAKJFADFKBDJ() *MKCDFIIKEPP {
	if x, ok := x.GetKIJAALEBHPJ().(*UpdatePsnSettingsInfoCsReq_AKJFADFKBDJ); ok {
		return x.AKJFADFKBDJ
	}
	return nil
}

func (x *UpdatePsnSettingsInfoCsReq) GetNFAMEILPPGI() *GIBBJHPOHGE {
	if x, ok := x.GetKIJAALEBHPJ().(*UpdatePsnSettingsInfoCsReq_NFAMEILPPGI); ok {
		return x.NFAMEILPPGI
	}
	return nil
}

type isUpdatePsnSettingsInfoCsReq_KIJAALEBHPJ interface {
	isUpdatePsnSettingsInfoCsReq_KIJAALEBHPJ()
}

type UpdatePsnSettingsInfoCsReq_AKJFADFKBDJ struct {
	AKJFADFKBDJ *MKCDFIIKEPP `protobuf:"bytes,1139,opt,name=AKJFADFKBDJ,proto3,oneof"`
}

type UpdatePsnSettingsInfoCsReq_NFAMEILPPGI struct {
	NFAMEILPPGI *GIBBJHPOHGE `protobuf:"bytes,1429,opt,name=NFAMEILPPGI,proto3,oneof"`
}

func (*UpdatePsnSettingsInfoCsReq_AKJFADFKBDJ) isUpdatePsnSettingsInfoCsReq_KIJAALEBHPJ() {}

func (*UpdatePsnSettingsInfoCsReq_NFAMEILPPGI) isUpdatePsnSettingsInfoCsReq_KIJAALEBHPJ() {}
...
var file_UpdatePsnSettingsInfoCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_UpdatePsnSettingsInfoCsReq_proto_goTypes = []interface{}{
	...
	(*MKCDFIIKEPP)(nil),                // 1: MKCDFIIKEPP
	(*GIBBJHPOHGE)(nil),                // 2: GIBBJHPOHGE
}
var file_UpdatePsnSettingsInfoCsReq_proto_depIdxs = []int32{
	1, // 0: UpdatePsnSettingsInfoCsReq.AKJFADFKBDJ:type_name -> MKCDFIIKEPP
	2, // 1: UpdatePsnSettingsInfoCsReq.NFAMEILPPGI:type_name -> GIBBJHPOHGE
...
func file_UpdatePsnSettingsInfoCsReq_proto_init() {
	...
	file_MKCDFIIKEPP_proto_init()
	file_GIBBJHPOHGE_proto_init()
	if !protoimpl.UnsafeEnabled {
	...
	file_UpdatePsnSettingsInfoCsReq_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*UpdatePsnSettingsInfoCsReq_AKJFADFKBDJ)(nil),
		(*UpdatePsnSettingsInfoCsReq_NFAMEILPPGI)(nil),
	}
	type x struct{}
