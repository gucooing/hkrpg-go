...
type ClockParkHandleWaitOperationScRsp struct {
	...
	KELMDDKDNJA ClockParkPlayStatus `protobuf:"varint,6,opt,name=KELMDDKDNJA,proto3,enum=ClockParkPlayStatus" json:"KELMDDKDNJA,omitempty"`
	Retcode     uint32              `protobuf:"varint,13,opt,name=retcode,proto3" json:"retcode,omitempty"`
	HIAGEINLAHL uint32              `protobuf:"varint,8,opt,name=HIAGEINLAHL,proto3" json:"HIAGEINLAHL,omitempty"`
	BattleInfo  *SceneBattleInfo    `protobuf:"bytes,9,opt,name=battle_info,json=battleInfo,proto3" json:"battle_info,omitempty"`
	FGBPANCBLEC uint32              `protobuf:"varint,10,opt,name=FGBPANCBLEC,proto3" json:"FGBPANCBLEC,omitempty"`
	BLPMDKEPMJB uint32              `protobuf:"varint,1,opt,name=BLPMDKEPMJB,proto3" json:"BLPMDKEPMJB,omitempty"`
}
...
func (x *ClockParkHandleWaitOperationScRsp) GetKELMDDKDNJA() ClockParkPlayStatus {
	if x != nil {
		return x.KELMDDKDNJA
	}
...
func (x *ClockParkHandleWaitOperationScRsp) GetHIAGEINLAHL() uint32 {
	if x != nil {
...
func (x *ClockParkHandleWaitOperationScRsp) GetFGBPANCBLEC() uint32 {
	if x != nil {
		return x.FGBPANCBLEC
	}
	return 0
}

func (x *ClockParkHandleWaitOperationScRsp) GetBLPMDKEPMJB() uint32 {
	if x != nil {
		return x.BLPMDKEPMJB
	}
	return 0
}
...
var file_ClockParkHandleWaitOperationScRsp_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x74, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x47, 0x42, 0x50,
	0x41, 0x4e, 0x43, 0x42, 0x4c, 0x45, 0x43, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x46,
	0x47, 0x42, 0x50, 0x41, 0x4e, 0x43, 0x42, 0x4c, 0x45, 0x43, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x4c,
	0x50, 0x4d, 0x44, 0x4b, 0x45, 0x50, 0x4d, 0x4a, 0x42, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x42, 0x4c, 0x50, 0x4d, 0x44, 0x4b, 0x45, 0x50, 0x4d, 0x4a, 0x42, 0x42, 0x2e, 0x5a, 0x0e,
...
var file_ClockParkHandleWaitOperationScRsp_proto_depIdxs = []int32{
	1, // 0: ClockParkHandleWaitOperationScRsp.KELMDDKDNJA:type_name -> ClockParkPlayStatus
