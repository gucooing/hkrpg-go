...
type FeverTimeActivityBattleEndScNotify struct {
	...
	PCCBJINOHBC FeverTimeBattleRank `protobuf:"varint,12,opt,name=PCCBJINOHBC,proto3,enum=FeverTimeBattleRank" json:"PCCBJINOHBC,omitempty"`
	LCPIPJLKGEK uint32              `protobuf:"varint,7,opt,name=LCPIPJLKGEK,proto3" json:"LCPIPJLKGEK,omitempty"`
	Id          uint32              `protobuf:"varint,11,opt,name=id,proto3" json:"id,omitempty"`
	GIGKNPFCKNB uint32              `protobuf:"varint,4,opt,name=GIGKNPFCKNB,proto3" json:"GIGKNPFCKNB,omitempty"`
}
...
func (x *FeverTimeActivityBattleEndScNotify) GetPCCBJINOHBC() FeverTimeBattleRank {
	if x != nil {
		return x.PCCBJINOHBC
	}
	return FeverTimeBattleRank_FEVER_TIME_BATTLE_RANK_C
}

func (x *FeverTimeActivityBattleEndScNotify) GetLCPIPJLKGEK() uint32 {
	if x != nil {
		return x.LCPIPJLKGEK
	}
	return 0
}
...
func (x *FeverTimeActivityBattleEndScNotify) GetGIGKNPFCKNB() uint32 {
	if x != nil {
...
var file_FeverTimeActivityBattleEndScNotify_proto_rawDesc = []byte{
	...
	,
...
var file_FeverTimeActivityBattleEndScNotify_proto_depIdxs = []int32{
	1, // 0: FeverTimeActivityBattleEndScNotify.PCCBJINOHBC:type_name -> FeverTimeBattleRank
