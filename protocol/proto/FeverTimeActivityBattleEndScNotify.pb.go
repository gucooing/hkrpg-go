...
type FeverTimeActivityBattleEndScNotify struct {
	...
	LEKIFOCPGIB uint32              `protobuf:"varint,6,opt,name=LEKIFOCPGIB,proto3" json:"LEKIFOCPGIB,omitempty"`
	Id          uint32              `protobuf:"varint,14,opt,name=id,proto3" json:"id,omitempty"`
	FMFHGAIDDKE FeverTimeBattleRank `protobuf:"varint,12,opt,name=FMFHGAIDDKE,proto3,enum=FeverTimeBattleRank" json:"FMFHGAIDDKE,omitempty"`
	BNEHEBMHOLI uint32              `protobuf:"varint,5,opt,name=BNEHEBMHOLI,proto3" json:"BNEHEBMHOLI,omitempty"`
}
...
func (x *FeverTimeActivityBattleEndScNotify) GetLEKIFOCPGIB() uint32 {
	if x != nil {
...
func (x *FeverTimeActivityBattleEndScNotify) GetFMFHGAIDDKE() FeverTimeBattleRank {
	if x != nil {
		return x.FMFHGAIDDKE
	}
	return FeverTimeBattleRank_FEVER_TIME_BATTLE_RANK_C
}

func (x *FeverTimeActivityBattleEndScNotify) GetBNEHEBMHOLI() uint32 {
	if x != nil {
		return x.BNEHEBMHOLI
	}
	return 0
}
...
var file_FeverTimeActivityBattleEndScNotify_proto_rawDesc = []byte{
	...
	,
...
var file_FeverTimeActivityBattleEndScNotify_proto_depIdxs = []int32{
	1, // 0: FeverTimeActivityBattleEndScNotify.FMFHGAIDDKE:type_name -> FeverTimeBattleRank
