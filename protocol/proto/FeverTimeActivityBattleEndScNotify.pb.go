...
type FeverTimeActivityBattleEndScNotify struct {
	...
	BFADHPMMODP uint32              `protobuf:"varint,2,opt,name=BFADHPMMODP,proto3" json:"BFADHPMMODP,omitempty"`
	Id          uint32              `protobuf:"varint,8,opt,name=id,proto3" json:"id,omitempty"`
	EGPGPJLOHIL FeverTimeBattleRank `protobuf:"varint,1,opt,name=EGPGPJLOHIL,proto3,enum=FeverTimeBattleRank" json:"EGPGPJLOHIL,omitempty"`
	DHFALDJEAAN uint32              `protobuf:"varint,9,opt,name=DHFALDJEAAN,proto3" json:"DHFALDJEAAN,omitempty"`
}
...
func (x *FeverTimeActivityBattleEndScNotify) GetBFADHPMMODP() uint32 {
	if x != nil {
...
func (x *FeverTimeActivityBattleEndScNotify) GetEGPGPJLOHIL() FeverTimeBattleRank {
	if x != nil {
		return x.EGPGPJLOHIL
	}
	return FeverTimeBattleRank_FEVER_TIME_BATTLE_RANK_C
}

func (x *FeverTimeActivityBattleEndScNotify) GetDHFALDJEAAN() uint32 {
	if x != nil {
		return x.DHFALDJEAAN
	}
	return 0
}
...
var file_FeverTimeActivityBattleEndScNotify_proto_rawDesc = []byte{
	...
	,
...
var file_FeverTimeActivityBattleEndScNotify_proto_depIdxs = []int32{
	1, // 0: FeverTimeActivityBattleEndScNotify.EGPGPJLOHIL:type_name -> FeverTimeBattleRank
