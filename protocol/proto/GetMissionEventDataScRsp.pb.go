...
type GetMissionEventDataScRsp struct {
	...
	MissionEventList []*Mission `protobuf:"bytes,9,rep,name=mission_event_list,json=missionEventList,proto3" json:"mission_event_list,omitempty"`
	ChallengeEventId uint32     `protobuf:"varint,4,opt,name=challenge_event_id,json=challengeEventId,proto3" json:"challenge_event_id,omitempty"`
}
...
var file_GetMissionEventDataScRsp_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x03,
	...
	0x6c, 0x65, 0x6e, 0x67, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x42, 0x28, 0x5a, 0x08,
