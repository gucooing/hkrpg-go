...
type RogueRecordInfo struct {
	...
	BuffList    []*RogueBuff         `protobuf:"bytes,1,rep,name=buff_list,json=buffList,proto3" json:"buff_list,omitempty"`
	AvatarList  []*RogueRecordAvatar `protobuf:"bytes,2,rep,name=avatar_list,json=avatarList,proto3" json:"avatar_list,omitempty"`
	MiracleList []uint32             `protobuf:"varint,7,rep,packed,name=miracle_list,json=miracleList,proto3" json:"miracle_list,omitempty"`
}
...
var file_RogueRecordInfo_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x52, 0x6f, 0x67, 0x75, 0x65,
	...
	0x69, 0x73, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x6d, 0x69, 0x72, 0x61, 0x63,
