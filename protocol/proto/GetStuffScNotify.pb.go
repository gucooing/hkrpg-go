...
type GetStuffScNotify struct {
	...
	IBPAGGPKNHJ GetStuffType `protobuf:"varint,11,opt,name=IBPAGGPKNHJ,proto3,enum=GetStuffType" json:"IBPAGGPKNHJ,omitempty"`
	CAPKIANAJIM uint32       `protobuf:"varint,5,opt,name=CAPKIANAJIM,proto3" json:"CAPKIANAJIM,omitempty"`
}
...
func (x *GetStuffScNotify) GetIBPAGGPKNHJ() GetStuffType {
	if x != nil {
		return x.IBPAGGPKNHJ
	}
	return GetStuffType_UNKNOW
}

func (x *GetStuffScNotify) GetCAPKIANAJIM() uint32 {
	if x != nil {
...
var file_GetStuffScNotify_proto_rawDesc = []byte{
	...
	0x12, 0x2f, 0x0a, 0x0b, 0x49, 0x42, 0x50, 0x41, 0x47, 0x47, 0x50, 0x4b, 0x4e, 0x48, 0x4a, 0x18,
	0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x66, 0x66,
	0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x49, 0x42, 0x50, 0x41, 0x47, 0x47, 0x50, 0x4b, 0x4e, 0x48,
	0x4a, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x41, 0x50, 0x4b, 0x49, 0x41, 0x4e, 0x41, 0x4a, 0x49, 0x4d,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x43, 0x41, 0x50, 0x4b, 0x49, 0x41, 0x4e, 0x41,
	0x4a, 0x49, 0x4d, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
...
var file_GetStuffScNotify_proto_depIdxs = []int32{
	1, // 0: GetStuffScNotify.IBPAGGPKNHJ:type_name -> GetStuffType
