...
type GetStuffScNotify struct {
	...
	DGPGBHDBHMJ GetStuffType `protobuf:"varint,5,opt,name=DGPGBHDBHMJ,proto3,enum=GetStuffType" json:"DGPGBHDBHMJ,omitempty"`
	BIIHOBMMFDP uint32       `protobuf:"varint,9,opt,name=BIIHOBMMFDP,proto3" json:"BIIHOBMMFDP,omitempty"`
}
...
func (x *GetStuffScNotify) GetDGPGBHDBHMJ() GetStuffType {
	if x != nil {
		return x.DGPGBHDBHMJ
	}
	return GetStuffType_UNKNOW
}

func (x *GetStuffScNotify) GetBIIHOBMMFDP() uint32 {
	if x != nil {
...
var file_GetStuffScNotify_proto_rawDesc = []byte{
	...
	0x12, 0x2f, 0x0a, 0x0b, 0x44, 0x47, 0x50, 0x47, 0x42, 0x48, 0x44, 0x42, 0x48, 0x4d, 0x4a, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x66, 0x66,
	0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x44, 0x47, 0x50, 0x47, 0x42, 0x48, 0x44, 0x42, 0x48, 0x4d,
	0x4a, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x49, 0x49, 0x48, 0x4f, 0x42, 0x4d, 0x4d, 0x46, 0x44, 0x50,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x49, 0x49, 0x48, 0x4f, 0x42, 0x4d, 0x4d,
	0x46, 0x44, 0x50, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
...
var file_GetStuffScNotify_proto_depIdxs = []int32{
	1, // 0: GetStuffScNotify.DGPGBHDBHMJ:type_name -> GetStuffType
