...
type GetStuffScNotify struct {
	...
	POEDFMELAKE uint32       `protobuf:"varint,6,opt,name=POEDFMELAKE,proto3" json:"POEDFMELAKE,omitempty"`
	CCPAJJMFEKC GetStuffType `protobuf:"varint,10,opt,name=CCPAJJMFEKC,proto3,enum=GetStuffType" json:"CCPAJJMFEKC,omitempty"`
}
...
func (x *GetStuffScNotify) GetPOEDFMELAKE() uint32 {
	if x != nil {
...
func (x *GetStuffScNotify) GetCCPAJJMFEKC() GetStuffType {
	if x != nil {
		return x.CCPAJJMFEKC
	}
...
var file_GetStuffScNotify_proto_rawDesc = []byte{
	...
	0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x4f, 0x45, 0x44, 0x46, 0x4d, 0x45, 0x4c, 0x41,
	0x4b, 0x45, 0x12, 0x2f, 0x0a, 0x0b, 0x43, 0x43, 0x50, 0x41, 0x4a, 0x4a, 0x4d, 0x46, 0x45, 0x4b,
	0x43, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75,
	0x66, 0x66, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x43, 0x43, 0x50, 0x41, 0x4a, 0x4a, 0x4d, 0x46,
	0x45, 0x4b, 0x43, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
...
var file_GetStuffScNotify_proto_depIdxs = []int32{
	1, // 0: GetStuffScNotify.CCPAJJMFEKC:type_name -> GetStuffType
