...
type GetStuffScNotify struct {
	...
	CICPNBCMHOC GetStuffType `protobuf:"varint,1,opt,name=CICPNBCMHOC,proto3,enum=GetStuffType" json:"CICPNBCMHOC,omitempty"`
...
func (x *GetStuffScNotify) GetCICPNBCMHOC() GetStuffType {
	if x != nil {
		return x.CICPNBCMHOC
	}
	return GetStuffType_UNKNOW
}

func (x *GetStuffScNotify) GetDIADHPAHLGC() uint32 {
	if x != nil {
...
var file_GetStuffScNotify_proto_rawDesc = []byte{
	...
	0x12, 0x2f, 0x0a, 0x0b, 0x43, 0x49, 0x43, 0x50, 0x4e, 0x42, 0x43, 0x4d, 0x48, 0x4f, 0x43, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x75, 0x66, 0x66,
	0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x43, 0x49, 0x43, 0x50, 0x4e, 0x42, 0x43, 0x4d, 0x48, 0x4f,
	0x43, 0x12, 0x20, 0x0a, 0x0b, 0x44, 0x49, 0x41, 0x44, 0x48, 0x50, 0x41, 0x48, 0x4c, 0x47, 0x43,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x44, 0x49, 0x41, 0x44, 0x48, 0x50, 0x41, 0x48,
	0x4c, 0x47, 0x43, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_GetStuffScNotify_proto_depIdxs = []int32{
	1, // 0: GetStuffScNotify.CICPNBCMHOC:type_name -> GetStuffType
