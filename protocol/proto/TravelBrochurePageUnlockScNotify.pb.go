...
type TravelBrochurePageUnlockScNotify struct {
	...
	LOFDIGOACGI uint32 `protobuf:"varint,2,opt,name=LOFDIGOACGI,proto3" json:"LOFDIGOACGI,omitempty"`
}
...
func (x *TravelBrochurePageUnlockScNotify) GetLOFDIGOACGI() uint32 {
	if x != nil {
...
var file_TravelBrochurePageUnlockScNotify_proto_rawDesc = []byte{
	...
	0x4c, 0x4f, 0x46, 0x44, 0x49, 0x47, 0x4f, 0x41, 0x43, 0x47, 0x49, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x4c, 0x4f, 0x46, 0x44, 0x49, 0x47, 0x4f, 0x41, 0x43, 0x47, 0x49, 0x42, 0x2e,
