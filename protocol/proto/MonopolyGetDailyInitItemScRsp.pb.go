...
type MonopolyGetDailyInitItemScRsp struct {
	...
	LBMEIHABLKN uint32 `protobuf:"varint,8,opt,name=LBMEIHABLKN,proto3" json:"LBMEIHABLKN,omitempty"`
	FBMLKJJMMFJ uint32 `protobuf:"varint,2,opt,name=FBMLKJJMMFJ,proto3" json:"FBMLKJJMMFJ,omitempty"`
	DBABLKNONJF uint32 `protobuf:"varint,15,opt,name=DBABLKNONJF,proto3" json:"DBABLKNONJF,omitempty"`
	AABJAEIBGGM int64  `protobuf:"varint,14,opt,name=AABJAEIBGGM,proto3" json:"AABJAEIBGGM,omitempty"`
	OBIDNHGHHMH uint32 `protobuf:"varint,4,opt,name=OBIDNHGHHMH,proto3" json:"OBIDNHGHHMH,omitempty"`
	Retcode     uint32 `protobuf:"varint,3,opt,name=retcode,proto3" json:"retcode,omitempty"`
	GELALEKMCGH uint32 `protobuf:"varint,5,opt,name=GELALEKMCGH,proto3" json:"GELALEKMCGH,omitempty"`
}
...
func (x *MonopolyGetDailyInitItemScRsp) GetLBMEIHABLKN() uint32 {
	if x != nil {
		return x.LBMEIHABLKN
	}
	return 0
}

func (x *MonopolyGetDailyInitItemScRsp) GetFBMLKJJMMFJ() uint32 {
	if x != nil {
		return x.FBMLKJJMMFJ
	}
	return 0
}

func (x *MonopolyGetDailyInitItemScRsp) GetDBABLKNONJF() uint32 {
	if x != nil {
		return x.DBABLKNONJF
	}
	return 0
}

func (x *MonopolyGetDailyInitItemScRsp) GetAABJAEIBGGM() int64 {
	if x != nil {
...
func (x *MonopolyGetDailyInitItemScRsp) GetOBIDNHGHHMH() uint32 {
	if x != nil {
		return x.OBIDNHGHHMH
	}
	return 0
}
...
func (x *MonopolyGetDailyInitItemScRsp) GetGELALEKMCGH() uint32 {
	if x != nil {
		return x.GELALEKMCGH
	}
	return 0
}
...
var file_MonopolyGetDailyInitItemScRsp_proto_rawDesc = []byte{
	...
	,
	...
	0x45, 0x4c, 0x41, 0x4c, 0x45, 0x4b, 0x4d, 0x43, 0x47, 0x48, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0b, 0x47, 0x45, 0x4c, 0x41, 0x4c, 0x45, 0x4b, 0x4d, 0x43, 0x47, 0x48, 0x42, 0x2e, 0x5a,
