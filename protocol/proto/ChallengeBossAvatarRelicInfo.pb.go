...
type ChallengeBossAvatarRelicInfo struct {
	...
	AvatarRelicSlotMap map[uint32]*ChallengeBossRelicInfo `protobuf:"bytes,4,rep,name=avatar_relic_slot_map,json=avatarRelicSlotMap,proto3" json:"avatar_relic_slot_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_ChallengeBossAvatarRelicInfo_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x63, 0x5f, 0x73, 0x6c, 0x6f, 0x74, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x04, 0x20, 0x03,
