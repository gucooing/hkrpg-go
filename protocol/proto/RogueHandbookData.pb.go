...
type RogueHandbookData struct {
	...
	BuffList      []*RogueHandbookBuff    `protobuf:"bytes,10,rep,name=buff_list,json=buffList,proto3" json:"buff_list,omitempty"`
	RogueAeonList []*RogueHandbookAeon    `protobuf:"bytes,15,rep,name=rogue_aeon_list,json=rogueAeonList,proto3" json:"rogue_aeon_list,omitempty"`
	MiracleList   []*RogueHandbookMiracle `protobuf:"bytes,5,rep,name=miracle_list,json=miracleList,proto3" json:"miracle_list,omitempty"`
}
...
var file_RogueHandbookData_proto_rawDesc = []byte{
	...
	0x09, 0x62, 0x75, 0x66, 0x66, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b,
	...
	0x74, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x48,
	...
	0x72, 0x61, 0x63, 0x6c, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
