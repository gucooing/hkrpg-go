...
type ChessRogueStartScRsp struct {
	...
	CurrentInfo    *ChessRogueCurrentInfo `protobuf:"bytes,1,opt,name=current_info,json=currentInfo,proto3" json:"current_info,omitempty"`
	Lineup         *LineupInfo            `protobuf:"bytes,8,opt,name=lineup,proto3" json:"lineup,omitempty"`
	CellInfo       *ChessRogueCellInfo    `protobuf:"bytes,13,opt,name=cell_info,json=cellInfo,proto3" json:"cell_info,omitempty"`
	Scene          *SceneInfo             `protobuf:"bytes,15,opt,name=scene,proto3" json:"scene,omitempty"`
	ChessRogueInfo *ChessRogueInfo        `protobuf:"bytes,14,opt,name=chess_rogue_info,json=chessRogueInfo,proto3" json:"chess_rogue_info,omitempty"` //PEEHMMLEDMP build_query = 3;
}
...
var file_ChessRogueStartScRsp_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x43, 0x68, 0x65, 0x73, 0x73, 0x52, 0x6f, 0x67,
	...
	0x30, 0x0a, 0x09, 0x63, 0x65, 0x6c, 0x6c, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0d, 0x20, 0x01,
	...
	0x6f, 0x12, 0x20, 0x0a, 0x05, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b,
	...
	0x75, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
