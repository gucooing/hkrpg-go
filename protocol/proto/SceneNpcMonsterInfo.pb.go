...
type SceneNpcMonsterInfo struct {
	...
	KIEDGNHHBMA bool                 `protobuf:"varint,6,opt,name=KIEDGNHHBMA,proto3" json:"KIEDGNHHBMA,omitempty"`
	...
	DNCKDNCOOAB bool                 `protobuf:"varint,1,opt,name=DNCKDNCOOAB,proto3" json:"DNCKDNCOOAB,omitempty"`
	EventId     uint32               `protobuf:"varint,13,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`
	ExtraInfo   *NpcMonsterExtraInfo `protobuf:"bytes,15,opt,name=extra_info,json=extraInfo,proto3" json:"extra_info,omitempty"`
}
...
func (x *SceneNpcMonsterInfo) GetKIEDGNHHBMA() bool {
	if x != nil {
		return x.KIEDGNHHBMA
	}
	return false
}
...
func (x *SceneNpcMonsterInfo) GetDNCKDNCOOAB() bool {
	if x != nil {
		return x.DNCKDNCOOAB
	}
	return false
}
...
var file_SceneNpcMonsterInfo_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x4b, 0x49, 0x45, 0x44, 0x47, 0x4e, 0x48, 0x48, 0x42, 0x4d, 0x41, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0b, 0x4b, 0x49, 0x45, 0x44, 0x47, 0x4e, 0x48, 0x48, 0x42, 0x4d, 0x41,
	0x12, 0x1f, 0x0a, 0x0b, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x4c, 0x65, 0x76, 0x65,
	...
	0x12, 0x20, 0x0a, 0x0b, 0x44, 0x4e, 0x43, 0x4b, 0x44, 0x4e, 0x43, 0x4f, 0x4f, 0x41, 0x42, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x44, 0x4e, 0x43, 0x4b, 0x44, 0x4e, 0x43, 0x4f, 0x4f,
	0x41, 0x42, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0d,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x33, 0x0a,
	0x0a, 0x65, 0x78, 0x74, 0x72, 0x61, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0f, 0x20, 0x01, 0x28,
