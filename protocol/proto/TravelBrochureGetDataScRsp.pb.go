...
type TravelBrochureGetDataScRsp struct {
	...
	EMAPOAHJFEM map[uint32]*PLHFOLKMAJI `protobuf:"bytes,3,rep,name=EMAPOAHJFEM,proto3" json:"EMAPOAHJFEM,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Retcode     uint32                  `protobuf:"varint,7,opt,name=retcode,proto3" json:"retcode,omitempty"`
	PBOADLAGGPN map[uint32]uint32       `protobuf:"bytes,2,rep,name=PBOADLAGGPN,proto3" json:"PBOADLAGGPN,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	CustomValue uint32                  `protobuf:"varint,9,opt,name=custom_value,json=customValue,proto3" json:"custom_value,omitempty"`
}
...
func (x *TravelBrochureGetDataScRsp) GetEMAPOAHJFEM() map[uint32]*PLHFOLKMAJI {
	if x != nil {
		return x.EMAPOAHJFEM
	}
	return nil
}
...
func (x *TravelBrochureGetDataScRsp) GetPBOADLAGGPN() map[uint32]uint32 {
	if x != nil {
		return x.PBOADLAGGPN
	}
	return nil
}
...
var file_TravelBrochureGetDataScRsp_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x11, 0x50, 0x4c, 0x48, 0x46, 0x4f, 0x4c, 0x4b, 0x4d, 0x41, 0x4a, 0x49, 0x2e,
	...
	,
...
var file_TravelBrochureGetDataScRsp_proto_goTypes = []interface{}{
	...
	nil,                                // 1: TravelBrochureGetDataScRsp.EMAPOAHJFEMEntry
	nil,                                // 2: TravelBrochureGetDataScRsp.PBOADLAGGPNEntry
	(*PLHFOLKMAJI)(nil),                // 3: PLHFOLKMAJI
}
var file_TravelBrochureGetDataScRsp_proto_depIdxs = []int32{
	1, // 0: TravelBrochureGetDataScRsp.EMAPOAHJFEM:type_name -> TravelBrochureGetDataScRsp.EMAPOAHJFEMEntry
	2, // 1: TravelBrochureGetDataScRsp.PBOADLAGGPN:type_name -> TravelBrochureGetDataScRsp.PBOADLAGGPNEntry
	3, // 2: TravelBrochureGetDataScRsp.EMAPOAHJFEMEntry.value:type_name -> PLHFOLKMAJI
