...
type TrialActivityDataChangeScNotify struct {
	...
	TrialActivityInfo *TrialActivityInfo `protobuf:"bytes,5,opt,name=trial_activity_info,json=trialActivityInfo,proto3" json:"trial_activity_info,omitempty"`
}
...
var file_TrialActivityDataChangeScNotify_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
