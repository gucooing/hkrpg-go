...
type FightActivityDataChangeScNotify struct {
	...
	FILOFJLGANE []*FightActivityGroup `protobuf:"bytes,6,rep,name=FILOFJLGANE,proto3" json:"FILOFJLGANE,omitempty"`
	HMEPCMMKMEP map[uint32]uint32     `protobuf:"bytes,5,rep,name=HMEPCMMKMEP,proto3" json:"HMEPCMMKMEP,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *FightActivityDataChangeScNotify) GetFILOFJLGANE() []*FightActivityGroup {
	if x != nil {
...
func (x *FightActivityDataChangeScNotify) GetHMEPCMMKMEP() map[uint32]uint32 {
	if x != nil {
...
var file_FightActivityDataChangeScNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x35, 0x0a, 0x0b, 0x46, 0x49, 0x4c, 0x4f, 0x46, 0x4a, 0x4c,
	0x47, 0x41, 0x4e, 0x45, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x46, 0x69, 0x67,
	0x68, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52,
	0x0b, 0x46, 0x49, 0x4c, 0x4f, 0x46, 0x4a, 0x4c, 0x47, 0x41, 0x4e, 0x45, 0x12, 0x53, 0x0a, 0x0b,
	0x48, 0x4d, 0x45, 0x50, 0x43, 0x4d, 0x4d, 0x4b, 0x4d, 0x45, 0x50, 0x18, 0x05, 0x20, 0x03, 0x28,
	...
	0x69, 0x66, 0x79, 0x2e, 0x48, 0x4d, 0x45, 0x50, 0x43, 0x4d, 0x4d, 0x4b, 0x4d, 0x45, 0x50, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x48, 0x4d, 0x45, 0x50, 0x43, 0x4d, 0x4d, 0x4b, 0x4d, 0x45,
	0x50, 0x1a, 0x3e, 0x0a, 0x10, 0x48, 0x4d, 0x45, 0x50, 0x43, 0x4d, 0x4d, 0x4b, 0x4d, 0x45, 0x50,
...
var file_FightActivityDataChangeScNotify_proto_goTypes = []interface{}{
	...
	nil,                                     // 1: FightActivityDataChangeScNotify.HMEPCMMKMEPEntry
	(*FightActivityGroup)(nil),              // 2: FightActivityGroup
}
var file_FightActivityDataChangeScNotify_proto_depIdxs = []int32{
	2, // 0: FightActivityDataChangeScNotify.FILOFJLGANE:type_name -> FightActivityGroup
	1, // 1: FightActivityDataChangeScNotify.HMEPCMMKMEP:type_name -> FightActivityDataChangeScNotify.HMEPCMMKMEPEntry
