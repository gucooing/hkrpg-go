...
type AnnounceData struct {
	...
	MFNLOJOMOAI uint32 `protobuf:"varint,9,opt,name=MFNLOJOMOAI,proto3" json:"MFNLOJOMOAI,omitempty"`
	GGKNOFCPGKP string `protobuf:"bytes,4,opt,name=GGKNOFCPGKP,proto3" json:"GGKNOFCPGKP,omitempty"`
	BMABEHFEHLF string `protobuf:"bytes,10,opt,name=BMABEHFEHLF,proto3" json:"BMABEHFEHLF,omitempty"`
	KFOMLPMMHCA bool   `protobuf:"varint,14,opt,name=KFOMLPMMHCA,proto3" json:"KFOMLPMMHCA,omitempty"`
	ConfigId    uint32 `protobuf:"varint,11,opt,name=config_id,json=configId,proto3" json:"config_id,omitempty"`
	ALJACEDDGHA string `protobuf:"bytes,3,opt,name=ALJACEDDGHA,proto3" json:"ALJACEDDGHA,omitempty"`
	IEJNHFPDFGE uint32 `protobuf:"varint,8,opt,name=IEJNHFPDFGE,proto3" json:"IEJNHFPDFGE,omitempty"`
...
func (x *AnnounceData) GetMFNLOJOMOAI() uint32 {
	if x != nil {
		return x.MFNLOJOMOAI
	}
	return 0
}

func (x *AnnounceData) GetGGKNOFCPGKP() string {
	if x != nil {
		return x.GGKNOFCPGKP
	}
	return ""
}

func (x *AnnounceData) GetBMABEHFEHLF() string {
	if x != nil {
		return x.BMABEHFEHLF
	}
	return ""
}

func (x *AnnounceData) GetKFOMLPMMHCA() bool {
	if x != nil {
		return x.KFOMLPMMHCA
	}
	return false
}
...
func (x *AnnounceData) GetALJACEDDGHA() string {
	if x != nil {
		return x.ALJACEDDGHA
	}
	return ""
}

func (x *AnnounceData) GetIEJNHFPDFGE() uint32 {
	if x != nil {
		return x.IEJNHFPDFGE
	}
	return 0
}
...
var file_AnnounceData_proto_rawDesc = []byte{
	...
	,
