...
type SelectChatBubbleScRsp struct {
	...
	CurChatBubble uint32 `protobuf:"varint,12,opt,name=cur_chat_bubble,json=curChatBubble,proto3" json:"cur_chat_bubble,omitempty"`
	MKPOIHGIHPC   uint32 `protobuf:"varint,6,opt,name=MKPOIHGIHPC,proto3" json:"MKPOIHGIHPC,omitempty"`
...
func (x *SelectChatBubbleScRsp) GetMKPOIHGIHPC() uint32 {
	if x != nil {
		return x.MKPOIHGIHPC
	}
	return 0
}
...
var file_SelectChatBubbleScRsp_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x5f, 0x62, 0x75, 0x62, 0x62, 0x6c, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0d, 0x63, 0x75, 0x72, 0x43, 0x68, 0x61, 0x74, 0x42, 0x75, 0x62, 0x62, 0x6c, 0x65, 0x12, 0x20,
	0x0a, 0x0b, 0x4d, 0x4b, 0x50, 0x4f, 0x49, 0x48, 0x47, 0x49, 0x48, 0x50, 0x43, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4d, 0x4b, 0x50, 0x4f, 0x49, 0x48, 0x47, 0x49, 0x48, 0x50, 0x43,
