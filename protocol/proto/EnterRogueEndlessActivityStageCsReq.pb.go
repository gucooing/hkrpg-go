...
type EnterRogueEndlessActivityStageCsReq struct {
	...
	AvatarList  []*RogueEndlessAvatar `protobuf:"bytes,11,rep,name=avatar_list,json=avatarList,proto3" json:"avatar_list,omitempty"`
	GDELCMKIEBH uint32                `protobuf:"varint,13,opt,name=GDELCMKIEBH,proto3" json:"GDELCMKIEBH,omitempty"`
}
...
func (x *EnterRogueEndlessActivityStageCsReq) GetGDELCMKIEBH() uint32 {
	if x != nil {
		return x.GDELCMKIEBH
	}
	return 0
}
...
var file_EnterRogueEndlessActivityStageCsReq_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x44, 0x45, 0x4c, 0x43, 0x4d, 0x4b, 0x49, 0x45, 0x42,
	0x48, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x47, 0x44, 0x45, 0x4c, 0x43, 0x4d, 0x4b,
	0x49, 0x45, 0x42, 0x48, 0x42, 0x28, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f,
