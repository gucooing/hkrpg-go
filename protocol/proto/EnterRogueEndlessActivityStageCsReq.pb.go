...
type EnterRogueEndlessActivityStageCsReq struct {
	...
	BBOLGLGMKEJ uint32                `protobuf:"varint,1,opt,name=BBOLGLGMKEJ,proto3" json:"BBOLGLGMKEJ,omitempty"`
	AvatarList  []*RogueEndlessAvatar `protobuf:"bytes,6,rep,name=avatar_list,json=avatarList,proto3" json:"avatar_list,omitempty"`
}
...
func (x *EnterRogueEndlessActivityStageCsReq) GetBBOLGLGMKEJ() uint32 {
	if x != nil {
		return x.BBOLGLGMKEJ
	}
	return 0
}
...
var file_EnterRogueEndlessActivityStageCsReq_proto_rawDesc = []byte{
	...
	0x42, 0x42, 0x4f, 0x4c, 0x47, 0x4c, 0x47, 0x4d, 0x4b, 0x45, 0x4a, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x42, 0x42, 0x4f, 0x4c, 0x47, 0x4c, 0x47, 0x4d, 0x4b, 0x45, 0x4a, 0x12, 0x34,
	0x0a, 0x0b, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20,
