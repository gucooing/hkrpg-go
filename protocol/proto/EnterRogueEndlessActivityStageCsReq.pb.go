...
type EnterRogueEndlessActivityStageCsReq struct {
	...
	GKCAKEDDEPN uint32                `protobuf:"varint,5,opt,name=GKCAKEDDEPN,proto3" json:"GKCAKEDDEPN,omitempty"`
	AvatarList  []*RogueEndlessAvatar `protobuf:"bytes,9,rep,name=avatar_list,json=avatarList,proto3" json:"avatar_list,omitempty"`
}
...
func (x *EnterRogueEndlessActivityStageCsReq) GetGKCAKEDDEPN() uint32 {
	if x != nil {
		return x.GKCAKEDDEPN
	}
	return 0
}
...
var file_EnterRogueEndlessActivityStageCsReq_proto_rawDesc = []byte{
	...
	0x47, 0x4b, 0x43, 0x41, 0x4b, 0x45, 0x44, 0x44, 0x45, 0x50, 0x4e, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x47, 0x4b, 0x43, 0x41, 0x4b, 0x45, 0x44, 0x44, 0x45, 0x50, 0x4e, 0x12, 0x34,
