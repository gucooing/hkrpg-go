...
type SetTurnFoodSwitchScRsp struct {
	...
	CIEEDPPEKAC TurnFoodSwitch `protobuf:"varint,9,opt,name=CIEEDPPEKAC,proto3,enum=TurnFoodSwitch" json:"CIEEDPPEKAC,omitempty"`
	EDHONFLKEGG bool           `protobuf:"varint,8,opt,name=EDHONFLKEGG,proto3" json:"EDHONFLKEGG,omitempty"`
}
...
func (x *SetTurnFoodSwitchScRsp) GetCIEEDPPEKAC() TurnFoodSwitch {
	if x != nil {
...
func (x *SetTurnFoodSwitchScRsp) GetEDHONFLKEGG() bool {
	if x != nil {
...
var file_SetTurnFoodSwitchScRsp_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x31, 0x0a, 0x0b, 0x43, 0x49, 0x45,
	0x45, 0x44, 0x50, 0x50, 0x45, 0x4b, 0x41, 0x43, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f,
	0x2e, 0x54, 0x75, 0x72, 0x6e, 0x46, 0x6f, 0x6f, 0x64, 0x53, 0x77, 0x69, 0x74, 0x63, 0x68, 0x52,
	0x0b, 0x43, 0x49, 0x45, 0x45, 0x44, 0x50, 0x50, 0x45, 0x4b, 0x41, 0x43, 0x12, 0x20, 0x0a, 0x0b,
	0x45, 0x44, 0x48, 0x4f, 0x4e, 0x46, 0x4c, 0x4b, 0x45, 0x47, 0x47, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0b, 0x45, 0x44, 0x48, 0x4f, 0x4e, 0x46, 0x4c, 0x4b, 0x45, 0x47, 0x47, 0x42, 0x2e,
...
var file_SetTurnFoodSwitchScRsp_proto_depIdxs = []int32{
	1, // 0: SetTurnFoodSwitchScRsp.CIEEDPPEKAC:type_name -> TurnFoodSwitch
