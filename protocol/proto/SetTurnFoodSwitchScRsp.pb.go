...
type SetTurnFoodSwitchScRsp struct {
	...
	NDIFKAKHGKH bool           `protobuf:"varint,1,opt,name=NDIFKAKHGKH,proto3" json:"NDIFKAKHGKH,omitempty"`
	Retcode     uint32         `protobuf:"varint,9,opt,name=retcode,proto3" json:"retcode,omitempty"`
	LPLMJKEDLDB TurnFoodSwitch `protobuf:"varint,14,opt,name=LPLMJKEDLDB,proto3,enum=TurnFoodSwitch" json:"LPLMJKEDLDB,omitempty"`
}
...
func (x *SetTurnFoodSwitchScRsp) GetNDIFKAKHGKH() bool {
	if x != nil {
...
func (x *SetTurnFoodSwitchScRsp) GetLPLMJKEDLDB() TurnFoodSwitch {
	if x != nil {
...
var file_SetTurnFoodSwitchScRsp_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x0b, 0x4e, 0x44, 0x49, 0x46, 0x4b, 0x41, 0x4b, 0x48, 0x47, 0x4b, 0x48, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x4e, 0x44, 0x49, 0x46, 0x4b, 0x41, 0x4b, 0x48, 0x47, 0x4b,
	0x48, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x31, 0x0a, 0x0b, 0x4c,
	0x50, 0x4c, 0x4d, 0x4a, 0x4b, 0x45, 0x44, 0x4c, 0x44, 0x42, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x0f, 0x2e, 0x54, 0x75, 0x72, 0x6e, 0x46, 0x6f, 0x6f, 0x64, 0x53, 0x77, 0x69, 0x74, 0x63,
	0x68, 0x52, 0x0b, 0x4c, 0x50, 0x4c, 0x4d, 0x4a, 0x4b, 0x45, 0x44, 0x4c, 0x44, 0x42, 0x42, 0x2e,
...
var file_SetTurnFoodSwitchScRsp_proto_depIdxs = []int32{
	1, // 0: SetTurnFoodSwitchScRsp.LPLMJKEDLDB:type_name -> TurnFoodSwitch
