...
type SetHeroBasicTypeCsReq struct {
	...
	BasicType HeroBasicType `protobuf:"varint,10,opt,name=basic_type,json=basicType,proto3,enum=HeroBasicType" json:"basic_type,omitempty"`
}
...
var file_SetHeroBasicTypeCsReq_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x69, 0x63, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32,
