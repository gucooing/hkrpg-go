...
type ChessRogueCurrentInfo struct {
	...
	StoryInfo *ChessRogueNousStoryInfo `protobuf:"bytes,5,opt,name=story_info,json=storyInfo,proto3" json:"story_info,omitempty"`
	// BELMNIPGEDN LIJCHOCOPEK = 15;
	RogueAvatarInfo *ChessRogueAvatarInfo `protobuf:"bytes,10,opt,name=rogue_avatar_info,json=rogueAvatarInfo,proto3" json:"rogue_avatar_info,omitempty"`
	// DKMCDMJGOIB CKJPPDKJIOH = 2;
	RogueVersionId  uint32                       `protobuf:"varint,12,opt,name=rogue_version_id,json=rogueVersionId,proto3" json:"rogue_version_id,omitempty"` // 202 for nous rogue
	VirtualItemInfo []*ChessRogueVirtualItemInfo `protobuf:"bytes,13,rep,name=virtual_item_info,json=virtualItemInfo,proto3" json:"virtual_item_info,omitempty"`
	// NGKOOLFOHEM JNAGMIALOII = 522;
	// LNJJGEAFJPH NMJAHFBMGDO = 7;
	BuffInfo      *ChessRogueBuffInfo       `protobuf:"bytes,1,opt,name=buff_info,json=buffInfo,proto3" json:"buff_info,omitempty"`
	...
	NousValue     *ChessRogueNousValue      `protobuf:"bytes,14,opt,name=nous_value,json=nousValue,proto3" json:"nous_value,omitempty"`
	// JFGFEBLFGMG KJHGNMBOGHA = 9;
	// CGAPFPHEJIA EEFGNNFCDNJ = 8;
	MiracleInfo *ChessRogueMiracleInfo `protobuf:"bytes,3,opt,name=miracle_info,json=miracleInfo,proto3" json:"miracle_info,omitempty"`
	DiceInfo    *ChessRogueNousDice    `protobuf:"bytes,11,opt,name=dice_info,json=diceInfo,proto3" json:"dice_info,omitempty"`
}
...
var file_ChessRogueCurrentInfo_proto_rawDesc = []byte{
	...
	0x37, 0x0a, 0x0a, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20,
	...
	0x65, 0x5f, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20,
	...
	0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x72, 0x6f, 0x67, 0x75, 0x65, 0x56, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x46, 0x0a, 0x11, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c,
	0x5f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b,
	...
	0x09, 0x62, 0x75, 0x66, 0x66, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x43,
	...
	0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x43,
	...
	0x6f, 0x12, 0x30, 0x0a, 0x09, 0x64, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0b,
