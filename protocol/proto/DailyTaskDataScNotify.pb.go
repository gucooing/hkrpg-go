...
type DailyTaskDataScNotify struct {
	...
	FinishedNum   uint32       `protobuf:"varint,1,opt,name=finished_num,json=finishedNum,proto3" json:"finished_num,omitempty"`
...
var file_DailyTaskDataScNotify_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x64, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x66,
