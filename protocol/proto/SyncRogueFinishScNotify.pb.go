...
type SyncRogueFinishScNotify struct {
	...
	RogueFinishInfo *RogueFinishInfo `protobuf:"bytes,2,opt,name=rogue_finish_info,json=rogueFinishInfo,proto3" json:"rogue_finish_info,omitempty"`
}
...
var file_SyncRogueFinishScNotify_proto_rawDesc = []byte{
	...
	0x68, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x52,
