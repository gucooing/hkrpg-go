...
type GetChallengeScRsp struct {
	...
	ChallengeList       []*Challenge       `protobuf:"bytes,5,rep,name=challenge_list,json=challengeList,proto3" json:"challenge_list,omitempty"`
	Retcode             uint32             `protobuf:"varint,13,opt,name=retcode,proto3" json:"retcode,omitempty"`
	ChallengeRewardList []*ChallengeReward `protobuf:"bytes,14,rep,name=challenge_reward_list,json=challengeRewardList,proto3" json:"challenge_reward_list,omitempty"`
}
...
var file_GetChallengeScRsp_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x67, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x65, 0x5f, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20,
