...
type RogueTournEnterRoomCsReq struct {
	...
	CurRoomIndex uint32 `protobuf:"varint,14,opt,name=cur_room_index,json=curRoomIndex,proto3" json:"cur_room_index,omitempty"`
}
...
var file_RogueTournEnterRoomCsReq_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x65, 0x78, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x63, 0x75, 0x72, 0x52,
