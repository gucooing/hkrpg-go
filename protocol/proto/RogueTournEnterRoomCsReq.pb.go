...
type RogueTournEnterRoomCsReq struct {
	...
	CurRoomIndex uint32 `protobuf:"varint,6,opt,name=cur_room_index,json=curRoomIndex,proto3" json:"cur_room_index,omitempty"`
	NextRoomType uint32 `protobuf:"varint,9,opt,name=next_room_type,json=nextRoomType,proto3" json:"next_room_type,omitempty"`
}
...
var file_RogueTournEnterRoomCsReq_proto_rawDesc = []byte{
	...
	0x63, 0x75, 0x72, 0x5f, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x06,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6e, 0x65, 0x78, 0x74,
