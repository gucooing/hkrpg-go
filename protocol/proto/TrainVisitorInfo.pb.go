...
type TrainVisitorInfo struct {
	...
	JGBBACIFGMM []uint32           `protobuf:"varint,11,rep,packed,name=JGBBACIFGMM,proto3" json:"JGBBACIFGMM,omitempty"`
	CMLLLEMAEOF bool               `protobuf:"varint,7,opt,name=CMLLLEMAEOF,proto3" json:"CMLLLEMAEOF,omitempty"`
	BGEFDJOBJHD uint32             `protobuf:"varint,13,opt,name=BGEFDJOBJHD,proto3" json:"BGEFDJOBJHD,omitempty"`
	MCINDOICELB uint32             `protobuf:"varint,14,opt,name=MCINDOICELB,proto3" json:"MCINDOICELB,omitempty"`
	Status      TrainVisitorStatus `protobuf:"varint,5,opt,name=status,proto3,enum=TrainVisitorStatus" json:"status,omitempty"`
}
...
func (x *TrainVisitorInfo) GetJGBBACIFGMM() []uint32 {
	if x != nil {
...
func (x *TrainVisitorInfo) GetCMLLLEMAEOF() bool {
	if x != nil {
		return x.CMLLLEMAEOF
	}
	return false
}

func (x *TrainVisitorInfo) GetBGEFDJOBJHD() uint32 {
	if x != nil {
		return x.BGEFDJOBJHD
	}
	return 0
}

func (x *TrainVisitorInfo) GetMCINDOICELB() uint32 {
	if x != nil {
...
var file_TrainVisitorInfo_proto_rawDesc = []byte{
	...
	,
