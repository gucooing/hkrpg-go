...
type TrainVisitorInfo struct {
	...
	MNPHPGLJMPB []uint32           `protobuf:"varint,11,rep,packed,name=MNPHPGLJMPB,proto3" json:"MNPHPGLJMPB,omitempty"`
	JOAIJMGMGFP uint32             `protobuf:"varint,8,opt,name=JOAIJMGMGFP,proto3" json:"JOAIJMGMGFP,omitempty"`
	LLILKEJOAKI bool               `protobuf:"varint,6,opt,name=LLILKEJOAKI,proto3" json:"LLILKEJOAKI,omitempty"`
	DIPBOELONLN uint32             `protobuf:"varint,3,opt,name=DIPBOELONLN,proto3" json:"DIPBOELONLN,omitempty"`
	Status      TrainVisitorStatus `protobuf:"varint,10,opt,name=status,proto3,enum=TrainVisitorStatus" json:"status,omitempty"`
}
...
func (x *TrainVisitorInfo) GetMNPHPGLJMPB() []uint32 {
	if x != nil {
...
func (x *TrainVisitorInfo) GetJOAIJMGMGFP() uint32 {
	if x != nil {
...
func (x *TrainVisitorInfo) GetLLILKEJOAKI() bool {
	if x != nil {
		return x.LLILKEJOAKI
	}
	return false
}

func (x *TrainVisitorInfo) GetDIPBOELONLN() uint32 {
	if x != nil {
		return x.DIPBOELONLN
	}
	return 0
}
...
var file_TrainVisitorInfo_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x2e, 0x5a, 0x0e,
