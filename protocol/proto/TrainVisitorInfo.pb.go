...
type TrainVisitorInfo struct {
	...
	CEOBDAFELDP bool               `protobuf:"varint,15,opt,name=CEOBDAFELDP,proto3" json:"CEOBDAFELDP,omitempty"`
	KKHCGIBNEED uint32             `protobuf:"varint,1,opt,name=KKHCGIBNEED,proto3" json:"KKHCGIBNEED,omitempty"`
	AAHILCBEFAD uint32             `protobuf:"varint,12,opt,name=AAHILCBEFAD,proto3" json:"AAHILCBEFAD,omitempty"`
	Status      TrainVisitorStatus `protobuf:"varint,6,opt,name=status,proto3,enum=TrainVisitorStatus" json:"status,omitempty"`
	GLLHDKKCGPM []uint32           `protobuf:"varint,4,rep,packed,name=GLLHDKKCGPM,proto3" json:"GLLHDKKCGPM,omitempty"`
}
...
func (x *TrainVisitorInfo) GetCEOBDAFELDP() bool {
	if x != nil {
		return x.CEOBDAFELDP
	}
	return false
}

func (x *TrainVisitorInfo) GetKKHCGIBNEED() uint32 {
	if x != nil {
...
func (x *TrainVisitorInfo) GetAAHILCBEFAD() uint32 {
	if x != nil {
		return x.AAHILCBEFAD
	}
	return 0
}
...
func (x *TrainVisitorInfo) GetGLLHDKKCGPM() []uint32 {
	if x != nil {
...
var file_TrainVisitorInfo_proto_rawDesc = []byte{
	...
	,
