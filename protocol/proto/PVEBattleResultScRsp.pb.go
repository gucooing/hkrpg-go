...
type PVEBattleResultScRsp struct {
	...
	ResVersion        string          `protobuf:"bytes,12,opt,name=res_version,json=resVersion,proto3" json:"res_version,omitempty"` // 10
	...
	OHNAGDLAMJO       uint32          `protobuf:"varint,13,opt,name=OHNAGDLAMJO,proto3" json:"OHNAGDLAMJO,omitempty"`
	EventId           uint32          `protobuf:"varint,15,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`
	Unk1              *ItemList       `protobuf:"bytes,5,opt,name=unk1,proto3" json:"unk1,omitempty"`
	Unk2              *ItemList       `protobuf:"bytes,1,opt,name=unk2,proto3" json:"unk2,omitempty"`
	Unk3              *ItemList       `protobuf:"bytes,73,opt,name=unk3,proto3" json:"unk3,omitempty"`
	DropData          *ItemList       `protobuf:"bytes,8,opt,name=drop_data,json=dropData,proto3" json:"drop_data,omitempty"`
	KPMOFAPALOC       uint32          `protobuf:"varint,9,opt,name=KPMOFAPALOC,proto3" json:"KPMOFAPALOC,omitempty"`
	BinVersion        string          `protobuf:"bytes,10,opt,name=bin_version,json=binVersion,proto3" json:"bin_version,omitempty"` // 12
	EndStatus         BattleEndStatus `protobuf:"varint,2,opt,name=end_status,json=endStatus,proto3,enum=BattleEndStatus" json:"end_status,omitempty"`
}
...
func (x *PVEBattleResultScRsp) GetOHNAGDLAMJO() uint32 {
	if x != nil {
		return x.OHNAGDLAMJO
	}
	return 0
}
...
func (x *PVEBattleResultScRsp) GetKPMOFAPALOC() uint32 {
	if x != nil {
		return x.KPMOFAPALOC
	}
	return 0
}
...
var file_PVEBattleResultScRsp_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd5, 0x04, 0x0a, 0x14, 0x50, 0x56, 0x45, 0x42,
	...
	,
...
var file_PVEBattleResultScRsp_proto_depIdxs = []int32{
	...
	2, // 1: PVEBattleResultScRsp.unk1:type_name -> ItemList
	2, // 2: PVEBattleResultScRsp.unk2:type_name -> ItemList
	2, // 3: PVEBattleResultScRsp.unk3:type_name -> ItemList
