...
type GetAuthkeyScRsp struct {
	...
	ABDAAEFGGMG uint32 `protobuf:"varint,7,opt,name=ABDAAEFGGMG,proto3" json:"ABDAAEFGGMG,omitempty"`
	COLDHHJCHBI string `protobuf:"bytes,14,opt,name=COLDHHJCHBI,proto3" json:"COLDHHJCHBI,omitempty"`
	OJMPIJLADML uint32 `protobuf:"varint,15,opt,name=OJMPIJLADML,proto3" json:"OJMPIJLADML,omitempty"`
	Retcode     uint32 `protobuf:"varint,10,opt,name=retcode,proto3" json:"retcode,omitempty"`
	KDLFALBDPIB string `protobuf:"bytes,11,opt,name=KDLFALBDPIB,proto3" json:"KDLFALBDPIB,omitempty"`
}
...
func (x *GetAuthkeyScRsp) GetABDAAEFGGMG() uint32 {
	if x != nil {
...
func (x *GetAuthkeyScRsp) GetCOLDHHJCHBI() string {
	if x != nil {
		return x.COLDHHJCHBI
	}
	return ""
}

func (x *GetAuthkeyScRsp) GetOJMPIJLADML() uint32 {
	if x != nil {
...
func (x *GetAuthkeyScRsp) GetKDLFALBDPIB() string {
	if x != nil {
...
var file_GetAuthkeyScRsp_proto_rawDesc = []byte{
	...
	,
