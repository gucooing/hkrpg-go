...
type UnlockBackGroundMusicScRsp struct {
	...
	UnlockedIds []uint32         `protobuf:"varint,10,rep,packed,name=unlocked_ids,json=unlockedIds,proto3" json:"unlocked_ids,omitempty"`
	Retcode     uint32           `protobuf:"varint,5,opt,name=retcode,proto3" json:"retcode,omitempty"`
	MusicList   []*UnlockedMusic `protobuf:"bytes,12,rep,name=music_list,json=musicList,proto3" json:"music_list,omitempty"`
}
...
var file_UnlockBackGroundMusicScRsp_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x75, 0x6e,
	...
	0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x55, 0x6e, 0x6c, 0x6f, 0x63, 0x6b,
