...
type HeartDialTraceScriptCsReq struct {
	...
	PENKIFIKIAC *HNGOJHBPFEJ `protobuf:"bytes,9,opt,name=PENKIFIKIAC,proto3" json:"PENKIFIKIAC,omitempty"`
}
...
func (x *HeartDialTraceScriptCsReq) GetPENKIFIKIAC() *HNGOJHBPFEJ {
	if x != nil {
...
var file_HeartDialTraceScriptCsReq_proto_rawDesc = []byte{
	...
	0x71, 0x12, 0x2e, 0x0a, 0x0b, 0x50, 0x45, 0x4e, 0x4b, 0x49, 0x46, 0x49, 0x4b, 0x49, 0x41, 0x43,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x48, 0x4e, 0x47, 0x4f, 0x4a, 0x48, 0x42,
...
var file_HeartDialTraceScriptCsReq_proto_depIdxs = []int32{
	1, // 0: HeartDialTraceScriptCsReq.PENKIFIKIAC:type_name -> HNGOJHBPFEJ
