...
type HeartDialTraceScriptCsReq struct {
	...
	BPIMBBDFIII *OAIGCJKNEGA `protobuf:"bytes,1,opt,name=BPIMBBDFIII,proto3" json:"BPIMBBDFIII,omitempty"`
}
...
func (x *HeartDialTraceScriptCsReq) GetBPIMBBDFIII() *OAIGCJKNEGA {
	if x != nil {
...
var file_HeartDialTraceScriptCsReq_proto_rawDesc = []byte{
	...
	0x71, 0x12, 0x2e, 0x0a, 0x0b, 0x42, 0x50, 0x49, 0x4d, 0x42, 0x42, 0x44, 0x46, 0x49, 0x49, 0x49,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x4f, 0x41, 0x49, 0x47, 0x43, 0x4a, 0x4b,
...
var file_HeartDialTraceScriptCsReq_proto_depIdxs = []int32{
	1, // 0: HeartDialTraceScriptCsReq.BPIMBBDFIII:type_name -> OAIGCJKNEGA
