...
type ChessRogueCellUpdateNotify struct {
	...
	HFBFDNEMJED RogueModifierSourceType `protobuf:"varint,6,opt,name=HFBFDNEMJED,proto3,enum=RogueModifierSourceType" json:"HFBFDNEMJED,omitempty"`
	Reason      JGJCJHMAKKA             `protobuf:"varint,11,opt,name=reason,proto3,enum=JGJCJHMAKKA" json:"reason,omitempty"`
	BoardId     uint32                  `protobuf:"varint,15,opt,name=board_id,json=boardId,proto3" json:"board_id,omitempty"`
	CellList    []*ChessRogueCell       `protobuf:"bytes,3,rep,name=cell_list,json=cellList,proto3" json:"cell_list,omitempty"`
}
...
func (x *ChessRogueCellUpdateNotify) GetHFBFDNEMJED() RogueModifierSourceType {
	if x != nil {
		return x.HFBFDNEMJED
	}
	return RogueModifierSourceType_ROGUE_MODIFIER_SOURCE_NONE
}

func (x *ChessRogueCellUpdateNotify) GetReason() JGJCJHMAKKA {
	if x != nil {
		return x.Reason
	}
	return JGJCJHMAKKA_CHESS_ROGUE_CELL_UPDATE_REASON_NONE
}
...
var file_ChessRogueCellUpdateNotify_proto_rawDesc = []byte{
	...
	,
...
var file_ChessRogueCellUpdateNotify_proto_goTypes = []interface{}{
	...
	(JGJCJHMAKKA)(0),                   // 2: JGJCJHMAKKA
	(*ChessRogueCell)(nil),             // 3: ChessRogueCell
}
var file_ChessRogueCellUpdateNotify_proto_depIdxs = []int32{
	1, // 0: ChessRogueCellUpdateNotify.HFBFDNEMJED:type_name -> RogueModifierSourceType
	2, // 1: ChessRogueCellUpdateNotify.reason:type_name -> JGJCJHMAKKA
