...
type SetRogueExhibitionScRsp struct {
	...
	GIKIDKIEDJO []*EHHFHIMIKKB `protobuf:"bytes,8,rep,name=GIKIDKIEDJO,proto3" json:"GIKIDKIEDJO,omitempty"`
	Retcode     uint32         `protobuf:"varint,2,opt,name=retcode,proto3" json:"retcode,omitempty"`
	AOGCEINCOJG []*CNEGKPBIFCA `protobuf:"bytes,13,rep,name=AOGCEINCOJG,proto3" json:"AOGCEINCOJG,omitempty"`
}
...
func (x *SetRogueExhibitionScRsp) GetGIKIDKIEDJO() []*EHHFHIMIKKB {
	if x != nil {
...
func (x *SetRogueExhibitionScRsp) GetAOGCEINCOJG() []*CNEGKPBIFCA {
	if x != nil {
...
var file_SetRogueExhibitionScRsp_proto_rawDesc = []byte{
	...
	0x11, 0x45, 0x48, 0x48, 0x46, 0x48, 0x49, 0x4d, 0x49, 0x4b, 0x4b, 0x42, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x11, 0x43, 0x4e, 0x45, 0x47, 0x4b, 0x50, 0x42, 0x49, 0x46, 0x43, 0x41, 0x2e,
	...
	,
...
var file_SetRogueExhibitionScRsp_proto_goTypes = []interface{}{
	...
	(*EHHFHIMIKKB)(nil),             // 1: EHHFHIMIKKB
	(*CNEGKPBIFCA)(nil),             // 2: CNEGKPBIFCA
}
var file_SetRogueExhibitionScRsp_proto_depIdxs = []int32{
	1, // 0: SetRogueExhibitionScRsp.GIKIDKIEDJO:type_name -> EHHFHIMIKKB
	2, // 1: SetRogueExhibitionScRsp.AOGCEINCOJG:type_name -> CNEGKPBIFCA
