...
type GetDailyActiveInfoScRsp struct {
	...
	DailyActiveQuestIdList []uint32            `protobuf:"varint,2,rep,packed,name=daily_active_quest_id_list,json=dailyActiveQuestIdList,proto3" json:"daily_active_quest_id_list,omitempty"`
	DailyActivePoint       uint32              `protobuf:"varint,6,opt,name=daily_active_point,json=dailyActivePoint,proto3" json:"daily_active_point,omitempty"`
	DailyActiveLevelList   []*DailyActiveLevel `protobuf:"bytes,12,rep,name=daily_active_level_list,json=dailyActiveLevelList,proto3" json:"daily_active_level_list,omitempty"`
}
...
func (x *GetDailyActiveInfoScRsp) GetDailyActiveLevelList() []*DailyActiveLevel {
	if x != nil {
...
var file_GetDailyActiveInfoScRsp_proto_rawDesc = []byte{
	...
	,
...
var file_GetDailyActiveInfoScRsp_proto_goTypes = []interface{}{
	...
	(*DailyActiveLevel)(nil),        // 1: DailyActiveLevel
}
var file_GetDailyActiveInfoScRsp_proto_depIdxs = []int32{
	1, // 0: GetDailyActiveInfoScRsp.daily_active_level_list:type_name -> DailyActiveLevel
...
func file_GetDailyActiveInfoScRsp_proto_init() {
	...
	file_DailyActiveLevel_proto_init()
	if !protoimpl.UnsafeEnabled {
