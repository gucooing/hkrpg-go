...
type RogueAction_BuffSelectInfo struct {
	BuffSelectInfo *RogueCommonBuffSelectInfo `protobuf:"bytes,1978,opt,name=buff_select_info,json=buffSelectInfo,proto3,oneof"` // done
}

type RogueAction_MiracleSelectInfo struct {
	// RogueBuffDropInfo BMIDONBKJNJ = 590;
	// RogueBuffEnhanceSelectInfo BDLINKPALNL = 1837;
	MiracleSelectInfo *RogueMiracleSelectInfo `protobuf:"bytes,1899,opt,name=miracle_select_info,json=miracleSelectInfo,proto3,oneof"` // done
}
...
var file_RogueAction_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x18, 0xba, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x52, 0x6f, 0x67, 0x75,
	...
	0x6c, 0x65, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0xeb,
	0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x4d, 0x69, 0x72,
