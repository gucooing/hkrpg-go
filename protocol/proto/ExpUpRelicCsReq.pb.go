...
type ExpUpRelicCsReq struct {
	...
	ItemCostList  *ItemCostList `protobuf:"bytes,12,opt,name=item_cost_list,json=itemCostList,proto3" json:"item_cost_list,omitempty"`
}
...
var file_ExpUpRelicCsReq_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d,
