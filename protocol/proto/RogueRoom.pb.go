...
type RogueRoom struct {
	...
	CJAPOCOFKFC RogueRoomStatus `protobuf:"varint,8,opt,name=CJAPOCOFKFC,proto3,enum=RogueRoomStatus" json:"CJAPOCOFKFC,omitempty"`
	SiteId      uint32          `protobuf:"varint,12,opt,name=site_id,json=siteId,proto3" json:"site_id,omitempty"`
	RoomId      uint32          `protobuf:"varint,7,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`
	CurStatus   RogueRoomStatus `protobuf:"varint,11,opt,name=cur_status,json=curStatus,proto3,enum=RogueRoomStatus" json:"cur_status,omitempty"` // 8
	ECAOPOJFEBB uint32          `protobuf:"varint,10,opt,name=ECAOPOJFEBB,proto3" json:"ECAOPOJFEBB,omitempty"`
}
...
func (x *RogueRoom) GetCJAPOCOFKFC() RogueRoomStatus {
	if x != nil {
		return x.CJAPOCOFKFC
	}
...
func (x *RogueRoom) GetECAOPOJFEBB() uint32 {
	if x != nil {
		return x.ECAOPOJFEBB
	}
	return 0
}
...
var file_RogueRoom_proto_rawDesc = []byte{
	...
	,
...
var file_RogueRoom_proto_depIdxs = []int32{
	1, // 0: RogueRoom.CJAPOCOFKFC:type_name -> RogueRoomStatus
