...
type RogueRoom struct {
	...
	SiteId      uint32          `protobuf:"varint,1,opt,name=site_id,json=siteId,proto3" json:"site_id,omitempty"`
	MGAHHMCOGKK uint32          `protobuf:"varint,14,opt,name=MGAHHMCOGKK,proto3" json:"MGAHHMCOGKK,omitempty"`
	CurStatus   RogueRoomStatus `protobuf:"varint,3,opt,name=cur_status,json=curStatus,proto3,enum=RogueRoomStatus" json:"cur_status,omitempty"` // 10
	GCAAEMOFLDM RogueRoomStatus `protobuf:"varint,10,opt,name=GCAAEMOFLDM,proto3,enum=RogueRoomStatus" json:"GCAAEMOFLDM,omitempty"`             // 3
...
func (x *RogueRoom) GetMGAHHMCOGKK() uint32 {
	if x != nil {
		return x.MGAHHMCOGKK
	}
	return 0
}
...
func (x *RogueRoom) GetGCAAEMOFLDM() RogueRoomStatus {
	if x != nil {
		return x.GCAAEMOFLDM
	}
	return RogueRoomStatus_ROGUE_ROOM_STATUS_NONE
}
...
var file_RogueRoom_proto_rawDesc = []byte{
	...
	,
...
var file_RogueRoom_proto_depIdxs = []int32{
	...
	1, // 1: RogueRoom.GCAAEMOFLDM:type_name -> RogueRoomStatus
