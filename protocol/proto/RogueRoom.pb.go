...
type RogueRoom struct {
	...
	LJFOBHKFEHE RogueRoomStatus `protobuf:"varint,12,opt,name=LJFOBHKFEHE,proto3,enum=RogueRoomStatus" json:"LJFOBHKFEHE,omitempty"`
	LELFKONOLPP uint32          `protobuf:"varint,4,opt,name=LELFKONOLPP,proto3" json:"LELFKONOLPP,omitempty"`
	CurStatus   RogueRoomStatus `protobuf:"varint,8,opt,name=cur_status,json=curStatus,proto3,enum=RogueRoomStatus" json:"cur_status,omitempty"`
...
func (x *RogueRoom) GetLJFOBHKFEHE() RogueRoomStatus {
	if x != nil {
		return x.LJFOBHKFEHE
	}
	return RogueRoomStatus_ROGUE_ROOM_STATUS_NONE
}

func (x *RogueRoom) GetLELFKONOLPP() uint32 {
	if x != nil {
		return x.LELFKONOLPP
	}
	return 0
}
...
var file_RogueRoom_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x12, 0x32, 0x0a, 0x0b, 0x4c, 0x4a, 0x46, 0x4f, 0x42, 0x48,
	0x4b, 0x46, 0x45, 0x48, 0x45, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x52, 0x6f,
	0x67, 0x75, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0b, 0x4c,
	0x4a, 0x46, 0x4f, 0x42, 0x48, 0x4b, 0x46, 0x45, 0x48, 0x45, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x45,
	0x4c, 0x46, 0x4b, 0x4f, 0x4e, 0x4f, 0x4c, 0x50, 0x50, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x4c, 0x45, 0x4c, 0x46, 0x4b, 0x4f, 0x4e, 0x4f, 0x4c, 0x50, 0x50, 0x12, 0x2f, 0x0a, 0x0a,
	0x63, 0x75, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e,
	...
	0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x73, 0x69, 0x74, 0x65, 0x49, 0x64, 0x42,
...
var file_RogueRoom_proto_depIdxs = []int32{
	1, // 0: RogueRoom.LJFOBHKFEHE:type_name -> RogueRoomStatus
