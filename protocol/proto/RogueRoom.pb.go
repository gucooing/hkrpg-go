...
type RogueRoom struct {
	...
	EHDFJGODBBD uint32          `protobuf:"varint,14,opt,name=EHDFJGODBBD,proto3" json:"EHDFJGODBBD,omitempty"`
	FHHHADKHHEF RogueRoomStatus `protobuf:"varint,15,opt,name=FHHHADKHHEF,proto3,enum=RogueRoomStatus" json:"FHHHADKHHEF,omitempty"`
	CurStatus   RogueRoomStatus `protobuf:"varint,12,opt,name=cur_status,json=curStatus,proto3,enum=RogueRoomStatus" json:"cur_status,omitempty"` // 15
	SiteId      uint32          `protobuf:"varint,8,opt,name=site_id,json=siteId,proto3" json:"site_id,omitempty"`
...
func (x *RogueRoom) GetEHDFJGODBBD() uint32 {
	if x != nil {
		return x.EHDFJGODBBD
	}
	return 0
}

func (x *RogueRoom) GetFHHHADKHHEF() RogueRoomStatus {
	if x != nil {
		return x.FHHHADKHHEF
	}
	return RogueRoomStatus_ROGUE_ROOM_STATUS_NONE
}

func (x *RogueRoom) GetCurStatus() RogueRoomStatus {
	if x != nil {
		return x.CurStatus
	}
	return RogueRoomStatus_ROGUE_ROOM_STATUS_NONE
...
var file_RogueRoom_proto_rawDesc = []byte{
	...
	,
...
var file_RogueRoom_proto_depIdxs = []int32{
	1, // 0: RogueRoom.FHHHADKHHEF:type_name -> RogueRoomStatus
	1, // 1: RogueRoom.cur_status:type_name -> RogueRoomStatus
