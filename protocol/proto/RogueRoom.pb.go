...
type RogueRoom struct {
	...
	NHLHMBLGMHB uint32          `protobuf:"varint,12,opt,name=NHLHMBLGMHB,proto3" json:"NHLHMBLGMHB,omitempty"`
	SiteId      uint32          `protobuf:"varint,4,opt,name=site_id,json=siteId,proto3" json:"site_id,omitempty"`
	CurStatus   RogueRoomStatus `protobuf:"varint,10,opt,name=cur_status,json=curStatus,proto3,enum=RogueRoomStatus" json:"cur_status,omitempty"` // 7
	RoomId      uint32          `protobuf:"varint,14,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`
	POMBBDDANNJ RogueRoomStatus `protobuf:"varint,7,opt,name=POMBBDDANNJ,proto3,enum=RogueRoomStatus" json:"POMBBDDANNJ,omitempty"`
}
...
func (x *RogueRoom) GetNHLHMBLGMHB() uint32 {
	if x != nil {
		return x.NHLHMBLGMHB
	}
	return 0
}
...
func (x *RogueRoom) GetPOMBBDDANNJ() RogueRoomStatus {
	if x != nil {
		return x.POMBBDDANNJ
	}
	return RogueRoomStatus_ROGUE_ROOM_STATUS_NONE
}
...
var file_RogueRoom_proto_rawDesc = []byte{
	...
	,
...
var file_RogueRoom_proto_depIdxs = []int32{
	1, // 0: RogueRoom.cur_status:type_name -> RogueRoomStatus
	1, // 1: RogueRoom.POMBBDDANNJ:type_name -> RogueRoomStatus
