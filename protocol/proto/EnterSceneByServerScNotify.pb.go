...
type EnterSceneByServerScNotify struct {
	...
	Reason EnterSceneReason `protobuf:"varint,8,opt,name=reason,proto3,enum=EnterSceneReason" json:"reason,omitempty"`
...
var file_EnterSceneByServerScNotify_proto_rawDesc = []byte{
	...
	0x70, 0x12, 0x29, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28,
