...
type SceneEnterStageCsReq struct {
	...
	DNOJLLAAFCB bool        `protobuf:"varint,5,opt,name=DNOJLLAAFCB,proto3" json:"DNOJLLAAFCB,omitempty"`
	EventId     uint32      `protobuf:"varint,7,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`
	KDKIAOFFNPB CMKNMGGEIPI `protobuf:"varint,8,opt,name=KDKIAOFFNPB,proto3,enum=CMKNMGGEIPI" json:"KDKIAOFFNPB,omitempty"`
}
...
func (x *SceneEnterStageCsReq) GetDNOJLLAAFCB() bool {
	if x != nil {
		return x.DNOJLLAAFCB
	}
	return false
}
...
func (x *SceneEnterStageCsReq) GetKDKIAOFFNPB() CMKNMGGEIPI {
	if x != nil {
		return x.KDKIAOFFNPB
	}
	return CMKNMGGEIPI_REBATTLE_TYPE_NONE
}
...
var file_SceneEnterStageCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_SceneEnterStageCsReq_proto_goTypes = []interface{}{
	...
	(CMKNMGGEIPI)(0),             // 1: CMKNMGGEIPI
}
var file_SceneEnterStageCsReq_proto_depIdxs = []int32{
	1, // 0: SceneEnterStageCsReq.KDKIAOFFNPB:type_name -> CMKNMGGEIPI
