...
type SendMsgCsReq struct {
	...
	ToUidList []uint32 `protobuf:"varint,10,rep,packed,name=to_uid_list,json=toUidList,proto3" json:"to_uid_list,omitempty"`
	Emote     uint32   `protobuf:"varint,12,opt,name=emote,proto3" json:"emote,omitempty"`
	MsgType   MsgType  `protobuf:"varint,11,opt,name=msg_type,json=msgType,proto3,enum=MsgType" json:"msg_type,omitempty"`
	Text      string   `protobuf:"bytes,2,opt,name=text,proto3" json:"text,omitempty"`
	ChatType  ChatType `protobuf:"varint,15,opt,name=chat_type,json=chatType,proto3,enum=ChatType" json:"chat_type,omitempty"`
}
...
var file_SendMsgCsReq_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x09, 0x74, 0x6f, 0x55, 0x69, 0x64,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x12, 0x23, 0x0a, 0x08, 0x6d, 0x73,
	0x67, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x08, 0x2e, 0x4d,
	...
	0x18, 0x0f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x54, 0x79, 0x70,
