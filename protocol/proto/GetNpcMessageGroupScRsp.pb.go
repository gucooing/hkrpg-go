...
type GetNpcMessageGroupScRsp struct {
	...
	MessageGroupList []*MessageGroup `protobuf:"bytes,5,rep,name=message_group_list,json=messageGroupList,proto3" json:"message_group_list,omitempty"`
...
var file_GetNpcMessageGroupScRsp_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x4d, 0x65, 0x73,
