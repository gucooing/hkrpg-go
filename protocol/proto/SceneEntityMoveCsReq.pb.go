...
type SceneEntityMoveCsReq struct {
	...
	CLENBGIJACP      uint64          `protobuf:"varint,15,opt,name=CLENBGIJACP,proto3" json:"CLENBGIJACP,omitempty"`
	EntityMotionList []*EntityMotion `protobuf:"bytes,14,rep,name=entity_motion_list,json=entityMotionList,proto3" json:"entity_motion_list,omitempty"`
}
...
func (x *SceneEntityMoveCsReq) GetCLENBGIJACP() uint64 {
	if x != nil {
		return x.CLENBGIJACP
	}
	return 0
}
...
var file_SceneEntityMoveCsReq_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x4c, 0x45, 0x4e, 0x42, 0x47, 0x49, 0x4a,
	0x41, 0x43, 0x50, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x43, 0x4c, 0x45, 0x4e, 0x42,
	0x47, 0x49, 0x4a, 0x41, 0x43, 0x50, 0x12, 0x3b, 0x0a, 0x12, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79,
	0x5f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20, 0x03,
