...
type SceneEntityMoveCsReq struct {
	...
	EntityMotionList []*EntityMotion `protobuf:"bytes,1,rep,name=entity_motion_list,json=entityMotionList,proto3" json:"entity_motion_list,omitempty"`
}
...
var file_SceneEntityMoveCsReq_proto_rawDesc = []byte{
	...
	0x79, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x65, 0x6e, 0x74, 0x72,
