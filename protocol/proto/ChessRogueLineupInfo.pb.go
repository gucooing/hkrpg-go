...
type ChessRogueLineupInfo struct {
	...
	ChessAvatarList []*ChessRogueLineupAvatarInfo `protobuf:"bytes,9,rep,name=chess_avatar_list,json=chessAvatarList,proto3" json:"chess_avatar_list,omitempty"`
	ReviveInfo      *RogueAvatarReviveCost        `protobuf:"bytes,14,opt,name=revive_info,json=reviveInfo,proto3" json:"revive_info,omitempty"`
}
...
var file_ChessRogueLineupInfo_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x0b, 0x72, 0x65, 0x76, 0x69, 0x76, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0e, 0x20, 0x01,
