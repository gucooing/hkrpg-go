...
type ExchangeGachaCeilingScRsp struct {
	...
	GachaInfoList *GachaCeiling `protobuf:"bytes,12,opt,name=gacha_info_list,json=gachaInfoList,proto3" json:"gacha_info_list,omitempty"`
	Retcode       uint32        `protobuf:"varint,13,opt,name=retcode,proto3" json:"retcode,omitempty"`
	OOPKEHIBDFD   *ItemList     `protobuf:"bytes,8,opt,name=OOPKEHIBDFD,proto3" json:"OOPKEHIBDFD,omitempty"`
	AKFBAHNPBCF   uint32        `protobuf:"varint,15,opt,name=AKFBAHNPBCF,proto3" json:"AKFBAHNPBCF,omitempty"`
}
...
func (x *ExchangeGachaCeilingScRsp) GetGachaInfoList() *GachaCeiling {
	if x != nil {
...
func (x *ExchangeGachaCeilingScRsp) GetOOPKEHIBDFD() *ItemList {
	if x != nil {
		return x.OOPKEHIBDFD
	}
	return nil
}

func (x *ExchangeGachaCeilingScRsp) GetAKFBAHNPBCF() uint32 {
	if x != nil {
...
var file_ExchangeGachaCeilingScRsp_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd8, 0x01, 0x0a, 0x19, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x49, 0x64,
	0x12, 0x35, 0x0a, 0x0f, 0x67, 0x61, 0x63, 0x68, 0x61, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6c,
	0x69, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x47, 0x61, 0x63, 0x68,
	0x61, 0x43, 0x65, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x52, 0x0d, 0x67, 0x61, 0x63, 0x68, 0x61, 0x49,
	...
	0x65, 0x12, 0x2b, 0x0a, 0x0b, 0x4f, 0x4f, 0x50, 0x4b, 0x45, 0x48, 0x49, 0x42, 0x44, 0x46, 0x44,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x4c, 0x69, 0x73,
	0x74, 0x52, 0x0b, 0x4f, 0x4f, 0x50, 0x4b, 0x45, 0x48, 0x49, 0x42, 0x44, 0x46, 0x44, 0x12, 0x20,
	0x0a, 0x0b, 0x41, 0x4b, 0x46, 0x42, 0x41, 0x48, 0x4e, 0x50, 0x42, 0x43, 0x46, 0x18, 0x0f, 0x20,
...
var file_ExchangeGachaCeilingScRsp_proto_depIdxs = []int32{
	1, // 0: ExchangeGachaCeilingScRsp.gacha_info_list:type_name -> GachaCeiling
	2, // 1: ExchangeGachaCeilingScRsp.OOPKEHIBDFD:type_name -> ItemList
