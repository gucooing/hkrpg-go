...
type SpaceZooCatUpdateNotify struct {
	...
	PCOJPHIDLOF bool           `protobuf:"varint,1,opt,name=PCOJPHIDLOF,proto3" json:"PCOJPHIDLOF,omitempty"`
	DEMPNBCBLIA []*CHBBGEIDOGB `protobuf:"bytes,7,rep,name=DEMPNBCBLIA,proto3" json:"DEMPNBCBLIA,omitempty"`
	IFCOOAAPLDF bool           `protobuf:"varint,10,opt,name=IFCOOAAPLDF,proto3" json:"IFCOOAAPLDF,omitempty"`
}
...
func (x *SpaceZooCatUpdateNotify) GetPCOJPHIDLOF() bool {
	if x != nil {
		return x.PCOJPHIDLOF
	}
	return false
}

func (x *SpaceZooCatUpdateNotify) GetDEMPNBCBLIA() []*CHBBGEIDOGB {
	if x != nil {
		return x.DEMPNBCBLIA
	}
	return nil
}

func (x *SpaceZooCatUpdateNotify) GetIFCOOAAPLDF() bool {
	if x != nil {
...
var file_SpaceZooCatUpdateNotify_proto_rawDesc = []byte{
	...
	0x11, 0x43, 0x48, 0x42, 0x42, 0x47, 0x45, 0x49, 0x44, 0x4f, 0x47, 0x42, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x0a, 0x0b, 0x50, 0x43, 0x4f, 0x4a, 0x50, 0x48, 0x49, 0x44, 0x4c, 0x4f, 0x46, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0b, 0x50, 0x43, 0x4f, 0x4a, 0x50, 0x48, 0x49, 0x44, 0x4c, 0x4f, 0x46,
	0x12, 0x2e, 0x0a, 0x0b, 0x44, 0x45, 0x4d, 0x50, 0x4e, 0x42, 0x43, 0x42, 0x4c, 0x49, 0x41, 0x18,
	0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x43, 0x48, 0x42, 0x42, 0x47, 0x45, 0x49, 0x44,
	0x4f, 0x47, 0x42, 0x52, 0x0b, 0x44, 0x45, 0x4d, 0x50, 0x4e, 0x42, 0x43, 0x42, 0x4c, 0x49, 0x41,
	0x12, 0x20, 0x0a, 0x0b, 0x49, 0x46, 0x43, 0x4f, 0x4f, 0x41, 0x41, 0x50, 0x4c, 0x44, 0x46, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x49, 0x46, 0x43, 0x4f, 0x4f, 0x41, 0x41, 0x50, 0x4c,
...
var file_SpaceZooCatUpdateNotify_proto_depIdxs = []int32{
	1, // 0: SpaceZooCatUpdateNotify.DEMPNBCBLIA:type_name -> CHBBGEIDOGB
