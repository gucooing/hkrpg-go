...
type GetPunkLordBattleRecordScRsp struct {
	...
	BattleRecordList []*PunkLordBattleRecord `protobuf:"bytes,1,rep,name=battle_record_list,json=battleRecordList,proto3" json:"battle_record_list,omitempty"`
	Retcode          uint32                  `protobuf:"varint,14,opt,name=retcode,proto3" json:"retcode,omitempty"`
	LEHPJLFNONE      *PunkLordMonsterKey     `protobuf:"bytes,2,opt,name=LEHPJLFNONE,proto3" json:"LEHPJLFNONE,omitempty"`
	IAJEKEMIJFA      []*PunkLordBattleReplay `protobuf:"bytes,11,rep,name=IAJEKEMIJFA,proto3" json:"IAJEKEMIJFA,omitempty"`
}
...
func (x *GetPunkLordBattleRecordScRsp) GetLEHPJLFNONE() *PunkLordMonsterKey {
	if x != nil {
...
func (x *GetPunkLordBattleRecordScRsp) GetIAJEKEMIJFA() []*PunkLordBattleReplay {
	if x != nil {
		return x.IAJEKEMIJFA
	}
	return nil
}
...
var file_GetPunkLordBattleRecordScRsp_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1a, 0x50, 0x75, 0x6e, 0x6b,
	0x4c, 0x6f, 0x72, 0x64, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x61, 0x79,
	...
	0x65, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20,
	...
	,
...
var file_GetPunkLordBattleRecordScRsp_proto_depIdxs = []int32{
	...
	2, // 1: GetPunkLordBattleRecordScRsp.LEHPJLFNONE:type_name -> PunkLordMonsterKey
	3, // 2: GetPunkLordBattleRecordScRsp.IAJEKEMIJFA:type_name -> PunkLordBattleReplay
