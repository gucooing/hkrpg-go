...
type PlayerHeartBeatCsReq struct {
	...
	HCPKPPFGEMA  *ClientUploadData `protobuf:"bytes,8,opt,name=HCPKPPFGEMA,proto3" json:"HCPKPPFGEMA,omitempty"`
	CIAHNCEBJGE  uint32            `protobuf:"varint,5,opt,name=CIAHNCEBJGE,proto3" json:"CIAHNCEBJGE,omitempty"`
	ClientTimeMs uint64            `protobuf:"varint,11,opt,name=client_time_ms,json=clientTimeMs,proto3" json:"client_time_ms,omitempty"`
}
...
func (x *PlayerHeartBeatCsReq) GetHCPKPPFGEMA() *ClientUploadData {
	if x != nil {
...
func (x *PlayerHeartBeatCsReq) GetCIAHNCEBJGE() uint32 {
	if x != nil {
...
var file_PlayerHeartBeatCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_PlayerHeartBeatCsReq_proto_depIdxs = []int32{
	1, // 0: PlayerHeartBeatCsReq.HCPKPPFGEMA:type_name -> ClientUploadData
