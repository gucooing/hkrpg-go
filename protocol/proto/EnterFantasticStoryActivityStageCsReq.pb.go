...
type EnterFantasticStoryActivityStageCsReq struct {
	...
	AvatarList  []*OIIHHHCGNMM `protobuf:"bytes,12,rep,name=avatar_list,json=avatarList,proto3" json:"avatar_list,omitempty"`
	BattleId    uint32         `protobuf:"varint,8,opt,name=battle_id,json=battleId,proto3" json:"battle_id,omitempty"`
	DBNMCDGLFKJ uint32         `protobuf:"varint,3,opt,name=DBNMCDGLFKJ,proto3" json:"DBNMCDGLFKJ,omitempty"`
...
func (x *EnterFantasticStoryActivityStageCsReq) GetAvatarList() []*OIIHHHCGNMM {
	if x != nil {
		return x.AvatarList
	}
	return nil
...
func (x *EnterFantasticStoryActivityStageCsReq) GetDBNMCDGLFKJ() uint32 {
	if x != nil {
...
var file_EnterFantasticStoryActivityStageCsReq_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x43, 0x73, 0x52, 0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x4f,
	0x49, 0x49, 0x48, 0x48, 0x48, 0x43, 0x47, 0x4e, 0x4d, 0x4d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x0c, 0x2e, 0x4f, 0x49, 0x49, 0x48, 0x48, 0x48, 0x43, 0x47, 0x4e, 0x4d, 0x4d, 0x52, 0x0a, 0x61,
	...
	0x74, 0x74, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x44, 0x42, 0x4e, 0x4d, 0x43, 0x44,
	0x47, 0x4c, 0x46, 0x4b, 0x4a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x44, 0x42, 0x4e,
	0x4d, 0x43, 0x44, 0x47, 0x4c, 0x46, 0x4b, 0x4a, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x75, 0x66, 0x66,
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x08, 0x62, 0x75, 0x66,
...
var file_EnterFantasticStoryActivityStageCsReq_proto_depIdxs = []int32{
	1, // 0: EnterFantasticStoryActivityStageCsReq.avatar_list:type_name -> OIIHHHCGNMM
