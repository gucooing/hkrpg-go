...
type EnterFantasticStoryActivityStageCsReq struct {
	...
	AvatarList  []*FFMHCHHHGBA `protobuf:"bytes,1,rep,name=avatar_list,json=avatarList,proto3" json:"avatar_list,omitempty"`
	BuffList    []uint32       `protobuf:"varint,8,rep,packed,name=buff_list,json=buffList,proto3" json:"buff_list,omitempty"`
	AIHBDNKBNMH uint32         `protobuf:"varint,12,opt,name=AIHBDNKBNMH,proto3" json:"AIHBDNKBNMH,omitempty"`
}
...
func (x *EnterFantasticStoryActivityStageCsReq) GetAvatarList() []*FFMHCHHHGBA {
	if x != nil {
		return x.AvatarList
	}
	return nil
...
func (x *EnterFantasticStoryActivityStageCsReq) GetAIHBDNKBNMH() uint32 {
	if x != nil {
...
var file_EnterFantasticStoryActivityStageCsReq_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x43, 0x73, 0x52, 0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x46,
	0x46, 0x4d, 0x48, 0x43, 0x48, 0x48, 0x48, 0x47, 0x42, 0x41, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	,
...
var file_EnterFantasticStoryActivityStageCsReq_proto_depIdxs = []int32{
	1, // 0: EnterFantasticStoryActivityStageCsReq.avatar_list:type_name -> FFMHCHHHGBA
