...
type ChessRogueMiracleInfo struct {
	...
	MiracleData *ChessRogueMiracleData `protobuf:"bytes,11,opt,name=miracle_data,json=miracleData,proto3" json:"miracle_data,omitempty"`
}
...
var file_ChessRogueMiracleInfo_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x43, 0x68, 0x65, 0x73,
