...
type DeleteSocialEventServerCacheScRsp struct {
	...
	HLFFLAMPKED []uint32 `protobuf:"varint,1,rep,packed,name=HLFFLAMPKED,proto3" json:"HLFFLAMPKED,omitempty"`
...
func (x *DeleteSocialEventServerCacheScRsp) GetHLFFLAMPKED() []uint32 {
	if x != nil {
		return x.HLFFLAMPKED
	}
	return nil
}
...
var file_DeleteSocialEventServerCacheScRsp_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x48, 0x4c, 0x46, 0x46, 0x4c, 0x41, 0x4d, 0x50, 0x4b, 0x45, 0x44, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0d, 0x52, 0x0b, 0x48, 0x4c, 0x46, 0x46, 0x4c, 0x41, 0x4d, 0x50, 0x4b, 0x45, 0x44,
