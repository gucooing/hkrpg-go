...
type DeleteSocialEventServerCacheScRsp struct {
	...
	GINKEDBBKMP []uint32 `protobuf:"varint,1,rep,packed,name=GINKEDBBKMP,proto3" json:"GINKEDBBKMP,omitempty"`
...
func (x *DeleteSocialEventServerCacheScRsp) GetGINKEDBBKMP() []uint32 {
	if x != nil {
		return x.GINKEDBBKMP
	}
	return nil
}
...
var file_DeleteSocialEventServerCacheScRsp_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x47, 0x49, 0x4e, 0x4b, 0x45, 0x44, 0x42, 0x42, 0x4b, 0x4d, 0x50, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0d, 0x52, 0x0b, 0x47, 0x49, 0x4e, 0x4b, 0x45, 0x44, 0x42, 0x42, 0x4b, 0x4d, 0x50,
