...
type DeleteSocialEventServerCacheScRsp struct {
	...
	IHBPHLKCEMP []uint32 `protobuf:"varint,15,rep,packed,name=IHBPHLKCEMP,proto3" json:"IHBPHLKCEMP,omitempty"`
}
...
func (x *DeleteSocialEventServerCacheScRsp) GetIHBPHLKCEMP() []uint32 {
	if x != nil {
		return x.IHBPHLKCEMP
	}
	return nil
}
...
var file_DeleteSocialEventServerCacheScRsp_proto_rawDesc = []byte{
	...
	0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x49, 0x48, 0x42, 0x50,
	0x48, 0x4c, 0x4b, 0x43, 0x45, 0x4d, 0x50, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x49,
	0x48, 0x42, 0x50, 0x48, 0x4c, 0x4b, 0x43, 0x45, 0x4d, 0x50, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e,
