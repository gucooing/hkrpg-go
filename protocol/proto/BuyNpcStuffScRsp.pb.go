...
type BuyNpcStuffScRsp struct {
	...
	POEDFMELAKE uint32 `protobuf:"varint,13,opt,name=POEDFMELAKE,proto3" json:"POEDFMELAKE,omitempty"`
}
...
func (x *BuyNpcStuffScRsp) GetPOEDFMELAKE() uint32 {
	if x != nil {
...
var file_BuyNpcStuffScRsp_proto_rawDesc = []byte{
	...
	0x45, 0x4c, 0x41, 0x4b, 0x45, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x4f, 0x45,
