...
type CancelCacheNotifyCsReq struct {
	...
	GGEPGHPENFG []uint32    `protobuf:"varint,4,rep,packed,name=GGEPGHPENFG,proto3" json:"GGEPGHPENFG,omitempty"`
	HJHCCJGMPBC []string    `protobuf:"bytes,9,rep,name=HJHCCJGMPBC,proto3" json:"HJHCCJGMPBC,omitempty"`
	Type        ACNLEMFFGLJ `protobuf:"varint,7,opt,name=type,proto3,enum=ACNLEMFFGLJ" json:"type,omitempty"`
}
...
func (x *CancelCacheNotifyCsReq) GetGGEPGHPENFG() []uint32 {
	if x != nil {
...
func (x *CancelCacheNotifyCsReq) GetHJHCCJGMPBC() []string {
	if x != nil {
		return x.HJHCCJGMPBC
	}
	return nil
}

func (x *CancelCacheNotifyCsReq) GetType() ACNLEMFFGLJ {
	if x != nil {
		return x.Type
	}
	return ACNLEMFFGLJ_CACHE_NOTIFY_TYPE_NONE
}
...
var file_CancelCacheNotifyCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_CancelCacheNotifyCsReq_proto_goTypes = []interface{}{
	...
	(ACNLEMFFGLJ)(0),               // 1: ACNLEMFFGLJ
}
var file_CancelCacheNotifyCsReq_proto_depIdxs = []int32{
	1, // 0: CancelCacheNotifyCsReq.type:type_name -> ACNLEMFFGLJ
