...
type CancelCacheNotifyCsReq struct {
	...
	AIMJJPNNPIH []uint32        `protobuf:"varint,1,rep,packed,name=AIMJJPNNPIH,proto3" json:"AIMJJPNNPIH,omitempty"`
	Type        CacheNotifyType `protobuf:"varint,15,opt,name=type,proto3,enum=CacheNotifyType" json:"type,omitempty"`
	DBOOHAMPKCN []string        `protobuf:"bytes,9,rep,name=DBOOHAMPKCN,proto3" json:"DBOOHAMPKCN,omitempty"`
}
...
func (x *CancelCacheNotifyCsReq) GetAIMJJPNNPIH() []uint32 {
	if x != nil {
		return x.AIMJJPNNPIH
	}
	return nil
}

func (x *CancelCacheNotifyCsReq) GetType() CacheNotifyType {
	if x != nil {
		return x.Type
	}
	return CacheNotifyType_CACHE_NOTIFY_TYPE_NONE
}

func (x *CancelCacheNotifyCsReq) GetDBOOHAMPKCN() []string {
	if x != nil {
		return x.DBOOHAMPKCN
	}
	return nil
}
...
var file_CancelCacheNotifyCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_CancelCacheNotifyCsReq_proto_goTypes = []interface{}{
	...
	(CacheNotifyType)(0),           // 1: CacheNotifyType
}
var file_CancelCacheNotifyCsReq_proto_depIdxs = []int32{
	1, // 0: CancelCacheNotifyCsReq.type:type_name -> CacheNotifyType
...
func file_CancelCacheNotifyCsReq_proto_init() {
	...
	file_CacheNotifyType_proto_init()
	if !protoimpl.UnsafeEnabled {
