...
type CancelCacheNotifyCsReq struct {
	...
	ENKBLEFCOID []uint32    `protobuf:"varint,13,rep,packed,name=ENKBLEFCOID,proto3" json:"ENKBLEFCOID,omitempty"`
	OAPHLEHOFKM []string    `protobuf:"bytes,9,rep,name=OAPHLEHOFKM,proto3" json:"OAPHLEHOFKM,omitempty"`
	Type        GECDMPFBLMF `protobuf:"varint,4,opt,name=type,proto3,enum=GECDMPFBLMF" json:"type,omitempty"`
}
...
func (x *CancelCacheNotifyCsReq) GetENKBLEFCOID() []uint32 {
	if x != nil {
...
func (x *CancelCacheNotifyCsReq) GetOAPHLEHOFKM() []string {
	if x != nil {
		return x.OAPHLEHOFKM
	}
	return nil
}

func (x *CancelCacheNotifyCsReq) GetType() GECDMPFBLMF {
	if x != nil {
		return x.Type
	}
	return GECDMPFBLMF_CACHE_NOTIFY_TYPE_NONE
}
...
var file_CancelCacheNotifyCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_CancelCacheNotifyCsReq_proto_goTypes = []interface{}{
	...
	(GECDMPFBLMF)(0),               // 1: GECDMPFBLMF
}
var file_CancelCacheNotifyCsReq_proto_depIdxs = []int32{
	1, // 0: CancelCacheNotifyCsReq.type:type_name -> GECDMPFBLMF
