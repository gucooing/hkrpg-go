...
type CancelCacheNotifyCsReq struct {
	...
	Type        NECHAKFLHKL `protobuf:"varint,15,opt,name=type,proto3,enum=NECHAKFLHKL" json:"type,omitempty"`
	MLKHBBNJMEI []string    `protobuf:"bytes,5,rep,name=MLKHBBNJMEI,proto3" json:"MLKHBBNJMEI,omitempty"`
	IIOBGIMHJGO []uint32    `protobuf:"varint,10,rep,packed,name=IIOBGIMHJGO,proto3" json:"IIOBGIMHJGO,omitempty"`
}
...
func (x *CancelCacheNotifyCsReq) GetType() NECHAKFLHKL {
	if x != nil {
		return x.Type
	}
	return NECHAKFLHKL_CACHE_NOTIFY_TYPE_NONE
}

func (x *CancelCacheNotifyCsReq) GetMLKHBBNJMEI() []string {
	if x != nil {
		return x.MLKHBBNJMEI
	}
	return nil
}

func (x *CancelCacheNotifyCsReq) GetIIOBGIMHJGO() []uint32 {
	if x != nil {
		return x.IIOBGIMHJGO
	}
	return nil
}
...
var file_CancelCacheNotifyCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_CancelCacheNotifyCsReq_proto_goTypes = []interface{}{
	...
	(NECHAKFLHKL)(0),               // 1: NECHAKFLHKL
}
var file_CancelCacheNotifyCsReq_proto_depIdxs = []int32{
	1, // 0: CancelCacheNotifyCsReq.type:type_name -> NECHAKFLHKL
