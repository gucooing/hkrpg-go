...
type CancelCacheNotifyCsReq struct {
	...
	OIEMAOMOCMF []string    `protobuf:"bytes,12,rep,name=OIEMAOMOCMF,proto3" json:"OIEMAOMOCMF,omitempty"`
	Type        MCFFICIIOHO `protobuf:"varint,4,opt,name=type,proto3,enum=MCFFICIIOHO" json:"type,omitempty"`
	BABBIHODFON []uint32    `protobuf:"varint,7,rep,packed,name=BABBIHODFON,proto3" json:"BABBIHODFON,omitempty"`
}
...
func (x *CancelCacheNotifyCsReq) GetOIEMAOMOCMF() []string {
	if x != nil {
		return x.OIEMAOMOCMF
	}
	return nil
}

func (x *CancelCacheNotifyCsReq) GetType() MCFFICIIOHO {
	if x != nil {
		return x.Type
	}
	return MCFFICIIOHO_CACHE_NOTIFY_TYPE_NONE
}

func (x *CancelCacheNotifyCsReq) GetBABBIHODFON() []uint32 {
	if x != nil {
...
var file_CancelCacheNotifyCsReq_proto_rawDesc = []byte{
	...
	,
...
var file_CancelCacheNotifyCsReq_proto_goTypes = []interface{}{
	...
	(MCFFICIIOHO)(0),               // 1: MCFFICIIOHO
}
var file_CancelCacheNotifyCsReq_proto_depIdxs = []int32{
	1, // 0: CancelCacheNotifyCsReq.type:type_name -> MCFFICIIOHO
