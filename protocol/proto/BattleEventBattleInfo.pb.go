...
type BattleEventBattleInfo struct {
	...
	SkillInfo     []*LGJAJMEHHID       `protobuf:"bytes,3,rep,name=skill_info,json=skillInfo,proto3" json:"skill_info,omitempty"`
}
...
func (x *BattleEventBattleInfo) GetSkillInfo() []*LGJAJMEHHID {
	if x != nil {
		return x.SkillInfo
	}
	return nil
...
var file_BattleEventBattleInfo_proto_rawDesc = []byte{
	...
	0x47, 0x4a, 0x41, 0x4a, 0x4d, 0x45, 0x48, 0x48, 0x49, 0x44, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x0c, 0x2e, 0x4c, 0x47, 0x4a, 0x41, 0x4a, 0x4d, 0x45, 0x48, 0x48, 0x49, 0x44, 0x52, 0x09, 0x73,
	0x6b, 0x69, 0x6c, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x28, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70,
