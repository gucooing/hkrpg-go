...
type BattleEventBattleInfo struct {
	...
	SkillInfo     []*ELBDNIGGHOE       `protobuf:"bytes,3,rep,name=skill_info,json=skillInfo,proto3" json:"skill_info,omitempty"`
}
...
func (x *BattleEventBattleInfo) GetSkillInfo() []*ELBDNIGGHOE {
	if x != nil {
		return x.SkillInfo
	}
	return nil
...
var file_BattleEventBattleInfo_proto_rawDesc = []byte{
	...
	0x0c, 0x2e, 0x45, 0x4c, 0x42, 0x44, 0x4e, 0x49, 0x47, 0x47, 0x48, 0x4f, 0x45, 0x52, 0x09, 0x73,
