...
type BattleEventBattleInfo struct {
	...
	SkillInfo     []*HFDPIOCJMLH       `protobuf:"bytes,3,rep,name=skill_info,json=skillInfo,proto3" json:"skill_info,omitempty"`
}
...
func (x *BattleEventBattleInfo) GetSkillInfo() []*HFDPIOCJMLH {
	if x != nil {
		return x.SkillInfo
	}
	return nil
...
var file_BattleEventBattleInfo_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x48, 0x46, 0x44, 0x50, 0x49, 0x4f,
	0x43, 0x4a, 0x4d, 0x4c, 0x48, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9a, 0x01, 0x0a, 0x15,
	...
	0x0c, 0x2e, 0x48, 0x46, 0x44, 0x50, 0x49, 0x4f, 0x43, 0x4a, 0x4d, 0x4c, 0x48, 0x52, 0x09, 0x73,
	0x6b, 0x69, 0x6c, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70,
