...
type MuseumRandomEventStartScNotify struct {
	...
	Info *CIBFGBHDPAM `protobuf:"bytes,7,opt,name=info,proto3" json:"info,omitempty"`
}
...
func (x *MuseumRandomEventStartScNotify) GetInfo() *CIBFGBHDPAM {
	if x != nil {
		return x.Info
	}
	return nil
...
var file_MuseumRandomEventStartScNotify_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x43, 0x49, 0x42, 0x46, 0x47, 0x42, 0x48, 0x44,
	0x50, 0x41, 0x4d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x42, 0x0a, 0x1e, 0x4d, 0x75, 0x73,
	...
	0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x43, 0x49, 0x42, 0x46,
	0x47, 0x42, 0x48, 0x44, 0x50, 0x41, 0x4d, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x42, 0x2e, 0x5a,
...
var file_MuseumRandomEventStartScNotify_proto_depIdxs = []int32{
	1, // 0: MuseumRandomEventStartScNotify.info:type_name -> CIBFGBHDPAM
