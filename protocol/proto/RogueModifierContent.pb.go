...
type RogueModifierContent struct {
	...
	ContentModifierEffectId uint32                   `protobuf:"varint,3,opt,name=content_modifier_effect_id,json=contentModifierEffectId,proto3" json:"content_modifier_effect_id,omitempty"` // 14
	ModifierContentType     RogueModifierContentType `protobuf:"varint,7,opt,name=modifier_content_type,json=modifierContentType,proto3,enum=RogueModifierContentType" json:"modifier_content_type,omitempty"`
	GFDNEJLPCMB             uint32                   `protobuf:"varint,14,opt,name=GFDNEJLPCMB,proto3" json:"GFDNEJLPCMB,omitempty"`
}
...
func (x *RogueModifierContent) GetGFDNEJLPCMB() uint32 {
	if x != nil {
		return x.GFDNEJLPCMB
	}
	return 0
}
...
var file_RogueModifierContent_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x17, 0x63, 0x6f, 0x6e, 0x74, 0x65,
	...
	0x65, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x46, 0x44, 0x4e, 0x45, 0x4a, 0x4c, 0x50, 0x43, 0x4d, 0x42,
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x47, 0x46, 0x44, 0x4e, 0x45, 0x4a, 0x4c, 0x50,
	0x43, 0x4d, 0x42, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
