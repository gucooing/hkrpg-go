...
type RogueModifierContent struct {
	...
	ContentModifierEffectId uint32                   `protobuf:"varint,13,opt,name=content_modifier_effect_id,json=contentModifierEffectId,proto3" json:"content_modifier_effect_id,omitempty"` // 7
	...
	KELBGBDDDJO             uint32                   `protobuf:"varint,7,opt,name=KELBGBDDDJO,proto3" json:"KELBGBDDDJO,omitempty"`
}
...
func (x *RogueModifierContent) GetKELBGBDDDJO() uint32 {
	if x != nil {
		return x.KELBGBDDDJO
	}
	return 0
}
...
var file_RogueModifierContent_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x17, 0x63, 0x6f, 0x6e, 0x74, 0x65,
	...
	0x65, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x45, 0x4c, 0x42, 0x47, 0x42, 0x44, 0x44, 0x44, 0x4a, 0x4f,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x45, 0x4c, 0x42, 0x47, 0x42, 0x44, 0x44,
	0x44, 0x4a, 0x4f, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
