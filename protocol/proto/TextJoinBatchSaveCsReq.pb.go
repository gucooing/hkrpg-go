...
type TextJoinBatchSaveCsReq struct {
	...
	TextJoinList []*TextJoinInfo `protobuf:"bytes,14,rep,name=text_join_list,json=textJoinList,proto3" json:"text_join_list,omitempty"`
}
...
var file_TextJoinBatchSaveCsReq_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x78, 0x74, 0x5f, 0x6a, 0x6f, 0x69, 0x6e, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e,
