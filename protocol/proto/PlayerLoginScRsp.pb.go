...
type PlayerLoginScRsp struct {
	...
	NDFEAEIHBFJ       string           `protobuf:"bytes,6,opt,name=NDFEAEIHBFJ,proto3" json:"NDFEAEIHBFJ,omitempty"`
	Retcode           uint32           `protobuf:"varint,10,opt,name=retcode,proto3" json:"retcode,omitempty"`
	CurTimezone       int32            `protobuf:"varint,7,opt,name=cur_timezone,json=curTimezone,proto3" json:"cur_timezone,omitempty"`
	...
	Stamina           uint32           `protobuf:"varint,14,opt,name=stamina,proto3" json:"stamina,omitempty"`
	LoginRandom       uint64           `protobuf:"varint,2,opt,name=login_random,json=loginRandom,proto3" json:"login_random,omitempty"`
	LJMFOHLOBCI       bool             `protobuf:"varint,3,opt,name=LJMFOHLOBCI,proto3" json:"LJMFOHLOBCI,omitempty"`
	DMAAMAMCNKJ       string           `protobuf:"bytes,12,opt,name=DMAAMAMCNKJ,proto3" json:"DMAAMAMCNKJ,omitempty"`
	JOPPAENDMFJ       bool             `protobuf:"varint,9,opt,name=JOPPAENDMFJ,proto3" json:"JOPPAENDMFJ,omitempty"`
}
...
func (x *PlayerLoginScRsp) GetNDFEAEIHBFJ() string {
	if x != nil {
		return x.NDFEAEIHBFJ
	}
	return ""
}
...
func (x *PlayerLoginScRsp) GetLJMFOHLOBCI() bool {
	if x != nil {
		return x.LJMFOHLOBCI
	}
	return false
}

func (x *PlayerLoginScRsp) GetDMAAMAMCNKJ() string {
	if x != nil {
		return x.DMAAMAMCNKJ
	}
	return ""
}

func (x *PlayerLoginScRsp) GetJOPPAENDMFJ() bool {
	if x != nil {
		return x.JOPPAENDMFJ
	}
	return false
}
...
var file_PlayerLoginScRsp_proto_rawDesc = []byte{
	...
	,
