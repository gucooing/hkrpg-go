...
type ChessRogueQueryBpScRsp struct {
	...
	Info    *FPENCNJJCHP `protobuf:"bytes,14,opt,name=info,proto3" json:"info,omitempty"`
...
func (x *ChessRogueQueryBpScRsp) GetInfo() *FPENCNJJCHP {
	if x != nil {
		return x.Info
	}
	return nil
...
var file_ChessRogueQueryBpScRsp_proto_rawDesc = []byte{
	...
	0x46, 0x50, 0x45, 0x4e, 0x43, 0x4e, 0x4a, 0x4a, 0x43, 0x48, 0x50, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x6e, 0x66, 0x6f, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x46, 0x50, 0x45, 0x4e,
	0x43, 0x4e, 0x4a, 0x4a, 0x43, 0x48, 0x50, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x18, 0x0a,
...
var file_ChessRogueQueryBpScRsp_proto_goTypes = []interface{}{
	...
	(*FPENCNJJCHP)(nil),            // 1: FPENCNJJCHP
}
var file_ChessRogueQueryBpScRsp_proto_depIdxs = []int32{
	1, // 0: ChessRogueQueryBpScRsp.info:type_name -> FPENCNJJCHP
