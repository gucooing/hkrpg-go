...
type AvatarExpUpCsReq struct {
	...
	ItemCost     *ItemCostData `protobuf:"bytes,10,opt,name=item_cost,json=itemCost,proto3" json:"item_cost,omitempty"`
}
...
var file_AvatarExpUpCsReq_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x49, 0x74, 0x65, 0x6d,
