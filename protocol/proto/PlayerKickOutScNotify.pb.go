...
type PlayerKickOutScNotify struct {
	...
	BlackInfo *BlackInfo `protobuf:"bytes,4,opt,name=black_info,json=blackInfo,proto3" json:"black_info,omitempty"`
	KickType  KickType   `protobuf:"varint,9,opt,name=kick_type,json=kickType,proto3,enum=KickType" json:"kick_type,omitempty"`
}
...
var file_PlayerKickOutScNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x42, 0x6c,
	...
	0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x4b, 0x69, 0x63, 0x6b, 0x54, 0x79, 0x70, 0x65,
