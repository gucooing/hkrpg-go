...
type FightEnterCsReq struct {
	...
	HOEFNICOFOO uint64 `protobuf:"varint,6,opt,name=HOEFNICOFOO,proto3" json:"HOEFNICOFOO,omitempty"`
	EOGAEEDMFNN string `protobuf:"bytes,3,opt,name=EOGAEEDMFNN,proto3" json:"EOGAEEDMFNN,omitempty"`
	Uid         uint32 `protobuf:"varint,14,opt,name=uid,proto3" json:"uid,omitempty"`
	FFLIBKEMJEB uint32 `protobuf:"varint,9,opt,name=FFLIBKEMJEB,proto3" json:"FFLIBKEMJEB,omitempty"`
	PBPOMEFNNGM uint32 `protobuf:"varint,10,opt,name=PBPOMEFNNGM,proto3" json:"PBPOMEFNNGM,omitempty"`
	Platform    uint32 `protobuf:"varint,11,opt,name=platform,proto3" json:"platform,omitempty"`
	FBLBMBDDHGE uint32 `protobuf:"varint,4,opt,name=FBLBMBDDHGE,proto3" json:"FBLBMBDDHGE,omitempty"`
...
func (x *FightEnterCsReq) GetHOEFNICOFOO() uint64 {
	if x != nil {
		return x.HOEFNICOFOO
	}
	return 0
}

func (x *FightEnterCsReq) GetEOGAEEDMFNN() string {
	if x != nil {
		return x.EOGAEEDMFNN
	}
	return ""
}
...
func (x *FightEnterCsReq) GetFFLIBKEMJEB() uint32 {
	if x != nil {
		return x.FFLIBKEMJEB
	}
	return 0
}

func (x *FightEnterCsReq) GetPBPOMEFNNGM() uint32 {
	if x != nil {
		return x.PBPOMEFNNGM
	}
	return 0
}
...
func (x *FightEnterCsReq) GetFBLBMBDDHGE() uint32 {
	if x != nil {
		return x.FBLBMBDDHGE
	}
	return 0
}
...
var file_FightEnterCsReq_proto_rawDesc = []byte{
	...
	,
