...
type SceneMonsterWave struct {
	...
	DropList    []*ItemList            `protobuf:"bytes,9,rep,name=drop_list,json=dropList,proto3" json:"drop_list,omitempty"`
	StageId     uint32                 `protobuf:"varint,13,opt,name=stage_id,json=stageId,proto3" json:"stage_id,omitempty"`
	MonsterList []*SceneMonster        `protobuf:"bytes,10,rep,name=monster_list,json=monsterList,proto3" json:"monster_list,omitempty"`
	WaveParam   *SceneMonsterWaveParam `protobuf:"bytes,5,opt,name=wave_param,json=waveParam,proto3" json:"wave_param,omitempty"`
}
...
var file_SceneMonsterWave_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x49, 0x74, 0x65,
	...
	0x77, 0x61, 0x76, 0x65, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
