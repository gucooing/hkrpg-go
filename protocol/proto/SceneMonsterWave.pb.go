...
type SceneMonsterWave struct {
	...
	WaveId      uint32                 `protobuf:"varint,11,opt,name=wave_id,json=waveId,proto3" json:"wave_id,omitempty"`
	DropList    []*ItemList            `protobuf:"bytes,6,rep,name=drop_list,json=dropList,proto3" json:"drop_list,omitempty"`
	StageId     uint32                 `protobuf:"varint,9,opt,name=stage_id,json=stageId,proto3" json:"stage_id,omitempty"`
	MonsterList []*SceneMonster        `protobuf:"bytes,8,rep,name=monster_list,json=monsterList,proto3" json:"monster_list,omitempty"`
...
var file_SceneMonsterWave_proto_rawDesc = []byte{
	...
	0x0a, 0x07, 0x77, 0x61, 0x76, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x06, 0x77, 0x61, 0x76, 0x65, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x09, 0x64, 0x72, 0x6f, 0x70, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x49, 0x74, 0x65,
