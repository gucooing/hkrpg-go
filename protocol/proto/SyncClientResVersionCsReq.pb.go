...
type SyncClientResVersionCsReq struct {
	...
	ClientResVersion uint32 `protobuf:"varint,1,opt,name=client_res_version,json=clientResVersion,proto3" json:"client_res_version,omitempty"`
}
...
var file_SyncClientResVersionCsReq_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x63, 0x6c, 0x69, 0x65,
