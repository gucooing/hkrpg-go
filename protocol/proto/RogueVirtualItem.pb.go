...
type RogueVirtualItem struct {
	...
	Sus         uint32 `protobuf:"varint,8,opt,name=sus,proto3" json:"sus,omitempty"`
	RogueMoney  uint32 `protobuf:"varint,9,opt,name=rogue_money,json=rogueMoney,proto3" json:"rogue_money,omitempty"`
	DCJBMAPNHBA uint32 `protobuf:"varint,4,opt,name=DCJBMAPNHBA,proto3" json:"DCJBMAPNHBA,omitempty"`
	GCAGLBCHOCN uint32 `protobuf:"varint,5,opt,name=GCAGLBCHOCN,proto3" json:"GCAGLBCHOCN,omitempty"`
}
...
func (x *RogueVirtualItem) GetSus() uint32 {
	if x != nil {
		return x.Sus
	}
	return 0
...
func (x *RogueVirtualItem) GetDCJBMAPNHBA() uint32 {
	if x != nil {
		return x.DCJBMAPNHBA
	}
	return 0
}

func (x *RogueVirtualItem) GetGCAGLBCHOCN() uint32 {
	if x != nil {
		return x.GCAGLBCHOCN
	}
	return 0
}
...
var file_RogueVirtualItem_proto_rawDesc = []byte{
	...
	,
