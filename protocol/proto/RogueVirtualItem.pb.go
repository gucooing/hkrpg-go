...
type RogueVirtualItem struct {
	...
	BNPOBEBNLJM uint32 `protobuf:"varint,12,opt,name=BNPOBEBNLJM,proto3" json:"BNPOBEBNLJM,omitempty"`
	RogueMoney  uint32 `protobuf:"varint,7,opt,name=rogue_money,json=rogueMoney,proto3" json:"rogue_money,omitempty"` // 12 3 8
	KOBNNGIMGEJ uint32 `protobuf:"varint,3,opt,name=KOBNNGIMGEJ,proto3" json:"KOBNNGIMGEJ,omitempty"`
	FFAACFIPNPH uint32 `protobuf:"varint,8,opt,name=FFAACFIPNPH,proto3" json:"FFAACFIPNPH,omitempty"`
}
...
func (x *RogueVirtualItem) GetBNPOBEBNLJM() uint32 {
	if x != nil {
		return x.BNPOBEBNLJM
	}
	return 0
}
...
func (x *RogueVirtualItem) GetKOBNNGIMGEJ() uint32 {
	if x != nil {
		return x.KOBNNGIMGEJ
	}
	return 0
}

func (x *RogueVirtualItem) GetFFAACFIPNPH() uint32 {
	if x != nil {
		return x.FFAACFIPNPH
	}
	return 0
}
...
var file_RogueVirtualItem_proto_rawDesc = []byte{
	...
	0x0b, 0x42, 0x4e, 0x50, 0x4f, 0x42, 0x45, 0x42, 0x4e, 0x4c, 0x4a, 0x4d, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x42, 0x4e, 0x50, 0x4f, 0x42, 0x45, 0x42, 0x4e, 0x4c, 0x4a, 0x4d, 0x12,
	...
	0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x4f, 0x42, 0x4e, 0x4e, 0x47, 0x49, 0x4d, 0x47, 0x45, 0x4a, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x4f, 0x42, 0x4e, 0x4e, 0x47, 0x49, 0x4d, 0x47,
	0x45, 0x4a, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x46, 0x41, 0x41, 0x43, 0x46, 0x49, 0x50, 0x4e, 0x50,
	0x48, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x46, 0x46, 0x41, 0x41, 0x43, 0x46, 0x49,
	0x50, 0x4e, 0x50, 0x48, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
