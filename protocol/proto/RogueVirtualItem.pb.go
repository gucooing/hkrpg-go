...
type RogueVirtualItem struct {
	...
	ACJKANLIGBM uint32 `protobuf:"varint,10,opt,name=ACJKANLIGBM,proto3" json:"ACJKANLIGBM,omitempty"`
	Money       uint32 `protobuf:"varint,15,opt,name=money,proto3" json:"money,omitempty"`
	DDOPHIJMILL uint32 `protobuf:"varint,9,opt,name=DDOPHIJMILL,proto3" json:"DDOPHIJMILL,omitempty"`
	MFOPPKIBGNJ uint32 `protobuf:"varint,8,opt,name=MFOPPKIBGNJ,proto3" json:"MFOPPKIBGNJ,omitempty"`
}
...
func (x *RogueVirtualItem) GetACJKANLIGBM() uint32 {
	if x != nil {
		return x.ACJKANLIGBM
	}
	return 0
}

func (x *RogueVirtualItem) GetMoney() uint32 {
	if x != nil {
		return x.Money
	}
	return 0
...
func (x *RogueVirtualItem) GetDDOPHIJMILL() uint32 {
	if x != nil {
		return x.DDOPHIJMILL
	}
	return 0
}

func (x *RogueVirtualItem) GetMFOPPKIBGNJ() uint32 {
	if x != nil {
		return x.MFOPPKIBGNJ
	}
	return 0
}
...
var file_RogueVirtualItem_proto_rawDesc = []byte{
	...
	,
