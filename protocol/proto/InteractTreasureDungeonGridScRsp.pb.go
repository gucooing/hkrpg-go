...
type InteractTreasureDungeonGridScRsp struct {
	...
	ANGLIEBKBBM *TreasureDungeonLevel `protobuf:"bytes,2,opt,name=ANGLIEBKBBM,proto3" json:"ANGLIEBKBBM,omitempty"`
...
func (x *InteractTreasureDungeonGridScRsp) GetANGLIEBKBBM() *TreasureDungeonLevel {
	if x != nil {
...
var file_InteractTreasureDungeonGridScRsp_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x64, 0x53, 0x63, 0x52, 0x73, 0x70, 0x12, 0x37, 0x0a, 0x0b, 0x41, 0x4e, 0x47, 0x4c,
	0x49, 0x45, 0x42, 0x4b, 0x42, 0x42, 0x4d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e,
...
var file_InteractTreasureDungeonGridScRsp_proto_depIdxs = []int32{
	1, // 0: InteractTreasureDungeonGridScRsp.ANGLIEBKBBM:type_name -> TreasureDungeonLevel
