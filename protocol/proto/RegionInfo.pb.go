...
func (x *RegionInfo) GetDispatchUrl() string {
	if x != nil {
...
func (x *RegionInfo) GetEnvType() string {
	if x != nil {
		return x.EnvType
	}
	return ""
...
func (x *RegionInfo) GetDisplayName() string {
	if x != nil {
...
func (x *RegionInfo) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_RegionInfo_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa9, 0x01, 0x0a, 0x0a, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66,
	...
	0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x64, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x55, 0x72, 0x6c, 0x12, 0x19,
	0x0a, 0x08, 0x65, 0x6e, 0x76, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x65, 0x6e, 0x76, 0x54, 0x79, 0x70, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x64, 0x69, 0x73,
	...
	0x6d, 0x73, 0x67, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x42, 0x28,
