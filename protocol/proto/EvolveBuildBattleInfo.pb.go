...
type EvolveBuildBattleInfo struct {
	...
	WeaponSlotList        []*ANBDAIBNOAI               `protobuf:"bytes,4,rep,name=weapon_slot_list,json=weaponSlotList,proto3" json:"weapon_slot_list,omitempty"`
	AccessorySlotList     []*ANBDAIBNOAI               `protobuf:"bytes,5,rep,name=accessory_slot_list,json=accessorySlotList,proto3" json:"accessory_slot_list,omitempty"`
	BanGearList           []uint32                     `protobuf:"varint,6,rep,packed,name=ban_gear_list,json=banGearList,proto3" json:"ban_gear_list,omitempty"`
	Collection            *GFICABEFOFD                 `protobuf:"bytes,7,opt,name=collection,proto3" json:"collection,omitempty"`
	...
	CardList              []*LENKFNKPHDK               `protobuf:"bytes,17,rep,name=card_list,json=cardList,proto3" json:"card_list,omitempty"`
	...
	StatLogInfo           *PHDMPFFLOEA                 `protobuf:"bytes,22,opt,name=stat_log_info,json=statLogInfo,proto3" json:"stat_log_info,omitempty"`
...
func (x *EvolveBuildBattleInfo) GetWeaponSlotList() []*ANBDAIBNOAI {
	if x != nil {
...
func (x *EvolveBuildBattleInfo) GetAccessorySlotList() []*ANBDAIBNOAI {
	if x != nil {
...
func (x *EvolveBuildBattleInfo) GetCollection() *GFICABEFOFD {
	if x != nil {
		return x.Collection
	}
	return nil
...
func (x *EvolveBuildBattleInfo) GetCardList() []*LENKFNKPHDK {
	if x != nil {
		return x.CardList
	}
	return nil
...
func (x *EvolveBuildBattleInfo) GetStatLogInfo() *PHDMPFFLOEA {
	if x != nil {
...
var file_EvolveBuildBattleInfo_proto_rawDesc = []byte{
	...
	0x41, 0x4e, 0x42, 0x44, 0x41, 0x49, 0x42, 0x4e, 0x4f, 0x41, 0x49, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x1a, 0x11, 0x50, 0x48, 0x44, 0x4d, 0x50, 0x46, 0x46, 0x4c, 0x4f, 0x45, 0x41, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x4c, 0x45, 0x4e, 0x4b, 0x46, 0x4e, 0x4b, 0x50, 0x48, 0x44,
	0x4b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x47, 0x46, 0x49, 0x43, 0x41, 0x42, 0x45,
	0x46, 0x4f, 0x46, 0x44, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe9, 0x07, 0x0a, 0x15, 0x45,
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x41, 0x4e, 0x42,
	0x44, 0x41, 0x49, 0x42, 0x4e, 0x4f, 0x41, 0x49, 0x52, 0x0e, 0x77, 0x65, 0x61, 0x70, 0x6f, 0x6e,
	...
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x41, 0x4e, 0x42, 0x44, 0x41, 0x49, 0x42, 0x4e,
	0x4f, 0x41, 0x49, 0x52, 0x11, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x79, 0x53, 0x6c,
	...
	0x2e, 0x47, 0x46, 0x49, 0x43, 0x41, 0x42, 0x45, 0x46, 0x4f, 0x46, 0x44, 0x52, 0x0a, 0x63, 0x6f,
	...
	0x2e, 0x4c, 0x45, 0x4e, 0x4b, 0x46, 0x4e, 0x4b, 0x50, 0x48, 0x44, 0x4b, 0x52, 0x08, 0x63, 0x61,
	...
	0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x50, 0x48, 0x44, 0x4d, 0x50, 0x46, 0x46, 0x4c, 0x4f, 0x45, 0x41,
...
var file_EvolveBuildBattleInfo_proto_goTypes = []interface{}{
	...
	(*ANBDAIBNOAI)(nil),               // 1: ANBDAIBNOAI
	(*GFICABEFOFD)(nil),               // 2: GFICABEFOFD
	(*LENKFNKPHDK)(nil),               // 3: LENKFNKPHDK
	(*EvolveBuildGearDamageInfo)(nil), // 4: EvolveBuildGearDamageInfo
	(*PHDMPFFLOEA)(nil),               // 5: PHDMPFFLOEA
}
var file_EvolveBuildBattleInfo_proto_depIdxs = []int32{
	1, // 0: EvolveBuildBattleInfo.weapon_slot_list:type_name -> ANBDAIBNOAI
	1, // 1: EvolveBuildBattleInfo.accessory_slot_list:type_name -> ANBDAIBNOAI
	2, // 2: EvolveBuildBattleInfo.collection:type_name -> GFICABEFOFD
	3, // 3: EvolveBuildBattleInfo.card_list:type_name -> LENKFNKPHDK
	4, // 4: EvolveBuildBattleInfo.gear_damage_list:type_name -> EvolveBuildGearDamageInfo
	5, // 5: EvolveBuildBattleInfo.stat_log_info:type_name -> PHDMPFFLOEA
...
func file_EvolveBuildBattleInfo_proto_init() {
	...
	file_ANBDAIBNOAI_proto_init()
	file_PHDMPFFLOEA_proto_init()
	file_LENKFNKPHDK_proto_init()
	file_GFICABEFOFD_proto_init()
	if !protoimpl.UnsafeEnabled {
