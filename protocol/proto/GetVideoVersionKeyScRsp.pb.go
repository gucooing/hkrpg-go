...
type GetVideoVersionKeyScRsp struct {
	...
	VideoKeyInfoList         []*VideoKeyInfo `protobuf:"bytes,14,rep,name=video_key_info_list,json=videoKeyInfoList,proto3" json:"video_key_info_list,omitempty"`
	ActivityVideoKeyInfoList []*VideoKeyInfo `protobuf:"bytes,5,rep,name=activity_video_key_info_list,json=activityVideoKeyInfoList,proto3" json:"activity_video_key_info_list,omitempty"`
}
...
var file_GetVideoVersionKeyScRsp_proto_rawDesc = []byte{
	...
	0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x4b, 0x65,
