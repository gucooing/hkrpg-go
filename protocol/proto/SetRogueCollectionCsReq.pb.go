...
type SetRogueCollectionCsReq struct {
	...
	LAECCEAFAKD []RogueCollectionExhibitionOperateType `protobuf:"varint,2,rep,packed,name=LAECCEAFAKD,proto3,enum=RogueCollectionExhibitionOperateType" json:"LAECCEAFAKD,omitempty"`
	PKMIOMOOILK []uint32                               `protobuf:"varint,15,rep,packed,name=PKMIOMOOILK,proto3" json:"PKMIOMOOILK,omitempty"`
	KGBJDEPIGLC []uint32                               `protobuf:"varint,7,rep,packed,name=KGBJDEPIGLC,proto3" json:"KGBJDEPIGLC,omitempty"`
}
...
func (x *SetRogueCollectionCsReq) GetLAECCEAFAKD() []RogueCollectionExhibitionOperateType {
	if x != nil {
		return x.LAECCEAFAKD
	}
	return nil
}

func (x *SetRogueCollectionCsReq) GetPKMIOMOOILK() []uint32 {
	if x != nil {
		return x.PKMIOMOOILK
	}
	return nil
}

func (x *SetRogueCollectionCsReq) GetKGBJDEPIGLC() []uint32 {
	if x != nil {
		return x.KGBJDEPIGLC
	}
	return nil
}
...
var file_SetRogueCollectionCsReq_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x43, 0x73, 0x52, 0x65, 0x71, 0x12, 0x47, 0x0a, 0x0b, 0x4c, 0x41, 0x45, 0x43, 0x43,
	0x45, 0x41, 0x46, 0x41, 0x4b, 0x44, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x25, 0x2e, 0x52,
	...
	0x79, 0x70, 0x65, 0x52, 0x0b, 0x4c, 0x41, 0x45, 0x43, 0x43, 0x45, 0x41, 0x46, 0x41, 0x4b, 0x44,
	0x12, 0x20, 0x0a, 0x0b, 0x50, 0x4b, 0x4d, 0x49, 0x4f, 0x4d, 0x4f, 0x4f, 0x49, 0x4c, 0x4b, 0x18,
	0x0f, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x4b, 0x4d, 0x49, 0x4f, 0x4d, 0x4f, 0x4f, 0x49,
	0x4c, 0x4b, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x47, 0x42, 0x4a, 0x44, 0x45, 0x50, 0x49, 0x47, 0x4c,
	0x43, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x47, 0x42, 0x4a, 0x44, 0x45, 0x50,
	0x49, 0x47, 0x4c, 0x43, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_SetRogueCollectionCsReq_proto_depIdxs = []int32{
	1, // 0: SetRogueCollectionCsReq.LAECCEAFAKD:type_name -> RogueCollectionExhibitionOperateType
