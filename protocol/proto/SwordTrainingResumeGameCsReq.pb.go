...
type SwordTrainingResumeGameCsReq struct {
	...
	GameStoryLineId uint32 `protobuf:"varint,5,opt,name=game_story_line_id,json=gameStoryLineId,proto3" json:"game_story_line_id,omitempty"`
}
...
var file_SwordTrainingResumeGameCsReq_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x5f, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d,
