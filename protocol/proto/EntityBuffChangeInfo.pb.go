...
type EntityBuffChangeInfo struct {
	...
	BuffChangeInfo *BuffInfo                 `protobuf:"bytes,6,opt,name=buff_change_info,json=buffChangeInfo,proto3" json:"buff_change_info,omitempty"`
	RemoveBuffId   uint32                    `protobuf:"varint,7,opt,name=remove_buff_id,json=removeBuffId,proto3" json:"remove_buff_id,omitempty"`
	Reason         SceneEntityBuffChangeType `protobuf:"varint,11,opt,name=reason,proto3,enum=SceneEntityBuffChangeType" json:"reason,omitempty"`
}
...
var file_EntityBuffChangeInfo_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1f, 0x53, 0x63,
	0x65, 0x6e, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0x75, 0x66, 0x66, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0e, 0x42,
	0x75, 0x66, 0x66, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc2, 0x01,
	0x0a, 0x14, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0x75, 0x66, 0x66, 0x43, 0x68, 0x61, 0x6e,
	...
	,
...
var file_EntityBuffChangeInfo_proto_goTypes = []interface{}{
	...
	(SceneEntityBuffChangeType)(0), // 2: SceneEntityBuffChangeType
}
var file_EntityBuffChangeInfo_proto_depIdxs = []int32{
	1, // 0: EntityBuffChangeInfo.buff_change_info:type_name -> BuffInfo
	2, // 1: EntityBuffChangeInfo.reason:type_name -> SceneEntityBuffChangeType
