...
type EntityBuffChangeInfo struct {
	...
	AddBuffInfo  *BuffInfo `protobuf:"bytes,2,opt,name=add_buff_info,json=addBuffInfo,proto3" json:"add_buff_info,omitempty"`
	RemoveBuffId uint32    `protobuf:"varint,8,opt,name=remove_buff_id,json=removeBuffId,proto3" json:"remove_buff_id,omitempty"`
...
var file_EntityBuffChangeInfo_proto_rawDesc = []byte{
	...
	0x66, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x42,
	...
	0x75, 0x66, 0x66, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x72, 0x65,
