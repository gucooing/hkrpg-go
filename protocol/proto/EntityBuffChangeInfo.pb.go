...
type EntityBuffChangeInfo struct {
	...
	//
	//	*EntityBuffChangeInfo_AddBuffInfo
	//	*EntityBuffChangeInfo_RemoveBuffId
	Info     isEntityBuffChangeInfo_Info `protobuf_oneof:"info"`
...
func (m *EntityBuffChangeInfo) GetInfo() isEntityBuffChangeInfo_Info {
	if m != nil {
		return m.Info
	}
	return nil
...
func (x *EntityBuffChangeInfo) GetAddBuffInfo() *BuffInfo {
	if x, ok := x.GetInfo().(*EntityBuffChangeInfo_AddBuffInfo); ok {
...
func (x *EntityBuffChangeInfo) GetRemoveBuffId() uint32 {
	if x, ok := x.GetInfo().(*EntityBuffChangeInfo_RemoveBuffId); ok {
...
type isEntityBuffChangeInfo_Info interface {
	isEntityBuffChangeInfo_Info()
}

type EntityBuffChangeInfo_AddBuffInfo struct {
	AddBuffInfo *BuffInfo `protobuf:"bytes,4,opt,name=add_buff_info,json=addBuffInfo,proto3,oneof"`
}

type EntityBuffChangeInfo_RemoveBuffId struct {
	RemoveBuffId uint32 `protobuf:"varint,5,opt,name=remove_buff_id,json=removeBuffId,proto3,oneof"`
}

func (*EntityBuffChangeInfo_AddBuffInfo) isEntityBuffChangeInfo_Info() {}

func (*EntityBuffChangeInfo_RemoveBuffId) isEntityBuffChangeInfo_Info() {}
...
var file_EntityBuffChangeInfo_proto_rawDesc = []byte{
	...
	,
...
func file_EntityBuffChangeInfo_proto_init() {
	...
	file_EntityBuffChangeInfo_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*EntityBuffChangeInfo_AddBuffInfo)(nil),
