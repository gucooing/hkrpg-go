...
type MarkRelicFilterPlanScRsp struct {
	...
	SlotIndexList []uint32 `protobuf:"varint,3,rep,packed,name=SlotIndexList,proto3" json:"SlotIndexList,omitempty"`
	IsMark        bool     `protobuf:"varint,8,opt,name=IsMark,proto3" json:"IsMark,omitempty"`
	IsBatchOp     bool     `protobuf:"varint,9,opt,name=IsBatchOp,proto3" json:"IsBatchOp,omitempty"`
}
...
func (x *MarkRelicFilterPlanScRsp) GetSlotIndexList() []uint32 {
	if x != nil {
...
func (x *MarkRelicFilterPlanScRsp) GetIsMark() bool {
	if x != nil {
		return x.IsMark
	}
	return false
...
func (x *MarkRelicFilterPlanScRsp) GetIsBatchOp() bool {
	if x != nil {
		return x.IsBatchOp
	}
	return false
...
var file_MarkRelicFilterPlanScRsp_proto_rawDesc = []byte{
	...
	0x22, 0x90, 0x01, 0x0a, 0x18, 0x4d, 0x61, 0x72, 0x6b, 0x52, 0x65, 0x6c, 0x69, 0x63, 0x46, 0x69,
	...
	0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x53, 0x6c, 0x6f, 0x74, 0x49,
	0x6e, 0x64, 0x65, 0x78, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0d,
	0x53, 0x6c, 0x6f, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x16, 0x0a,
	0x06, 0x49, 0x73, 0x4d, 0x61, 0x72, 0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x49,
	0x73, 0x4d, 0x61, 0x72, 0x6b, 0x12, 0x1c, 0x0a, 0x09, 0x49, 0x73, 0x42, 0x61, 0x74, 0x63, 0x68,
	0x4f, 0x70, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x49, 0x73, 0x42, 0x61, 0x74, 0x63,
	0x68, 0x4f, 0x70, 0x42, 0x2e, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
