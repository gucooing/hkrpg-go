...
type GroupStateInfo struct {
	...
	GroupState  uint32 `protobuf:"varint,13,opt,name=group_state,json=groupState,proto3" json:"group_state,omitempty"` // 7
	GroupId     uint32 `protobuf:"varint,8,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	EKAAFFIAFJB uint32 `protobuf:"varint,7,opt,name=EKAAFFIAFJB,proto3" json:"EKAAFFIAFJB,omitempty"` // 13
}
...
func (x *GroupStateInfo) GetEKAAFFIAFJB() uint32 {
	if x != nil {
		return x.EKAAFFIAFJB
	}
	return 0
}
...
var file_GroupStateInfo_proto_rawDesc = []byte{
	...
	,
