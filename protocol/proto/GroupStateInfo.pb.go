...
type GroupStateInfo struct {
	...
	IEDEBJMAAHH uint32 `protobuf:"varint,14,opt,name=IEDEBJMAAHH,proto3" json:"IEDEBJMAAHH,omitempty"` // 2
	EntryId     uint32 `protobuf:"varint,7,opt,name=entry_id,json=entryId,proto3" json:"entry_id,omitempty"`
	GroupState  uint32 `protobuf:"varint,2,opt,name=group_state,json=groupState,proto3" json:"group_state,omitempty"` // 14
...
func (x *GroupStateInfo) GetIEDEBJMAAHH() uint32 {
	if x != nil {
		return x.IEDEBJMAAHH
	}
	return 0
}
...
var file_GroupStateInfo_proto_rawDesc = []byte{
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x49, 0x45, 0x44,
	0x45, 0x42, 0x4a, 0x4d, 0x41, 0x41, 0x48, 0x48, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b,
	0x49, 0x45, 0x44, 0x45, 0x42, 0x4a, 0x4d, 0x41, 0x41, 0x48, 0x48, 0x12, 0x19, 0x0a, 0x08, 0x65,
	0x6e, 0x74, 0x72, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x65,
	0x6e, 0x74, 0x72, 0x79, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70,
