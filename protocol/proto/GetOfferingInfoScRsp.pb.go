...
type GetOfferingInfoScRsp struct {
	...
	KELCIDDBBIL []*EPMNGCPCBKL `protobuf:"bytes,9,rep,name=KELCIDDBBIL,proto3" json:"KELCIDDBBIL,omitempty"`
}
...
func (x *GetOfferingInfoScRsp) GetKELCIDDBBIL() []*EPMNGCPCBKL {
	if x != nil {
		return x.KELCIDDBBIL
	}
	return nil
}
...
var file_GetOfferingInfoScRsp_proto_rawDesc = []byte{
	...
	0x6f, 0x53, 0x63, 0x52, 0x73, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x45, 0x50,
	...
	0x65, 0x12, 0x2e, 0x0a, 0x0b, 0x4b, 0x45, 0x4c, 0x43, 0x49, 0x44, 0x44, 0x42, 0x42, 0x49, 0x4c,
	0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x45, 0x50, 0x4d, 0x4e, 0x47, 0x43, 0x50,
	0x43, 0x42, 0x4b, 0x4c, 0x52, 0x0b, 0x4b, 0x45, 0x4c, 0x43, 0x49, 0x44, 0x44, 0x42, 0x42, 0x49,
...
var file_GetOfferingInfoScRsp_proto_depIdxs = []int32{
	1, // 0: GetOfferingInfoScRsp.KELCIDDBBIL:type_name -> EPMNGCPCBKL
