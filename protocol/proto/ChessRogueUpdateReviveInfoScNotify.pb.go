...
type ChessRogueUpdateReviveInfoScNotify struct {
	...
	ReviveInfo *RogueAvatarReviveCost `protobuf:"bytes,12,opt,name=revive_info,json=reviveInfo,proto3" json:"revive_info,omitempty"`
}
...
var file_ChessRogueUpdateReviveInfoScNotify_proto_rawDesc = []byte{
	...
	0x0b, 0x72, 0x65, 0x76, 0x69, 0x76, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0c, 0x20, 0x01,
