...
type EnterTelevisionActivityStageCsReq struct {
	...
	DNFJOOAJIKG uint32         `protobuf:"varint,3,opt,name=DNFJOOAJIKG,proto3" json:"DNFJOOAJIKG,omitempty"`
	BuffList    []uint32       `protobuf:"varint,4,rep,packed,name=buff_list,json=buffList,proto3" json:"buff_list,omitempty"`
	AvatarList  []*CDFOIPHMOJP `protobuf:"bytes,7,rep,name=avatar_list,json=avatarList,proto3" json:"avatar_list,omitempty"`
}
...
func (x *EnterTelevisionActivityStageCsReq) GetDNFJOOAJIKG() uint32 {
	if x != nil {
...
func (x *EnterTelevisionActivityStageCsReq) GetAvatarList() []*CDFOIPHMOJP {
	if x != nil {
		return x.AvatarList
	}
	return nil
...
var file_EnterTelevisionActivityStageCsReq_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x43, 0x44, 0x46, 0x4f, 0x49,
	0x50, 0x48, 0x4d, 0x4f, 0x4a, 0x50, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x01, 0x0a,
	...
	0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x44, 0x4e, 0x46, 0x4a, 0x4f, 0x4f, 0x41, 0x4a, 0x49, 0x4b,
	0x47, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x44, 0x4e, 0x46, 0x4a, 0x4f, 0x4f, 0x41,
	0x4a, 0x49, 0x4b, 0x47, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x75, 0x66, 0x66, 0x5f, 0x6c, 0x69, 0x73,
	...
	0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x43, 0x44, 0x46, 0x4f, 0x49, 0x50, 0x48,
	0x4d, 0x4f, 0x4a, 0x50, 0x52, 0x0a, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x4c, 0x69, 0x73, 0x74,
...
var file_EnterTelevisionActivityStageCsReq_proto_goTypes = []interface{}{
	...
	(*CDFOIPHMOJP)(nil),                       // 1: CDFOIPHMOJP
}
var file_EnterTelevisionActivityStageCsReq_proto_depIdxs = []int32{
	1, // 0: EnterTelevisionActivityStageCsReq.avatar_list:type_name -> CDFOIPHMOJP
