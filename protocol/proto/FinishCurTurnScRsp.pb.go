...
type FinishCurTurnScRsp struct {
	...
	CEOHKDINAHE uint32 `protobuf:"varint,3,opt,name=CEOHKDINAHE,proto3" json:"CEOHKDINAHE,omitempty"`
}
...
func (x *FinishCurTurnScRsp) GetCEOHKDINAHE() uint32 {
	if x != nil {
		return x.CEOHKDINAHE
	}
	return 0
}
...
var file_FinishCurTurnScRsp_proto_rawDesc = []byte{
	...
	0x0d, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x45,
	0x4f, 0x48, 0x4b, 0x44, 0x49, 0x4e, 0x41, 0x48, 0x45, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x43, 0x45, 0x4f, 0x48, 0x4b, 0x44, 0x49, 0x4e, 0x41, 0x48, 0x45, 0x42, 0x2e, 0x5a, 0x0e,
