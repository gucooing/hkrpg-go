...
type FinishCurTurnScRsp struct {
	...
	NMJPHLOEENH uint32 `protobuf:"varint,15,opt,name=NMJPHLOEENH,proto3" json:"NMJPHLOEENH,omitempty"`
...
func (x *FinishCurTurnScRsp) GetNMJPHLOEENH() uint32 {
	if x != nil {
		return x.NMJPHLOEENH
	}
	return 0
}
...
var file_FinishCurTurnScRsp_proto_rawDesc = []byte{
	...
	0x12, 0x20, 0x0a, 0x0b, 0x4e, 0x4d, 0x4a, 0x50, 0x48, 0x4c, 0x4f, 0x45, 0x45, 0x4e, 0x48, 0x18,
	0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4e, 0x4d, 0x4a, 0x50, 0x48, 0x4c, 0x4f, 0x45, 0x45,
	0x4e, 0x48, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x05, 0x20,
