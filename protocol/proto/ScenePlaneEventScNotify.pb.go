...
type ScenePlaneEventScNotify struct {
	...
	GHOKFLHACEF *ItemList `protobuf:"bytes,6,opt,name=GHOKFLHACEF,proto3" json:"GHOKFLHACEF,omitempty"`
	MFAKDCHPFHC *ItemList `protobuf:"bytes,12,opt,name=MFAKDCHPFHC,proto3" json:"MFAKDCHPFHC,omitempty"`
	NAGPDPMJBKA *ItemList `protobuf:"bytes,9,opt,name=NAGPDPMJBKA,proto3" json:"NAGPDPMJBKA,omitempty"`
}
...
func (x *ScenePlaneEventScNotify) GetGHOKFLHACEF() *ItemList {
	if x != nil {
		return x.GHOKFLHACEF
	}
	return nil
}

func (x *ScenePlaneEventScNotify) GetMFAKDCHPFHC() *ItemList {
	if x != nil {
		return x.MFAKDCHPFHC
	}
	return nil
}

func (x *ScenePlaneEventScNotify) GetNAGPDPMJBKA() *ItemList {
	if x != nil {
		return x.NAGPDPMJBKA
	}
	return nil
}
...
var file_ScenePlaneEventScNotify_proto_rawDesc = []byte{
	...
	,
...
var file_ScenePlaneEventScNotify_proto_depIdxs = []int32{
	...
	1, // 1: ScenePlaneEventScNotify.GHOKFLHACEF:type_name -> ItemList
	1, // 2: ScenePlaneEventScNotify.MFAKDCHPFHC:type_name -> ItemList
	1, // 3: ScenePlaneEventScNotify.NAGPDPMJBKA:type_name -> ItemList
