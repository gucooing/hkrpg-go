...
type ScenePlaneEventScNotify struct {
	...
	GetItemList *ItemList `protobuf:"bytes,3,opt,name=get_item_list,json=getItemList,proto3" json:"get_item_list,omitempty"`
}
...
var file_ScenePlaneEventScNotify_proto_rawDesc = []byte{
	...
	0x74, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
