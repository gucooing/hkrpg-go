...
type ScenePlaneEventScNotify struct {
	...
	COKKHBOPEDB *ItemList `protobuf:"bytes,10,opt,name=COKKHBOPEDB,proto3" json:"COKKHBOPEDB,omitempty"`
	GetItemList *ItemList `protobuf:"bytes,9,opt,name=get_item_list,json=getItemList,proto3" json:"get_item_list,omitempty"`
	LLKMAFOLGCO *ItemList `protobuf:"bytes,6,opt,name=LLKMAFOLGCO,proto3" json:"LLKMAFOLGCO,omitempty"`
	LEILPLGGBLJ *ItemList `protobuf:"bytes,3,opt,name=LEILPLGGBLJ,proto3" json:"LEILPLGGBLJ,omitempty"`
}
...
func (x *ScenePlaneEventScNotify) GetCOKKHBOPEDB() *ItemList {
	if x != nil {
		return x.COKKHBOPEDB
	}
	return nil
}
...
func (x *ScenePlaneEventScNotify) GetLLKMAFOLGCO() *ItemList {
	if x != nil {
		return x.LLKMAFOLGCO
	}
	return nil
}

func (x *ScenePlaneEventScNotify) GetLEILPLGGBLJ() *ItemList {
	if x != nil {
		return x.LEILPLGGBLJ
	}
	return nil
}
...
var file_ScenePlaneEventScNotify_proto_rawDesc = []byte{
	...
	,
...
var file_ScenePlaneEventScNotify_proto_depIdxs = []int32{
	1, // 0: ScenePlaneEventScNotify.COKKHBOPEDB:type_name -> ItemList
	1, // 1: ScenePlaneEventScNotify.get_item_list:type_name -> ItemList
	1, // 2: ScenePlaneEventScNotify.LLKMAFOLGCO:type_name -> ItemList
	1, // 3: ScenePlaneEventScNotify.LEILPLGGBLJ:type_name -> ItemList
