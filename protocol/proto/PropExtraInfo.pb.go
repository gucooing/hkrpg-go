...
type PropExtraInfo_RogueInfo struct {
	RogueInfo *PropRogueInfo `protobuf:"bytes,7,opt,name=rogue_info,json=rogueInfo,proto3,oneof"`
}
...
var file_PropExtraInfo_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x75, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32,
