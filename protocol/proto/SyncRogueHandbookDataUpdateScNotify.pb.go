...
type SyncRogueHandbookDataUpdateScNotify struct {
	...
	BNJFABDDPJJ []*IKKLLNLEPDF `protobuf:"bytes,13,rep,name=BNJFABDDPJJ,proto3" json:"BNJFABDDPJJ,omitempty"`
	CHFAJOMCMCJ []*CABEFCJFAGI `protobuf:"bytes,9,rep,name=CHFAJOMCMCJ,proto3" json:"CHFAJOMCMCJ,omitempty"`
	LILCKKGNLBG []*ABGIMIMBJHI `protobuf:"bytes,5,rep,name=LILCKKGNLBG,proto3" json:"LILCKKGNLBG,omitempty"`
}
...
func (x *SyncRogueHandbookDataUpdateScNotify) GetBNJFABDDPJJ() []*IKKLLNLEPDF {
	if x != nil {
		return x.BNJFABDDPJJ
	}
	return nil
}

func (x *SyncRogueHandbookDataUpdateScNotify) GetCHFAJOMCMCJ() []*CABEFCJFAGI {
	if x != nil {
		return x.CHFAJOMCMCJ
	}
	return nil
}

func (x *SyncRogueHandbookDataUpdateScNotify) GetLILCKKGNLBG() []*ABGIMIMBJHI {
	if x != nil {
		return x.LILCKKGNLBG
	}
	return nil
}
...
var file_SyncRogueHandbookDataUpdateScNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x43, 0x41, 0x42,
	...
	0x6f, 0x1a, 0x11, 0x41, 0x42, 0x47, 0x49, 0x4d, 0x49, 0x4d, 0x42, 0x4a, 0x48, 0x49, 0x2e, 0x70,
	...
	,
...
var file_SyncRogueHandbookDataUpdateScNotify_proto_goTypes = []interface{}{
	...
	(*IKKLLNLEPDF)(nil),                         // 1: IKKLLNLEPDF
	(*CABEFCJFAGI)(nil),                         // 2: CABEFCJFAGI
	(*ABGIMIMBJHI)(nil),                         // 3: ABGIMIMBJHI
}
var file_SyncRogueHandbookDataUpdateScNotify_proto_depIdxs = []int32{
	1, // 0: SyncRogueHandbookDataUpdateScNotify.BNJFABDDPJJ:type_name -> IKKLLNLEPDF
	2, // 1: SyncRogueHandbookDataUpdateScNotify.CHFAJOMCMCJ:type_name -> CABEFCJFAGI
	3, // 2: SyncRogueHandbookDataUpdateScNotify.LILCKKGNLBG:type_name -> ABGIMIMBJHI
