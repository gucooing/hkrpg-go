...
type HandleRogueCommonPendingActionCsReq struct {
	...
	BuffSelectResult *RogueCommonBuffSelectResult `protobuf:"bytes,1139,opt,name=buff_select_result,json=buffSelectResult,proto3" json:"buff_select_result,omitempty"`
	// KINJFMEPCKE LIIGPIFDPLK = 1157;
	// CKGDDAIDEMO OECLKHEGBFM = 1521;
	RollBuff            *RogueBuffRollInfo        `protobuf:"bytes,689,opt,name=roll_buff,json=rollBuff,proto3" json:"roll_buff,omitempty"`
	MiracleSelectResult *RogueMiracleSelectResult `protobuf:"bytes,194,opt,name=miracle_select_result,json=miracleSelectResult,proto3" json:"miracle_select_result,omitempty"`
	// PHDCDDGMOJD MKNBOHDIBMC = 1285;
	// LNKCIHHBMCN LMGOMLNGOCL = 1618;
	// ECNFHANMIJD PCEFILHFHDH = 368;
	// GOGIJMPCNAO FBDCGDPCBNL = 569;
	BonusSelectResult *RogueBonusSelectResult `protobuf:"bytes,136,opt,name=bonus_select_result,json=bonusSelectResult,proto3" json:"bonus_select_result,omitempty"`
}
...
var file_HandleRogueCommonPendingActionCsReq_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x18, 0xf3, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x52, 0x6f, 0x67,
	0x75, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x75, 0x66, 0x66, 0x53, 0x65, 0x6c, 0x65,
	...
	0x6c, 0x6c, 0x5f, 0x62, 0x75, 0x66, 0x66, 0x18, 0xb1, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0xc2, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x52,
	...
	0x75, 0x6c, 0x74, 0x18, 0x88, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x52, 0x6f, 0x67,
