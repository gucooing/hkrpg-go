...
type GetHeroBasicTypeInfoScRsp struct {
	...
	CurBasicType      HeroBasicType        `protobuf:"varint,5,opt,name=cur_basic_type,json=curBasicType,proto3,enum=HeroBasicType" json:"cur_basic_type,omitempty"`
	BasicTypeInfoList []*HeroBasicTypeInfo `protobuf:"bytes,2,rep,name=basic_type_info_list,json=basicTypeInfoList,proto3" json:"basic_type_info_list,omitempty"`
...
var file_GetHeroBasicTypeInfoScRsp_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x5f, 0x62, 0x61, 0x73, 0x69, 0x63, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20,
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x07, 0x2e, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x52,
