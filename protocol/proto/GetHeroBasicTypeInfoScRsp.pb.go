...
type GetHeroBasicTypeInfoScRsp struct {
	...
	CurBasicType      HeroBasicType        `protobuf:"varint,7,opt,name=cur_basic_type,json=curBasicType,proto3,enum=HeroBasicType" json:"cur_basic_type,omitempty"`
...
var file_GetHeroBasicTypeInfoScRsp_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x5f, 0x62, 0x61, 0x73, 0x69, 0x63, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20,
