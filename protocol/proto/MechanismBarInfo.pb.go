...
type MechanismBarInfo struct {
	...
	OMJJJNANJIP uint32 `protobuf:"varint,14,opt,name=OMJJJNANJIP,proto3" json:"OMJJJNANJIP,omitempty"`
...
func (x *MechanismBarInfo) GetOMJJJNANJIP() uint32 {
	if x != nil {
		return x.OMJJJNANJIP
	}
	return 0
}
...
var file_MechanismBarInfo_proto_rawDesc = []byte{
	...
	0x4f, 0x4d, 0x4a, 0x4a, 0x4a, 0x4e, 0x41, 0x4e, 0x4a, 0x49, 0x50, 0x18, 0x0e, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x4f, 0x4d, 0x4a, 0x4a, 0x4a, 0x4e, 0x41, 0x4e, 0x4a, 0x49, 0x50, 0x12, 0x14,
