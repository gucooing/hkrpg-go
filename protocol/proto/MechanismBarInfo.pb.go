...
type MechanismBarInfo struct {
	...
	IFJEOKLKPNK uint32 `protobuf:"varint,9,opt,name=IFJEOKLKPNK,proto3" json:"IFJEOKLKPNK,omitempty"`
...
func (x *MechanismBarInfo) GetIFJEOKLKPNK() uint32 {
	if x != nil {
		return x.IFJEOKLKPNK
	}
	return 0
}
...
var file_MechanismBarInfo_proto_rawDesc = []byte{
	...
	0x49, 0x46, 0x4a, 0x45, 0x4f, 0x4b, 0x4c, 0x4b, 0x50, 0x4e, 0x4b, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x49, 0x46, 0x4a, 0x45, 0x4f, 0x4b, 0x4c, 0x4b, 0x50, 0x4e, 0x4b, 0x12, 0x14,
