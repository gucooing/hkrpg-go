...
type RogueVirtualItemInfo struct {
	...
	KNMMOAHLIIH uint32 `protobuf:"varint,6,opt,name=KNMMOAHLIIH,proto3" json:"KNMMOAHLIIH,omitempty"`
	MMDFFCLLDEC uint32 `protobuf:"varint,1,opt,name=MMDFFCLLDEC,proto3" json:"MMDFFCLLDEC,omitempty"`
	OBGJKGGPGJM uint32 `protobuf:"varint,8,opt,name=OBGJKGGPGJM,proto3" json:"OBGJKGGPGJM,omitempty"`
	HHACJFFEHMK uint32 `protobuf:"varint,5,opt,name=HHACJFFEHMK,proto3" json:"HHACJFFEHMK,omitempty"`
}
...
func (x *RogueVirtualItemInfo) GetKNMMOAHLIIH() uint32 {
	if x != nil {
		return x.KNMMOAHLIIH
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetMMDFFCLLDEC() uint32 {
	if x != nil {
		return x.MMDFFCLLDEC
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetOBGJKGGPGJM() uint32 {
	if x != nil {
		return x.OBGJKGGPGJM
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetHHACJFFEHMK() uint32 {
	if x != nil {
		return x.HHACJFFEHMK
	}
	return 0
}
...
var file_RogueVirtualItemInfo_proto_rawDesc = []byte{
	...
	,
