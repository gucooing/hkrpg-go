...
type RogueVirtualItemInfo struct {
	...
	NOLNLHIPHKO uint32 `protobuf:"varint,8,opt,name=NOLNLHIPHKO,proto3" json:"NOLNLHIPHKO,omitempty"`
	CLPHHMPMHMP uint32 `protobuf:"varint,11,opt,name=CLPHHMPMHMP,proto3" json:"CLPHHMPMHMP,omitempty"`
	BIGMODPHFDB uint32 `protobuf:"varint,3,opt,name=BIGMODPHFDB,proto3" json:"BIGMODPHFDB,omitempty"`
	PNONKBMMHPJ uint32 `protobuf:"varint,15,opt,name=PNONKBMMHPJ,proto3" json:"PNONKBMMHPJ,omitempty"`
}
...
func (x *RogueVirtualItemInfo) GetNOLNLHIPHKO() uint32 {
	if x != nil {
		return x.NOLNLHIPHKO
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetCLPHHMPMHMP() uint32 {
	if x != nil {
		return x.CLPHHMPMHMP
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetBIGMODPHFDB() uint32 {
	if x != nil {
		return x.BIGMODPHFDB
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetPNONKBMMHPJ() uint32 {
	if x != nil {
		return x.PNONKBMMHPJ
	}
	return 0
}
...
var file_RogueVirtualItemInfo_proto_rawDesc = []byte{
	...
	,
