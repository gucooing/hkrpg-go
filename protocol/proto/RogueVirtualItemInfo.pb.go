...
type RogueVirtualItemInfo struct {
	...
	LLBICIFCPPM uint32 `protobuf:"varint,13,opt,name=LLBICIFCPPM,proto3" json:"LLBICIFCPPM,omitempty"`
	CBBNGFNOIAP uint32 `protobuf:"varint,10,opt,name=CBBNGFNOIAP,proto3" json:"CBBNGFNOIAP,omitempty"`
	NKPCHPKFELD uint32 `protobuf:"varint,14,opt,name=NKPCHPKFELD,proto3" json:"NKPCHPKFELD,omitempty"`
	FDHPGGFOCBM uint32 `protobuf:"varint,15,opt,name=FDHPGGFOCBM,proto3" json:"FDHPGGFOCBM,omitempty"`
}
...
func (x *RogueVirtualItemInfo) GetLLBICIFCPPM() uint32 {
	if x != nil {
...
func (x *RogueVirtualItemInfo) GetCBBNGFNOIAP() uint32 {
	if x != nil {
		return x.CBBNGFNOIAP
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetNKPCHPKFELD() uint32 {
	if x != nil {
		return x.NKPCHPKFELD
	}
	return 0
}

func (x *RogueVirtualItemInfo) GetFDHPGGFOCBM() uint32 {
	if x != nil {
		return x.FDHPGGFOCBM
	}
	return 0
}
...
var file_RogueVirtualItemInfo_proto_rawDesc = []byte{
	...
	,
