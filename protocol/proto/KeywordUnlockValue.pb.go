...
type KeywordUnlockValue struct {
	...
	KeywordUnlockMap map[uint32]bool `protobuf:"bytes,12,rep,name=keyword_unlock_map,json=keywordUnlockMap,proto3" json:"keyword_unlock_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_KeywordUnlockValue_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x6b, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e,
