...
type AlleyShipUsedCountScNotify struct {
	...
	PCFBNFBDLAH map[uint32]uint32 `protobuf:"bytes,11,rep,name=PCFBNFBDLAH,proto3" json:"PCFBNFBDLAH,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *AlleyShipUsedCountScNotify) GetPCFBNFBDLAH() map[uint32]uint32 {
	if x != nil {
...
var file_AlleyShipUsedCountScNotify_proto_rawDesc = []byte{
	...
	0x79, 0x12, 0x4e, 0x0a, 0x0b, 0x50, 0x43, 0x46, 0x42, 0x4e, 0x46, 0x42, 0x44, 0x4c, 0x41, 0x48,
	...
	0x69, 0x66, 0x79, 0x2e, 0x50, 0x43, 0x46, 0x42, 0x4e, 0x46, 0x42, 0x44, 0x4c, 0x41, 0x48, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x50, 0x43, 0x46, 0x42, 0x4e, 0x46, 0x42, 0x44, 0x4c, 0x41,
	0x48, 0x1a, 0x3e, 0x0a, 0x10, 0x50, 0x43, 0x46, 0x42, 0x4e, 0x46, 0x42, 0x44, 0x4c, 0x41, 0x48,
...
var file_AlleyShipUsedCountScNotify_proto_goTypes = []interface{}{
	...
	nil,                                // 1: AlleyShipUsedCountScNotify.PCFBNFBDLAHEntry
}
var file_AlleyShipUsedCountScNotify_proto_depIdxs = []int32{
	1, // 0: AlleyShipUsedCountScNotify.PCFBNFBDLAH:type_name -> AlleyShipUsedCountScNotify.PCFBNFBDLAHEntry
