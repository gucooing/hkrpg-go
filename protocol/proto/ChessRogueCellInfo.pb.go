...
type ChessRogueCellInfo struct {
	...
	Query       []*ChessRogueCell `protobuf:"bytes,1,rep,name=query,proto3" json:"query,omitempty"`
	BIEJGDGAOBL uint32            `protobuf:"varint,8,opt,name=BIEJGDGAOBL,proto3" json:"BIEJGDGAOBL,omitempty"` // 61
}
...
func (x *ChessRogueCellInfo) GetQuery() []*ChessRogueCell {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *ChessRogueCellInfo) GetBIEJGDGAOBL() uint32 {
	if x != nil {
		return x.BIEJGDGAOBL
	}
	return 0
}
...
var file_ChessRogueCellInfo_proto_rawDesc = []byte{
	...
	0x22, 0x5d, 0x0a, 0x12, 0x43, 0x68, 0x65, 0x73, 0x73, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x43, 0x65,
	0x6c, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x25, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x43, 0x68, 0x65, 0x73, 0x73, 0x52, 0x6f, 0x67,
	0x75, 0x65, 0x43, 0x65, 0x6c, 0x6c, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x20, 0x0a,
	0x0b, 0x42, 0x49, 0x45, 0x4a, 0x47, 0x44, 0x47, 0x41, 0x4f, 0x42, 0x4c, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x42, 0x49, 0x45, 0x4a, 0x47, 0x44, 0x47, 0x41, 0x4f, 0x42, 0x4c, 0x42,
...
var file_ChessRogueCellInfo_proto_depIdxs = []int32{
	1, // 0: ChessRogueCellInfo.query:type_name -> ChessRogueCell
