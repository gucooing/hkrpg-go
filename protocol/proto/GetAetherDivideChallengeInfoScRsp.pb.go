...
type GetAetherDivideChallengeInfoScRsp struct {
	...
	IKDILKHCGEI []uint32 `protobuf:"varint,13,rep,packed,name=IKDILKHCGEI,proto3" json:"IKDILKHCGEI,omitempty"`
	POHFLBMFEFE []uint32 `protobuf:"varint,2,rep,packed,name=POHFLBMFEFE,proto3" json:"POHFLBMFEFE,omitempty"`
	ENPOCAKPLHN uint32   `protobuf:"varint,15,opt,name=ENPOCAKPLHN,proto3" json:"ENPOCAKPLHN,omitempty"`
...
func (x *GetAetherDivideChallengeInfoScRsp) GetIKDILKHCGEI() []uint32 {
	if x != nil {
		return x.IKDILKHCGEI
	}
	return nil
}

func (x *GetAetherDivideChallengeInfoScRsp) GetPOHFLBMFEFE() []uint32 {
	if x != nil {
		return x.POHFLBMFEFE
	}
	return nil
}

func (x *GetAetherDivideChallengeInfoScRsp) GetENPOCAKPLHN() uint32 {
	if x != nil {
		return x.ENPOCAKPLHN
	}
	return 0
}
...
var file_GetAetherDivideChallengeInfoScRsp_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x0b, 0x49, 0x4b, 0x44, 0x49, 0x4c, 0x4b, 0x48, 0x43, 0x47, 0x45, 0x49, 0x18, 0x0d,
	0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x49, 0x4b, 0x44, 0x49, 0x4c, 0x4b, 0x48, 0x43, 0x47, 0x45,
	0x49, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x4f, 0x48, 0x46, 0x4c, 0x42, 0x4d, 0x46, 0x45, 0x46, 0x45,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x4f, 0x48, 0x46, 0x4c, 0x42, 0x4d, 0x46,
	0x45, 0x46, 0x45, 0x12, 0x20, 0x0a, 0x0b, 0x45, 0x4e, 0x50, 0x4f, 0x43, 0x41, 0x4b, 0x50, 0x4c,
	0x48, 0x4e, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x45, 0x4e, 0x50, 0x4f, 0x43, 0x41,
	0x4b, 0x50, 0x4c, 0x48, 0x4e, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65,
