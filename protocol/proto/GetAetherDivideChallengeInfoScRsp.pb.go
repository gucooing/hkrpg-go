...
type GetAetherDivideChallengeInfoScRsp struct {
	...
	ANLOIAIEKHB []uint32 `protobuf:"varint,6,rep,packed,name=ANLOIAIEKHB,proto3" json:"ANLOIAIEKHB,omitempty"`
	ECDFJJCPFJA uint32   `protobuf:"varint,14,opt,name=ECDFJJCPFJA,proto3" json:"ECDFJJCPFJA,omitempty"`
	DEOOAOCGIIF []uint32 `protobuf:"varint,13,rep,packed,name=DEOOAOCGIIF,proto3" json:"DEOOAOCGIIF,omitempty"`
...
func (x *GetAetherDivideChallengeInfoScRsp) GetANLOIAIEKHB() []uint32 {
	if x != nil {
		return x.ANLOIAIEKHB
	}
	return nil
}

func (x *GetAetherDivideChallengeInfoScRsp) GetECDFJJCPFJA() uint32 {
	if x != nil {
		return x.ECDFJJCPFJA
	}
	return 0
}

func (x *GetAetherDivideChallengeInfoScRsp) GetDEOOAOCGIIF() []uint32 {
	if x != nil {
		return x.DEOOAOCGIIF
	}
	return nil
}
...
var file_GetAetherDivideChallengeInfoScRsp_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x0b, 0x41, 0x4e, 0x4c, 0x4f, 0x49, 0x41, 0x49, 0x45, 0x4b, 0x48, 0x42, 0x18, 0x06,
	0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x41, 0x4e, 0x4c, 0x4f, 0x49, 0x41, 0x49, 0x45, 0x4b, 0x48,
	0x42, 0x12, 0x20, 0x0a, 0x0b, 0x45, 0x43, 0x44, 0x46, 0x4a, 0x4a, 0x43, 0x50, 0x46, 0x4a, 0x41,
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x45, 0x43, 0x44, 0x46, 0x4a, 0x4a, 0x43, 0x50,
	0x46, 0x4a, 0x41, 0x12, 0x20, 0x0a, 0x0b, 0x44, 0x45, 0x4f, 0x4f, 0x41, 0x4f, 0x43, 0x47, 0x49,
	0x49, 0x46, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x44, 0x45, 0x4f, 0x4f, 0x41, 0x4f,
	0x43, 0x47, 0x49, 0x49, 0x46, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65,
