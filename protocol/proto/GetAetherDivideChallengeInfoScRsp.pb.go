...
type GetAetherDivideChallengeInfoScRsp struct {
	...
	MEFNJKOFLND []uint32 `protobuf:"varint,5,rep,packed,name=MEFNJKOFLND,proto3" json:"MEFNJKOFLND,omitempty"`
	Retcode     uint32   `protobuf:"varint,10,opt,name=retcode,proto3" json:"retcode,omitempty"`
	KDIAFEMLEOE uint32   `protobuf:"varint,7,opt,name=KDIAFEMLEOE,proto3" json:"KDIAFEMLEOE,omitempty"`
	AGCBCOBPGMF []uint32 `protobuf:"varint,14,rep,packed,name=AGCBCOBPGMF,proto3" json:"AGCBCOBPGMF,omitempty"`
}
...
func (x *GetAetherDivideChallengeInfoScRsp) GetMEFNJKOFLND() []uint32 {
	if x != nil {
		return x.MEFNJKOFLND
	}
	return nil
}
...
func (x *GetAetherDivideChallengeInfoScRsp) GetKDIAFEMLEOE() uint32 {
	if x != nil {
		return x.KDIAFEMLEOE
	}
	return 0
}

func (x *GetAetherDivideChallengeInfoScRsp) GetAGCBCOBPGMF() []uint32 {
	if x != nil {
		return x.AGCBCOBPGMF
	}
	return nil
}
...
var file_GetAetherDivideChallengeInfoScRsp_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x0b, 0x4d, 0x45, 0x46, 0x4e, 0x4a, 0x4b, 0x4f, 0x46, 0x4c, 0x4e, 0x44, 0x18, 0x05,
	0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4d, 0x45, 0x46, 0x4e, 0x4a, 0x4b, 0x4f, 0x46, 0x4c, 0x4e,
	...
	0x44, 0x49, 0x41, 0x46, 0x45, 0x4d, 0x4c, 0x45, 0x4f, 0x45, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0b, 0x4b, 0x44, 0x49, 0x41, 0x46, 0x45, 0x4d, 0x4c, 0x45, 0x4f, 0x45, 0x12, 0x20, 0x0a,
	0x0b, 0x41, 0x47, 0x43, 0x42, 0x43, 0x4f, 0x42, 0x50, 0x47, 0x4d, 0x46, 0x18, 0x0e, 0x20, 0x03,
	0x28, 0x0d, 0x52, 0x0b, 0x41, 0x47, 0x43, 0x42, 0x43, 0x4f, 0x42, 0x50, 0x47, 0x4d, 0x46, 0x42,
