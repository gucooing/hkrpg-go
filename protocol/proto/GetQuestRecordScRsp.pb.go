...
type GetQuestRecordScRsp struct {
	...
	HNHLHFFBHAG []*QuestRecord `protobuf:"bytes,6,rep,name=HNHLHFFBHAG,proto3" json:"HNHLHFFBHAG,omitempty"`
...
func (x *GetQuestRecordScRsp) GetHNHLHFFBHAG() []*QuestRecord {
	if x != nil {
		return x.HNHLHFFBHAG
	}
	return nil
}
...
var file_GetQuestRecordScRsp_proto_rawDesc = []byte{
	...
	0x53, 0x63, 0x52, 0x73, 0x70, 0x12, 0x2e, 0x0a, 0x0b, 0x48, 0x4e, 0x48, 0x4c, 0x48, 0x46, 0x46,
	0x42, 0x48, 0x41, 0x47, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x51, 0x75, 0x65,
	0x73, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x0b, 0x48, 0x4e, 0x48, 0x4c, 0x48, 0x46,
	0x46, 0x42, 0x48, 0x41, 0x47, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65,
...
var file_GetQuestRecordScRsp_proto_depIdxs = []int32{
	1, // 0: GetQuestRecordScRsp.HNHLHFFBHAG:type_name -> QuestRecord
