...
type GetQuestRecordScRsp struct {
	...
	DCLIHBHPJKK []*QuestRecord `protobuf:"bytes,9,rep,name=DCLIHBHPJKK,proto3" json:"DCLIHBHPJKK,omitempty"`
}
...
func (x *GetQuestRecordScRsp) GetDCLIHBHPJKK() []*QuestRecord {
	if x != nil {
		return x.DCLIHBHPJKK
	}
	return nil
}
...
var file_GetQuestRecordScRsp_proto_rawDesc = []byte{
	...
	0x2e, 0x0a, 0x0b, 0x44, 0x43, 0x4c, 0x49, 0x48, 0x42, 0x48, 0x50, 0x4a, 0x4b, 0x4b, 0x18, 0x09,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x51, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x52, 0x0b, 0x44, 0x43, 0x4c, 0x49, 0x48, 0x42, 0x48, 0x50, 0x4a, 0x4b, 0x4b, 0x42,
...
var file_GetQuestRecordScRsp_proto_depIdxs = []int32{
	1, // 0: GetQuestRecordScRsp.DCLIHBHPJKK:type_name -> QuestRecord
