...
type Material struct {
	...
	ExpireTime uint64 `protobuf:"varint,15,opt,name=expire_time,json=expireTime,proto3" json:"expire_time,omitempty"`
...
func (x *Material) GetExpireTime() uint64 {
	if x != nil {
		return x.ExpireTime
	}
	return 0
...
var file_Material_proto_rawDesc = []byte{
	...
	0x22, 0x4f, 0x0a, 0x08, 0x4d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x12, 0x10, 0x0a, 0x03,
	0x74, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x69, 0x64, 0x12, 0x1f,
	...
	0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x6e, 0x75,
