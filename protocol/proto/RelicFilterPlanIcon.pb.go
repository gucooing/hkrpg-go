...
type RelicFilterPlanIcon struct {
	...
	IsAvatarIcon bool   `protobuf:"varint,7,opt,name=is_avatar_icon,json=isAvatarIcon,proto3" json:"is_avatar_icon,omitempty"`
	IconId       uint32 `protobuf:"varint,3,opt,name=icon_id,json=iconId,proto3" json:"icon_id,omitempty"`
}
...
func (x *RelicFilterPlanIcon) GetIsAvatarIcon() bool {
	if x != nil {
		return x.IsAvatarIcon
	}
	return false
}

func (x *RelicFilterPlanIcon) GetIconId() uint32 {
	if x != nil {
		return x.IconId
	}
	return 0
...
var file_RelicFilterPlanIcon_proto_rawDesc = []byte{
	...
	0x6e, 0x49, 0x63, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x54, 0x0a, 0x13, 0x52,
	0x65, 0x6c, 0x69, 0x63, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x50, 0x6c, 0x61, 0x6e, 0x49, 0x63,
	0x6f, 0x6e, 0x12, 0x24, 0x0a, 0x0e, 0x69, 0x73, 0x5f, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f,
	0x69, 0x63, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x69, 0x73, 0x41, 0x76,
	0x61, 0x74, 0x61, 0x72, 0x49, 0x63, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x63, 0x6f, 0x6e,
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x69, 0x63, 0x6f, 0x6e, 0x49,
