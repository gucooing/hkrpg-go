...
type ShareScRsp struct {
	...
	MBEKCOCEGFL *ShareData `protobuf:"bytes,12,opt,name=MBEKCOCEGFL,proto3" json:"MBEKCOCEGFL,omitempty"`
...
func (x *ShareScRsp) GetMBEKCOCEGFL() *ShareData {
	if x != nil {
		return x.MBEKCOCEGFL
	}
	return nil
}
...
var file_ShareScRsp_proto_rawDesc = []byte{
	...
	0x70, 0x12, 0x2c, 0x0a, 0x0b, 0x4d, 0x42, 0x45, 0x4b, 0x43, 0x4f, 0x43, 0x45, 0x47, 0x46, 0x4c,
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x53, 0x68, 0x61, 0x72, 0x65, 0x44, 0x61,
	0x74, 0x61, 0x52, 0x0b, 0x4d, 0x42, 0x45, 0x4b, 0x43, 0x4f, 0x43, 0x45, 0x47, 0x46, 0x4c, 0x12,
...
var file_ShareScRsp_proto_depIdxs = []int32{
	1, // 0: ShareScRsp.MBEKCOCEGFL:type_name -> ShareData
	2, // 1: ShareScRsp.reward:type_name -> ItemList
