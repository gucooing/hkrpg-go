...
type SetClientRaidTargetCountScRsp struct {
	...
	KMGMHPKGEDA uint32 `protobuf:"varint,3,opt,name=KMGMHPKGEDA,proto3" json:"KMGMHPKGEDA,omitempty"`
}
...
func (x *SetClientRaidTargetCountScRsp) GetKMGMHPKGEDA() uint32 {
	if x != nil {
...
var file_SetClientRaidTargetCountScRsp_proto_rawDesc = []byte{
	...
	0x4b, 0x4d, 0x47, 0x4d, 0x48, 0x50, 0x4b, 0x47, 0x45, 0x44, 0x41, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x4b, 0x4d, 0x47, 0x4d, 0x48, 0x50, 0x4b, 0x47, 0x45, 0x44, 0x41, 0x42, 0x2e,
