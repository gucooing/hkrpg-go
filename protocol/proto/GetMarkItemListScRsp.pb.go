...
type GetMarkItemListScRsp struct {
	...
	CPJJPOEPHIN []uint32 `protobuf:"varint,8,rep,packed,name=CPJJPOEPHIN,proto3" json:"CPJJPOEPHIN,omitempty"`
...
func (x *GetMarkItemListScRsp) GetCPJJPOEPHIN() []uint32 {
	if x != nil {
		return x.CPJJPOEPHIN
	}
	return nil
}
...
var file_GetMarkItemListScRsp_proto_rawDesc = []byte{
	...
	0x63, 0x52, 0x73, 0x70, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x50, 0x4a, 0x4a, 0x50, 0x4f, 0x45, 0x50,
	0x48, 0x49, 0x4e, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x43, 0x50, 0x4a, 0x4a, 0x50,
	0x4f, 0x45, 0x50, 0x48, 0x49, 0x4e, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64,
