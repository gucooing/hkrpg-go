...
type GetMarkItemListScRsp struct {
	...
	BDGECCMOCJA []uint32 `protobuf:"varint,11,rep,packed,name=BDGECCMOCJA,proto3" json:"BDGECCMOCJA,omitempty"`
}
...
func (x *GetMarkItemListScRsp) GetBDGECCMOCJA() []uint32 {
	if x != nil {
		return x.BDGECCMOCJA
	}
	return nil
}
...
var file_GetMarkItemListScRsp_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x42, 0x44, 0x47, 0x45, 0x43, 0x43, 0x4d, 0x4f, 0x43, 0x4a, 0x41, 0x18, 0x0b, 0x20,
	0x03, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x44, 0x47, 0x45, 0x43, 0x43, 0x4d, 0x4f, 0x43, 0x4a, 0x41,
