...
type GetMarkItemListScRsp struct {
	...
	FIOELBEMJAB []uint32 `protobuf:"varint,13,rep,packed,name=FIOELBEMJAB,proto3" json:"FIOELBEMJAB,omitempty"`
...
func (x *GetMarkItemListScRsp) GetFIOELBEMJAB() []uint32 {
	if x != nil {
		return x.FIOELBEMJAB
	}
	return nil
}
...
var file_GetMarkItemListScRsp_proto_rawDesc = []byte{
	...
	0x63, 0x52, 0x73, 0x70, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x49, 0x4f, 0x45, 0x4c, 0x42, 0x45, 0x4d,
	0x4a, 0x41, 0x42, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x46, 0x49, 0x4f, 0x45, 0x4c,
	0x42, 0x45, 0x4d, 0x4a, 0x41, 0x42, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64,
