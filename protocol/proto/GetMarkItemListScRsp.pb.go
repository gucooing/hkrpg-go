...
type GetMarkItemListScRsp struct {
	...
	AMGCMGFMPOH []uint32 `protobuf:"varint,5,rep,packed,name=AMGCMGFMPOH,proto3" json:"AMGCMGFMPOH,omitempty"`
}
...
func (x *GetMarkItemListScRsp) GetAMGCMGFMPOH() []uint32 {
	if x != nil {
		return x.AMGCMGFMPOH
	}
	return nil
}
...
var file_GetMarkItemListScRsp_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x41, 0x4d, 0x47, 0x43, 0x4d, 0x47, 0x46, 0x4d, 0x50, 0x4f, 0x48, 0x18, 0x05, 0x20,
	0x03, 0x28, 0x0d, 0x52, 0x0b, 0x41, 0x4d, 0x47, 0x43, 0x4d, 0x47, 0x46, 0x4d, 0x50, 0x4f, 0x48,
