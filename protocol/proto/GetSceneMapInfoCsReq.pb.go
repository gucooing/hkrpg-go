...
type GetSceneMapInfoCsReq struct {
	...
	EntryIdList []uint32 `protobuf:"varint,9,rep,packed,name=entry_id_list,json=entryIdList,proto3" json:"entry_id_list,omitempty"`
}
...
var file_GetSceneMapInfoCsReq_proto_rawDesc = []byte{
	...
	0x18, 0x09, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x49, 0x64, 0x4c,
