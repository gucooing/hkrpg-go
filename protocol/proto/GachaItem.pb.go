...
type GachaItem struct {
	...
	TokenItem        *ItemList `protobuf:"bytes,8,opt,name=token_item,json=tokenItem,proto3" json:"token_item,omitempty"`
	IsNew            bool      `protobuf:"varint,10,opt,name=is_new,json=isNew,proto3" json:"is_new,omitempty"`
	TransferItemList *ItemList `protobuf:"bytes,15,opt,name=transfer_item_list,json=transferItemList,proto3" json:"transfer_item_list,omitempty"`
}
...
var file_GachaItem_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x68, 0x61, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x52, 0x09, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x15, 0x0a, 0x06, 0x69,
