...
type RogueCommonDialogueInfo struct {
	...
	DialogueBasicInfo *RogueCommonDialogueBasicInfo `protobuf:"bytes,4,opt,name=dialogue_basic_info,json=dialogueBasicInfo,proto3" json:"dialogue_basic_info,omitempty"`
	LLNEBAMBHDE       *JHFNBCAKNAP                  `protobuf:"bytes,5,opt,name=LLNEBAMBHDE,proto3" json:"LLNEBAMBHDE,omitempty"`
	FALDMNMCOMC       *AGICBCNPMBF                  `protobuf:"bytes,12,opt,name=FALDMNMCOMC,proto3" json:"FALDMNMCOMC,omitempty"`
	PBPGFIIHHAF       *LMFCCGILDOH                  `protobuf:"bytes,15,opt,name=PBPGFIIHHAF,proto3" json:"PBPGFIIHHAF,omitempty"`
}
...
func (x *RogueCommonDialogueInfo) GetLLNEBAMBHDE() *JHFNBCAKNAP {
	if x != nil {
		return x.LLNEBAMBHDE
	}
	return nil
}

func (x *RogueCommonDialogueInfo) GetFALDMNMCOMC() *AGICBCNPMBF {
	if x != nil {
		return x.FALDMNMCOMC
	}
	return nil
}

func (x *RogueCommonDialogueInfo) GetPBPGFIIHHAF() *LMFCCGILDOH {
	if x != nil {
		return x.PBPGFIIHHAF
	}
	return nil
}
...
var file_RogueCommonDialogueInfo_proto_rawDesc = []byte{
	...
	0x11, 0x4a, 0x48, 0x46, 0x4e, 0x42, 0x43, 0x41, 0x4b, 0x4e, 0x41, 0x50, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x11, 0x41, 0x47, 0x49, 0x43, 0x42, 0x43, 0x4e, 0x50, 0x4d, 0x42, 0x46, 0x2e,
	...
	0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x4c, 0x4d, 0x46, 0x43, 0x43,
	0x47, 0x49, 0x4c, 0x44, 0x4f, 0x48, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x01, 0x0a,
	...
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x43, 0x6f, 0x6d,
	...
	,
...
var file_RogueCommonDialogueInfo_proto_goTypes = []interface{}{
	...
	(*JHFNBCAKNAP)(nil),                  // 2: JHFNBCAKNAP
	(*AGICBCNPMBF)(nil),                  // 3: AGICBCNPMBF
	(*LMFCCGILDOH)(nil),                  // 4: LMFCCGILDOH
}
var file_RogueCommonDialogueInfo_proto_depIdxs = []int32{
	...
	2, // 1: RogueCommonDialogueInfo.LLNEBAMBHDE:type_name -> JHFNBCAKNAP
	3, // 2: RogueCommonDialogueInfo.FALDMNMCOMC:type_name -> AGICBCNPMBF
	4, // 3: RogueCommonDialogueInfo.PBPGFIIHHAF:type_name -> LMFCCGILDOH
...
func file_RogueCommonDialogueInfo_proto_init() {
	...
	file_JHFNBCAKNAP_proto_init()
	file_AGICBCNPMBF_proto_init()
	file_RogueCommonDialogueBasicInfo_proto_init()
	file_LMFCCGILDOH_proto_init()
	if !protoimpl.UnsafeEnabled {
