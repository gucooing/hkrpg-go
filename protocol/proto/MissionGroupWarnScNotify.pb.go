...
type MissionGroupWarnScNotify struct {
	...
	GroupIdList []uint32 `protobuf:"varint,8,rep,packed,name=group_id_list,json=groupIdList,proto3" json:"group_id_list,omitempty"`
}
...
var file_MissionGroupWarnScNotify_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x08, 0x20,
