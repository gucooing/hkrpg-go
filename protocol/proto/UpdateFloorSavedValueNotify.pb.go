...
type UpdateFloorSavedValueNotify struct {
	...
	SavedValue  map[string]int32 `protobuf:"bytes,5,rep,name=saved_value,json=savedValue,proto3" json:"saved_value,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	FloorId     uint32           `protobuf:"varint,3,opt,name=floor_id,json=floorId,proto3" json:"floor_id,omitempty"`
	DimensionId uint32           `protobuf:"varint,14,opt,name=dimension_id,json=dimensionId,proto3" json:"dimension_id,omitempty"`
...
var file_UpdateFloorSavedValueNotify_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x75, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x66, 0x6c, 0x6f, 0x6f, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x66, 0x6c, 0x6f, 0x6f, 0x72, 0x49, 0x64, 0x12, 0x21, 0x0a,
	0x0c, 0x64, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20,
	...
	0x28, 0x0d, 0x52, 0x07, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x49, 0x64, 0x1a, 0x3d, 0x0a, 0x0f, 0x53,
