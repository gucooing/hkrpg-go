...
type SetLanguageCsReq struct {
	...
	FJCCIGGAIPJ LanguageType `protobuf:"varint,13,opt,name=FJCCIGGAIPJ,proto3,enum=LanguageType" json:"FJCCIGGAIPJ,omitempty"`
}
...
func (x *SetLanguageCsReq) GetFJCCIGGAIPJ() LanguageType {
	if x != nil {
...
var file_SetLanguageCsReq_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
...
var file_SetLanguageCsReq_proto_depIdxs = []int32{
	1, // 0: SetLanguageCsReq.FJCCIGGAIPJ:type_name -> LanguageType
