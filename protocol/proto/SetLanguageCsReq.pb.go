...
type SetLanguageCsReq struct {
	...
	LanguageType LanguageType `protobuf:"varint,4,opt,name=language_type,json=languageType,proto3,enum=LanguageType" json:"language_type,omitempty"`
}
...
func (x *SetLanguageCsReq) GetLanguageType() LanguageType {
	if x != nil {
...
var file_SetLanguageCsReq_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x46, 0x0a, 0x10,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61,
...
var file_SetLanguageCsReq_proto_depIdxs = []int32{
	1, // 0: SetLanguageCsReq.language_type:type_name -> LanguageType
