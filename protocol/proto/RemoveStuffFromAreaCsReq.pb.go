...
type RemoveStuffFromAreaCsReq struct {
	...
	EEINDHJBFPF uint32 `protobuf:"varint,4,opt,name=EEINDHJBFPF,proto3" json:"EEINDHJBFPF,omitempty"`
}
...
func (x *RemoveStuffFromAreaCsReq) GetEEINDHJBFPF() uint32 {
	if x != nil {
...
var file_RemoveStuffFromAreaCsReq_proto_rawDesc = []byte{
	...
	0x45, 0x45, 0x49, 0x4e, 0x44, 0x48, 0x4a, 0x42, 0x46, 0x50, 0x46, 0x18, 0x04, 0x20, 0x01, 0x28,
