...
type RemoveStuffFromAreaCsReq struct {
	...
	CAPKIANAJIM uint32 `protobuf:"varint,15,opt,name=CAPKIANAJIM,proto3" json:"CAPKIANAJIM,omitempty"`
}
...
func (x *RemoveStuffFromAreaCsReq) GetCAPKIANAJIM() uint32 {
	if x != nil {
...
var file_RemoveStuffFromAreaCsReq_proto_rawDesc = []byte{
	...
	0x43, 0x41, 0x50, 0x4b, 0x49, 0x41, 0x4e, 0x41, 0x4a, 0x49, 0x4d, 0x18, 0x0f, 0x20, 0x01, 0x28,
