...
type RemoveStuffFromAreaCsReq struct {
	...
	POEDFMELAKE uint32 `protobuf:"varint,14,opt,name=POEDFMELAKE,proto3" json:"POEDFMELAKE,omitempty"`
}
...
func (x *RemoveStuffFromAreaCsReq) GetPOEDFMELAKE() uint32 {
	if x != nil {
...
var file_RemoveStuffFromAreaCsReq_proto_rawDesc = []byte{
	...
	0x50, 0x4f, 0x45, 0x44, 0x46, 0x4d, 0x45, 0x4c, 0x41, 0x4b, 0x45, 0x18, 0x0e, 0x20, 0x01, 0x28,
