...
type RemoveStuffFromAreaCsReq struct {
	...
	DIADHPAHLGC uint32 `protobuf:"varint,12,opt,name=DIADHPAHLGC,proto3" json:"DIADHPAHLGC,omitempty"`
}
...
func (x *RemoveStuffFromAreaCsReq) GetDIADHPAHLGC() uint32 {
	if x != nil {
...
var file_RemoveStuffFromAreaCsReq_proto_rawDesc = []byte{
	...
	0x44, 0x49, 0x41, 0x44, 0x48, 0x50, 0x41, 0x48, 0x4c, 0x47, 0x43, 0x18, 0x0c, 0x20, 0x01, 0x28,
