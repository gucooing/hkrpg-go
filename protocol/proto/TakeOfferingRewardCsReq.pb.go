...
type TakeOfferingRewardCsReq struct {
	...
	OEDHEKABIPP []uint32 `protobuf:"varint,6,rep,packed,name=OEDHEKABIPP,proto3" json:"OEDHEKABIPP,omitempty"`
	MonsterId   uint32   `protobuf:"varint,3,opt,name=monster_id,json=monsterId,proto3" json:"monster_id,omitempty"`
	ICAEMFCMPMA uint32   `protobuf:"varint,2,opt,name=ICAEMFCMPMA,proto3" json:"ICAEMFCMPMA,omitempty"`
}
...
func (x *TakeOfferingRewardCsReq) GetOEDHEKABIPP() []uint32 {
	if x != nil {
...
func (x *TakeOfferingRewardCsReq) GetICAEMFCMPMA() uint32 {
	if x != nil {
...
var file_TakeOfferingRewardCsReq_proto_rawDesc = []byte{
	...
	0x65, 0x77, 0x61, 0x72, 0x64, 0x43, 0x73, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x4f, 0x45,
	0x44, 0x48, 0x45, 0x4b, 0x41, 0x42, 0x49, 0x50, 0x50, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0d, 0x52,
	0x0b, 0x4f, 0x45, 0x44, 0x48, 0x45, 0x4b, 0x41, 0x42, 0x49, 0x50, 0x50, 0x12, 0x1d, 0x0a, 0x0a,
	0x6d, 0x6f, 0x6e, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x09, 0x6d, 0x6f, 0x6e, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x49,
	0x43, 0x41, 0x45, 0x4d, 0x46, 0x43, 0x4d, 0x50, 0x4d, 0x41, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0b, 0x49, 0x43, 0x41, 0x45, 0x4d, 0x46, 0x43, 0x4d, 0x50, 0x4d, 0x41, 0x42, 0x2e, 0x5a,
