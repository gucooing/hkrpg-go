...
type RogueWorkbenchGetInfoScRsp struct {
	...
	FuncInfoMap map[uint32]*WorkbenchFuncInfo `protobuf:"bytes,7,rep,name=func_info_map,json=funcInfoMap,proto3" json:"func_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
var file_RogueWorkbenchGetInfoScRsp_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x07, 0x20, 0x03, 0x28,
