...
type TakeMailAttachmentScRsp struct {
	...
	FailMailList   []*ClientMailAttachmentItem `protobuf:"bytes,13,rep,name=fail_mail_list,json=failMailList,proto3" json:"fail_mail_list,omitempty"`
	SuccMailIdList []uint32                    `protobuf:"varint,10,rep,packed,name=succ_mail_id_list,json=succMailIdList,proto3" json:"succ_mail_id_list,omitempty"`
...
var file_TakeMailAttachmentScRsp_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6c, 0x5f, 0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0d, 0x20,
	...
	0x74, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0e, 0x73, 0x75, 0x63, 0x63, 0x4d, 0x61, 0x69,
