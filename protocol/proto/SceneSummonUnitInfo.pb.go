...
type SceneSummonUnitInfo struct {
	...
	LifeTimeMs      int32    `protobuf:"varint,15,opt,name=life_time_ms,json=lifeTimeMs,proto3" json:"life_time_ms,omitempty"`
	CasterEntityId  uint32   `protobuf:"varint,4,opt,name=caster_entity_id,json=casterEntityId,proto3" json:"caster_entity_id,omitempty"`  // 10 14
	SummonUnitId    uint32   `protobuf:"varint,10,opt,name=summon_unit_id,json=summonUnitId,proto3" json:"summon_unit_id,omitempty"`       // 4 14
	AttachEntityId  uint32   `protobuf:"varint,14,opt,name=attach_entity_id,json=attachEntityId,proto3" json:"attach_entity_id,omitempty"` // 4 10
...
var file_SceneSummonUnitInfo_proto_rawDesc = []byte{
	...
	0x0f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x6c, 0x69, 0x66, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x4d,
	0x73, 0x12, 0x28, 0x0a, 0x10, 0x63, 0x61, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x63, 0x61, 0x73,
	0x74, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0e, 0x73,
	0x75, 0x6d, 0x6d, 0x6f, 0x6e, 0x5f, 0x75, 0x6e, 0x69, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20,
	...
	0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x61, 0x74, 0x74,
