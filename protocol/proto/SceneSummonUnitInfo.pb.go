...
type SceneSummonUnitInfo struct {
	...
	IDIHABIGADA     uint32   `protobuf:"varint,6,opt,name=IDIHABIGADA,proto3" json:"IDIHABIGADA,omitempty"`
	DPAIENFBFKD     uint32   `protobuf:"varint,13,opt,name=DPAIENFBFKD,proto3" json:"DPAIENFBFKD,omitempty"`
	GCHKBHGAFPM     uint32   `protobuf:"varint,5,opt,name=GCHKBHGAFPM,proto3" json:"GCHKBHGAFPM,omitempty"`
	LifeTimeMs      int32    `protobuf:"varint,3,opt,name=life_time_ms,json=lifeTimeMs,proto3" json:"life_time_ms,omitempty"`
...
func (x *SceneSummonUnitInfo) GetIDIHABIGADA() uint32 {
	if x != nil {
		return x.IDIHABIGADA
	}
	return 0
}

func (x *SceneSummonUnitInfo) GetDPAIENFBFKD() uint32 {
	if x != nil {
		return x.DPAIENFBFKD
	}
	return 0
}

func (x *SceneSummonUnitInfo) GetGCHKBHGAFPM() uint32 {
	if x != nil {
		return x.GCHKBHGAFPM
	}
	return 0
}
...
var file_SceneSummonUnitInfo_proto_rawDesc = []byte{
	...
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x01, 0x0a, 0x13,
	...
	,
