...
type UpdateTrackMainMissionIdScRsp struct {
	...
	TrackMissionId     uint32 `protobuf:"varint,4,opt,name=track_mission_id,json=trackMissionId,proto3" json:"track_mission_id,omitempty"`
	PrevTrackMissionId uint32 `protobuf:"varint,6,opt,name=prev_track_mission_id,json=prevTrackMissionId,proto3" json:"prev_track_mission_id,omitempty"`
...
var file_UpdateTrackMainMissionIdScRsp_proto_rawDesc = []byte{
	...
	0x64, 0x12, 0x31, 0x0a, 0x15, 0x70, 0x72, 0x65, 0x76, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x5f,
	0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d,
