...
type QuestRogue struct {
	...
	RogueArea map[uint32]*QuestRogueArea `protobuf:"bytes,1,rep,name=rogue_area,json=rogueArea,proto3" json:"rogue_area,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 关卡状态
	// CurRogue cur_rogue = 2; // 当前正在进行的
	QuestRogueHistoryList map[uint32]*QuestRogueHistory `protobuf:"bytes,3,rep,name=quest_rogue_history_list,json=questRogueHistoryList,proto3" json:"quest_rogue_history_list,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 历史领取信息/[年+周次]:2401
}
...
type QuestRogueHistory struct {
	...
	RowInfo map[uint32]bool `protobuf:"bytes,3,rep,name=row_info,json=rowInfo,proto3" json:"row_info,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` //领取奖励
}
...
type CurRogue struct {
	...
	// Types that are assignable to RogueInfo:
	//
	//	*CurRogue_QuestRogue
	RogueInfo isCurRogue_RogueInfo    `protobuf_oneof:"rogue_info"`
	Action    map[uint32]*RogueAction `protobuf:"bytes,30,rep,name=action,proto3" json:"action,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 模拟宇宙选择
}
...
func (m *CurRogue) GetRogueInfo() isCurRogue_RogueInfo {
	if m != nil {
		return m.RogueInfo
	}
	return nil
...
func (x *CurRogue) GetQuestRogue() *CurQuestRogue {
	if x, ok := x.GetRogueInfo().(*CurRogue_QuestRogue); ok {
		return x.QuestRogue
	}
	return nil
}
...
func (x *RogueAction) GetBonusSelect() *BonusSelect {
	if x, ok := x.GetAction().(*RogueAction_BonusSelect); ok {
...
func (x *RogueAction) GetBuffSelect() *BuffSelect {
	if x, ok := x.GetAction().(*RogueAction_BuffSelect); ok {
		return x.BuffSelect
	}
	return nil
}
...
type CurQuestRogue struct {
	...
	RogueRoomMap map[uint32]*RogueRoomInfo `protobuf:"bytes,3,rep,name=rogue_room_map,json=rogueRoomMap,proto3" json:"rogue_room_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 房间列表
}
...
type BonusSelect struct {
	...
	BonusIdMap map[uint32]bool `protobuf:"bytes,1,rep,name=bonus_id_map,json=bonusIdMap,proto3" json:"bonus_id_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
type BuffSelect struct {
	...
	RollBuffCost     map[uint32]uint32     `protobuf:"bytes,2,rep,name=roll_buff_cost,json=rollBuffCost,proto3" json:"roll_buff_cost,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 刷新费用
	...
	BuffMap          map[uint32]*RogueBuff `protobuf:"bytes,7,rep,name=buff_map,json=buffMap,proto3" json:"buff_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`                   // buff列表
}
...
var file_bin_server_rogue_proto_goTypes = []interface{}{
...
func file_bin_server_rogue_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_bin_server_rogue_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QuestRogue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_rogue_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QuestRogueArea); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_rogue_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QuestRogueHistory); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_rogue_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TournRogue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_rogue_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_rogue_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_rogue_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_rogue_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_rogue_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_rogue_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_rogue_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_rogue_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CurQuestRogue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_rogue_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RogueRoomInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_rogue_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BonusSelect); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_rogue_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BuffSelect); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_bin_server_rogue_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*CurRogue_QuestRogue)(nil),
	}
	file_bin_server_rogue_proto_msgTypes[9].OneofWrappers = []interface{}{
