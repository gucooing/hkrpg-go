...
type TrialActivity struct {
	...
	TrialInfoMap map[uint32]*TrialActivityInfo `protobuf:"bytes,2,rep,name=trial_info_map,json=trialInfoMap,proto3" json:"trial_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 历史角色试用
}
...
type MatchThree struct {
	...
	LevelList   map[uint32]*MatchThreeLevelMap `protobuf:"bytes,1,rep,name=level_list,json=levelList,proto3" json:"level_list,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 关卡信息 level_id
	BirdInfoMap map[uint32]*MatchThreeBirdInfo `protobuf:"bytes,2,rep,name=bird_info_map,json=birdInfoMap,proto3" json:"bird_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type MatchThreeLevelMap struct {
	...
	Level map[uint32]*MatchThreeLevel `protobuf:"bytes,1,rep,name=level,proto3" json:"level,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // mode
}
...
var file_bin_server_activity_proto_goTypes = []interface{}{
...
func file_bin_server_activity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_bin_server_activity_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_activity_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TrialActivity); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_activity_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CurTrialActivity); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_activity_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_activity_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_activity_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_activity_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_activity_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bin_server_activity_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MatchThree); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_activity_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MatchThreeLevelMap); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_activity_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MatchThreeLevel); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_bin_server_activity_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
