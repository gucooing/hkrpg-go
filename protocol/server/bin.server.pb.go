...
var file_bin_server_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x6e, 0x67, 0x65, 0x22, 0x07, 0x0a, 0x05, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x22, 0xc0,
	...
	0x61, 0x72, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x1a, 0x40, 0x0a, 0x12, 0x43, 0x68, 0x61, 0x6c, 0x6c,
	...
	0x01, 0x22, 0x0c, 0x0a, 0x0a, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x22,
...
var file_bin_server_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_bin_server_proto_goTypes = []interface{}{
	...
	(*BattleList)(nil),         // 19: proto.BattleList
	(*Gacha)(nil),              // 20: proto.Gacha
	(*GachaNum)(nil),           // 21: proto.GachaNum
	(*ContentAuditBin)(nil),    // 22: proto.ContentAuditBin
	nil,                        // 23: proto.PlayerBasicCompBin.OpenStateMapEntry
	nil,                        // 24: proto.Activity.ActivityLoginEntry
	nil,                        // 25: proto.Avatar.AvatarEntry
	nil,                        // 26: proto.AvatarBin.EquipRelicEntry
	nil,                        // 27: proto.LineUp.LineUpListEntry
	nil,                        // 28: proto.Item.RelicMapEntry
	nil,                        // 29: proto.Item.EquipmentMapEntry
	nil,                        // 30: proto.Item.MaterialMapEntry
	nil,                        // 31: proto.Challenge.ChallengeListEntry
	nil,                        // 32: proto.Challenge.ChallengeRewardListEntry
	nil,                        // 33: proto.Gacha.GachaMapEntry
	(Gender)(0),                // 34: proto.Gender
	(HeroBasicType)(0),         // 35: proto.HeroBasicType
	(ExtraLineupType)(0),       // 36: proto.ExtraLineupType
}
var file_bin_server_proto_depIdxs = []int32{
	...
	20, // 7: proto.PlayerBasicCompBin.gacha:type_name -> proto.Gacha
	16, // 8: proto.PlayerBasicCompBin.battle:type_name -> proto.Battle
	23, // 9: proto.PlayerBasicCompBin.open_state_map:type_name -> proto.PlayerBasicCompBin.OpenStateMapEntry
	22, // 10: proto.PlayerBasicCompBin.nickname_audit_bin:type_name -> proto.ContentAuditBin
	24, // 11: proto.Activity.activity_login:type_name -> proto.Activity.ActivityLoginEntry
	25, // 12: proto.Avatar.avatar:type_name -> proto.Avatar.AvatarEntry
	34, // 13: proto.Avatar.gender:type_name -> proto.Gender
	35, // 14: proto.Avatar.cur_main_avatar:type_name -> proto.HeroBasicType
	4,  // 15: proto.Avatar.hero_basic_type_info:type_name -> proto.HeroBasicTypeInfo
	35, // 16: proto.HeroBasicTypeInfo.basic_type:type_name -> proto.HeroBasicType
	...
	26, // 20: proto.AvatarBin.equip_relic:type_name -> proto.AvatarBin.EquipRelicEntry
	27, // 21: proto.LineUp.line_up_list:type_name -> proto.LineUp.LineUpListEntry
	36, // 22: proto.Line.extra_lineup_type:type_name -> proto.ExtraLineupType
	28, // 23: proto.Item.relic_map:type_name -> proto.Item.RelicMapEntry
	29, // 24: proto.Item.equipment_map:type_name -> proto.Item.EquipmentMapEntry
	30, // 25: proto.Item.material_map:type_name -> proto.Item.MaterialMapEntry
	...
	31, // 29: proto.Challenge.challenge_list:type_name -> proto.Challenge.ChallengeListEntry
	32, // 30: proto.Challenge.challenge_reward_list:type_name -> proto.Challenge.ChallengeRewardListEntry
	33, // 31: proto.Gacha.gacha_map:type_name -> proto.Gacha.GachaMapEntry
	...
	21, // 36: proto.Gacha.GachaMapEntry.value:type_name -> proto.GachaNum
