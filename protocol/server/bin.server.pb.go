...
var file_bin_server_proto_goTypes = []interface{}{
	...
	(*TutorialDb)(nil),             // 44: proto.TutorialDb
	(*TutorialInfo)(nil),           // 45: proto.TutorialInfo
	(*MessageGroup)(nil),           // 46: proto.MessageGroup
	(*MessageSection)(nil),         // 47: proto.MessageSection
	(*BlockBin)(nil),               // 48: proto.BlockBin
	(*BlockList)(nil),              // 49: proto.BlockList
	(*PropInfo)(nil),               // 50: proto.PropInfo
	nil,                            // 51: proto.PlayerBasicCompBin.OpenStateMapEntry
	nil,                            // 52: proto.PlayerBasicCompBin.MessageGroupListEntry
	nil,                            // 53: proto.Activity.ActivityLoginEntry
	nil,                            // 54: proto.Avatar.AvatarListEntry
	nil,                            // 55: proto.Avatar.BattleAvatarListEntry
	nil,                            // 56: proto.AvatarBin.MultiPathAvatarInfoListEntry
	nil,                            // 57: proto.MultiPathAvatarInfo.EquipRelicEntry
	nil,                            // 58: proto.LineUp.LineUpListEntry
	nil,                            // 59: proto.LineUp.BattleLineListEntry
	nil,                            // 60: proto.Line.AvatarIdListEntry
	nil,                            // 61: proto.Item.RelicMapEntry
	nil,                            // 62: proto.Item.EquipmentMapEntry
	nil,                            // 63: proto.Item.MaterialMapEntry
	nil,                            // 64: proto.Relic.RelicAffixEntry
	nil,                            // 65: proto.Rogue.RogueAreaEntry
	nil,                            // 66: proto.Rogue.RogueHistoryListEntry
	nil,                            // 67: proto.CurRogue.RogueRoomMapEntry
	nil,                            // 68: proto.CurRogue.BuffListEntry
	nil,                            // 69: proto.RogueTourn.InspirationCircuitInfoEntry
	nil,                            // 70: proto.CurRogueTourn.CurLayerListEntry
	nil,                            // 71: proto.LayerInfo.RogueTournRoomListEntry
	nil,                            // 72: proto.Challenge.ChallengeListEntry
	nil,                            // 73: proto.Challenge.ChallengeRewardListEntry
	nil,                            // 74: proto.Raid.RaidMapEntry
	nil,                            // 75: proto.Raid.FinishRaidMapEntry
	nil,                            // 76: proto.Gacha.GachaMapEntry
	nil,                            // 77: proto.Mail.MailListEntry
	nil,                            // 78: proto.PlayerFriend.FriendListEntry
	nil,                            // 79: proto.MainMission.MainMissionListEntry
	nil,                            // 80: proto.MainMission.SubMissionListEntry
	nil,                            // 81: proto.MainMission.FinishMainMissionListEntry
	nil,                            // 82: proto.MainMission.FinishSubMissionListEntry
	nil,                            // 83: proto.TutorialDb.TutorialEntry
	nil,                            // 84: proto.TutorialDb.TutorialGuideEntry
	nil,                            // 85: proto.MessageGroup.MessageSectionListEntry
	nil,                            // 86: proto.BlockBin.BlockListEntry
	nil,                            // 87: proto.BlockList.PropInfoEntry
	(Gender)(0),                    // 88: proto.Gender
	(ExtraLineupType)(0),           // 89: proto.ExtraLineupType
	(LineAvatarType)(0),            // 90: proto.LineAvatarType
	(BattleType)(0),                // 91: proto.BattleType
	(RogueAreaStatus)(0),           // 92: proto.RogueAreaStatus
	(RogueStatus)(0),               // 93: proto.RogueStatus
	(RoomStatus)(0),                // 94: proto.RoomStatus
	(RogueTalentStatus)(0),         // 95: proto.RogueTalentStatus
	(RogueTournLayerStatus)(0),     // 96: proto.RogueTournLayerStatus
	(RogueTournRoomStatus)(0),      // 97: proto.RogueTournRoomStatus
	(ChallengeStatus)(0),           // 98: proto.ChallengeStatus
	(RaidStatus)(0),                // 99: proto.RaidStatus
	(MissionStatus)(0),             // 100: proto.MissionStatus
	(TutorialStatus)(0),            // 101: proto.TutorialStatus
	(MessageGroupStatus)(0),        // 102: proto.MessageGroupStatus
	(MessageSectionStatus)(0),      // 103: proto.MessageSectionStatus
}
var file_bin_server_proto_depIdxs = []int32{
	...
	51,  // 9: proto.PlayerBasicCompBin.open_state_map:type_name -> proto.PlayerBasicCompBin.OpenStateMapEntry
	...
	44,  // 12: proto.PlayerBasicCompBin.tutorial:type_name -> proto.TutorialDb
	52,  // 13: proto.PlayerBasicCompBin.message_group_list:type_name -> proto.PlayerBasicCompBin.MessageGroupListEntry
	...
	53,  // 16: proto.Activity.activity_login:type_name -> proto.Activity.ActivityLoginEntry
	54,  // 17: proto.Avatar.avatar_list:type_name -> proto.Avatar.AvatarListEntry
	88,  // 18: proto.Avatar.gender:type_name -> proto.Gender
	55,  // 19: proto.Avatar.battle_avatar_list:type_name -> proto.Avatar.BattleAvatarListEntry
	6,   // 20: proto.AvatarBin.sp_bar:type_name -> proto.AvatarSpBarInfo
	56,  // 21: proto.AvatarBin.multi_path_avatar_info_list:type_name -> proto.AvatarBin.MultiPathAvatarInfoListEntry
	7,   // 22: proto.MultiPathAvatarInfo.skilltree_list:type_name -> proto.AvatarSkillBin
	57,  // 23: proto.MultiPathAvatarInfo.equip_relic:type_name -> proto.MultiPathAvatarInfo.EquipRelicEntry
	58,  // 24: proto.LineUp.line_up_list:type_name -> proto.LineUp.LineUpListEntry
	59,  // 25: proto.LineUp.battle_line_list:type_name -> proto.LineUp.BattleLineListEntry
	60,  // 26: proto.Line.avatar_id_list:type_name -> proto.Line.AvatarIdListEntry
	89,  // 27: proto.Line.line_type:type_name -> proto.ExtraLineupType
	90,  // 28: proto.LineAvatarList.line_avatar_type:type_name -> proto.LineAvatarType
	61,  // 29: proto.Item.relic_map:type_name -> proto.Item.RelicMapEntry
	62,  // 30: proto.Item.equipment_map:type_name -> proto.Item.EquipmentMapEntry
	63,  // 31: proto.Item.material_map:type_name -> proto.Item.MaterialMapEntry
	64,  // 32: proto.Relic.relic_affix:type_name -> proto.Relic.RelicAffixEntry
	91,  // 33: proto.Battle.battle_type:type_name -> proto.BattleType
	...
	65,  // 38: proto.Rogue.rogue_area:type_name -> proto.Rogue.RogueAreaEntry
	20,  // 39: proto.Rogue.cur_rogue:type_name -> proto.CurRogue
	66,  // 40: proto.Rogue.rogue_history_list:type_name -> proto.Rogue.RogueHistoryListEntry
	92,  // 41: proto.RogueArea.rogue_area_status:type_name -> proto.RogueAreaStatus
	67,  // 42: proto.CurRogue.rogue_room_map:type_name -> proto.CurRogue.RogueRoomMapEntry
	68,  // 43: proto.CurRogue.buff_list:type_name -> proto.CurRogue.BuffListEntry
	93,  // 44: proto.CurRogue.status:type_name -> proto.RogueStatus
	94,  // 45: proto.RogueRoom.room_status:type_name -> proto.RoomStatus
	69,  // 46: proto.RogueTourn.inspiration_circuit_info:type_name -> proto.RogueTourn.InspirationCircuitInfoEntry
	26,  // 47: proto.RogueTourn.cur_rogue_tourn:type_name -> proto.CurRogueTourn
	95,  // 48: proto.InspirationCircuitInfo.status:type_name -> proto.RogueTalentStatus
	70,  // 49: proto.CurRogueTourn.cur_layer_list:type_name -> proto.CurRogueTourn.CurLayerListEntry
	96,  // 50: proto.LayerInfo.status:type_name -> proto.RogueTournLayerStatus
	71,  // 51: proto.LayerInfo.rogue_tourn_room_list:type_name -> proto.LayerInfo.RogueTournRoomListEntry
	97,  // 52: proto.RogueTournRoomInfo.status:type_name -> proto.RogueTournRoomStatus
	72,  // 53: proto.Challenge.challenge_list:type_name -> proto.Challenge.ChallengeListEntry
	73,  // 54: proto.Challenge.challenge_reward_list:type_name -> proto.Challenge.ChallengeRewardListEntry
	31,  // 55: proto.Challenge.cur_challenge:type_name -> proto.CurChallenge
	98,  // 56: proto.CurChallenge.status:type_name -> proto.ChallengeStatus
	74,  // 57: proto.Raid.raid_map:type_name -> proto.Raid.RaidMapEntry
	75,  // 58: proto.Raid.finish_raid_map:type_name -> proto.Raid.FinishRaidMapEntry
	99,  // 59: proto.RaidInfo.status:type_name -> proto.RaidStatus
	8,   // 60: proto.RaidInfo.pos:type_name -> proto.VectorBin
	8,   // 61: proto.RaidInfo.rot:type_name -> proto.VectorBin
	76,  // 62: proto.Gacha.gacha_map:type_name -> proto.Gacha.GachaMapEntry
	77,  // 63: proto.Mail.MailList:type_name -> proto.Mail.MailListEntry
	78,  // 64: proto.PlayerFriend.friend_list:type_name -> proto.PlayerFriend.FriendListEntry
	42,  // 65: proto.Mission.main_mission:type_name -> proto.MainMission
	79,  // 66: proto.MainMission.main_mission_list:type_name -> proto.MainMission.MainMissionListEntry
	80,  // 67: proto.MainMission.sub_mission_list:type_name -> proto.MainMission.SubMissionListEntry
	81,  // 68: proto.MainMission.finish_main_mission_list:type_name -> proto.MainMission.FinishMainMissionListEntry
	82,  // 69: proto.MainMission.finish_sub_mission_list:type_name -> proto.MainMission.FinishSubMissionListEntry
	100, // 70: proto.MissionInfo.status:type_name -> proto.MissionStatus
	83,  // 71: proto.TutorialDb.Tutorial:type_name -> proto.TutorialDb.TutorialEntry
	84,  // 72: proto.TutorialDb.TutorialGuide:type_name -> proto.TutorialDb.TutorialGuideEntry
	101, // 73: proto.TutorialInfo.status:type_name -> proto.TutorialStatus
	85,  // 74: proto.MessageGroup.message_section_list:type_name -> proto.MessageGroup.MessageSectionListEntry
	102, // 75: proto.MessageGroup.status:type_name -> proto.MessageGroupStatus
	103, // 76: proto.MessageSection.status:type_name -> proto.MessageSectionStatus
	86,  // 77: proto.BlockBin.block_list:type_name -> proto.BlockBin.BlockListEntry
	87,  // 78: proto.BlockList.prop_info:type_name -> proto.BlockList.PropInfoEntry
	46,  // 79: proto.PlayerBasicCompBin.MessageGroupListEntry.value:type_name -> proto.MessageGroup
	4,   // 80: proto.Avatar.AvatarListEntry.value:type_name -> proto.AvatarBin
	4,   // 81: proto.Avatar.BattleAvatarListEntry.value:type_name -> proto.AvatarBin
	5,   // 82: proto.AvatarBin.MultiPathAvatarInfoListEntry.value:type_name -> proto.MultiPathAvatarInfo
	10,  // 83: proto.LineUp.LineUpListEntry.value:type_name -> proto.Line
	10,  // 84: proto.LineUp.BattleLineListEntry.value:type_name -> proto.Line
	11,  // 85: proto.Line.AvatarIdListEntry.value:type_name -> proto.LineAvatarList
	13,  // 86: proto.Item.RelicMapEntry.value:type_name -> proto.Relic
	15,  // 87: proto.Item.EquipmentMapEntry.value:type_name -> proto.Equipment
	14,  // 88: proto.Relic.RelicAffixEntry.value:type_name -> proto.RelicAffix
	19,  // 89: proto.Rogue.RogueAreaEntry.value:type_name -> proto.RogueArea
	23,  // 90: proto.Rogue.RogueHistoryListEntry.value:type_name -> proto.RogueHistory
	21,  // 91: proto.CurRogue.RogueRoomMapEntry.value:type_name -> proto.RogueRoom
	22,  // 92: proto.CurRogue.BuffListEntry.value:type_name -> proto.RogueBuff
	25,  // 93: proto.RogueTourn.InspirationCircuitInfoEntry.value:type_name -> proto.InspirationCircuitInfo
	27,  // 94: proto.CurRogueTourn.CurLayerListEntry.value:type_name -> proto.LayerInfo
	28,  // 95: proto.LayerInfo.RogueTournRoomListEntry.value:type_name -> proto.RogueTournRoomInfo
	30,  // 96: proto.Challenge.ChallengeListEntry.value:type_name -> proto.ChallengeList
	33,  // 97: proto.Raid.RaidMapEntry.value:type_name -> proto.RaidInfo
	33,  // 98: proto.Raid.FinishRaidMapEntry.value:type_name -> proto.RaidInfo
	35,  // 99: proto.Gacha.GachaMapEntry.value:type_name -> proto.GachaNum
	38,  // 100: proto.Mail.MailListEntry.value:type_name -> proto.MailDts
	40,  // 101: proto.PlayerFriend.FriendListEntry.value:type_name -> proto.Friend
	43,  // 102: proto.MainMission.MainMissionListEntry.value:type_name -> proto.MissionInfo
	43,  // 103: proto.MainMission.SubMissionListEntry.value:type_name -> proto.MissionInfo
	43,  // 104: proto.MainMission.FinishMainMissionListEntry.value:type_name -> proto.MissionInfo
	43,  // 105: proto.MainMission.FinishSubMissionListEntry.value:type_name -> proto.MissionInfo
	45,  // 106: proto.TutorialDb.TutorialEntry.value:type_name -> proto.TutorialInfo
	45,  // 107: proto.TutorialDb.TutorialGuideEntry.value:type_name -> proto.TutorialInfo
	47,  // 108: proto.MessageGroup.MessageSectionListEntry.value:type_name -> proto.MessageSection
	49,  // 109: proto.BlockBin.BlockListEntry.value:type_name -> proto.BlockList
	50,  // 110: proto.BlockList.PropInfoEntry.value:type_name -> proto.PropInfo
