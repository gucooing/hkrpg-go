...
func file_common_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_server_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_server_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_server_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GmMission); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
