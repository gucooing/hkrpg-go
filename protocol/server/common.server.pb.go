...
type GmGetServiceStateReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GmGetServiceStateReq) Reset() {
	*x = GmGetServiceStateReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *GmGetServiceStateReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GmGetServiceStateReq) ProtoMessage() {}

func (x *GmGetServiceStateReq) ProtoReflect() protoreflect.Message {
	mi := &file_common_server_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GmGetServiceStateReq.ProtoReflect.Descriptor instead.
func (*GmGetServiceStateReq) Descriptor() ([]byte, []int) {
	return file_common_server_proto_rawDescGZIP(), []int{2}
}

type GmGetServiceStateRsp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GmGetServiceStateRsp) Reset() {
	*x = GmGetServiceStateRsp{}
	if protoimpl.UnsafeEnabled {
...
func (x *GmGetServiceStateRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GmGetServiceStateRsp) ProtoMessage() {}

func (x *GmGetServiceStateRsp) ProtoReflect() protoreflect.Message {
	mi := &file_common_server_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GmGetServiceStateRsp.ProtoReflect.Descriptor instead.
func (*GmGetServiceStateRsp) Descriptor() ([]byte, []int) {
...
var file_common_server_proto_rawDesc = []byte{
	...
	0x6c, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x6d, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x6d, 0x47,
	0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x73,
...
var file_common_server_proto_goTypes = []interface{}{
	...
	(*GmGetServiceStateReq)(nil), // 2: GmGetServiceStateReq
	(*GmGetServiceStateRsp)(nil), // 3: GmGetServiceStateRsp
}
...
func file_common_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_server_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GmGetServiceStateReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_server_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GmGetServiceStateRsp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
