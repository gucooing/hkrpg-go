...
const (
	...
	PlayerStatus_PlayerStatus_PostLogin      PlayerStatus = 2 // 登录后
	PlayerStatus_PlayerStatus_Offline        PlayerStatus = 3 // 登录后主动离线
	PlayerStatus_PlayerStatus_PassiveOffline PlayerStatus = 4 // 登录后被动离线
	PlayerStatus_PlayerStatus_RepeatLogin    PlayerStatus = 5 // 登录踢下线
)
...
var (
	PlayerStatus_name = map[int32]string{
		...
		3: "PlayerStatus_Offline",
		4: "PlayerStatus_PassiveOffline",
		5: "PlayerStatus_RepeatLogin",
	}
	PlayerStatus_value = map[string]int32{
		"PlayerStatus_PreLogin":       0,
		"PlayerStatus_LoggingIn":      1,
		"PlayerStatus_PostLogin":      2,
		"PlayerStatus_Offline":        3,
		"PlayerStatus_PassiveOffline": 4,
		"PlayerStatus_RepeatLogin":    5,
	}
)
...
type PlayerGateStatus int32

const (
	PlayerGateStatus_PlayerGateStatus_None           PlayerGateStatus = 0
	PlayerGateStatus_PlayerGateStatus_GateLogin      PlayerGateStatus = 1 // 登录gate中
	PlayerGateStatus_PlayerGateStatus_GatePlaying    PlayerGateStatus = 2 // 已登录gate
	PlayerGateStatus_PlayerGateStatus_GateWaitLogout PlayerGateStatus = 3 // 离线gate中
	PlayerGateStatus_PlayerGateStatus_GateLogout     PlayerGateStatus = 4 // 离线gate
)

// Enum value maps for PlayerGateStatus.
var (
	PlayerGateStatus_name = map[int32]string{
		0: "PlayerGateStatus_None",
		1: "PlayerGateStatus_GateLogin",
		2: "PlayerGateStatus_GatePlaying",
		3: "PlayerGateStatus_GateWaitLogout",
		4: "PlayerGateStatus_GateLogout",
	}
	PlayerGateStatus_value = map[string]int32{
		"PlayerGateStatus_None":           0,
		"PlayerGateStatus_GateLogin":      1,
		"PlayerGateStatus_GatePlaying":    2,
		"PlayerGateStatus_GateWaitLogout": 3,
		"PlayerGateStatus_GateLogout":     4,
	}
)

func (x PlayerGateStatus) Enum() *PlayerGateStatus {
	p := new(PlayerGateStatus)
	*p = x
	return p
}

func (x PlayerGateStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PlayerGateStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_enum_server_proto_enumTypes[9].Descriptor()
}

func (PlayerGateStatus) Type() protoreflect.EnumType {
	return &file_enum_server_proto_enumTypes[9]
}

func (x PlayerGateStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PlayerGateStatus.Descriptor instead.
func (PlayerGateStatus) EnumDescriptor() ([]byte, []int) {
...
const (
	PlayerGameStatus_PlayerGameStatus_None           PlayerGameStatus = 0
	PlayerGameStatus_PlayerGameStatus_GameLogin      PlayerGameStatus = 1 // 登录game中
	PlayerGameStatus_PlayerGameStatus_GamePlaying    PlayerGameStatus = 2 // 已登录game
	PlayerGameStatus_PlayerGameStatus_GameWaitLogout PlayerGameStatus = 3 // 离线game中
	PlayerGameStatus_PlayerGameStatus_GameLogout     PlayerGameStatus = 4 // 离线game
)

// Enum value maps for PlayerGameStatus.
var (
	PlayerGameStatus_name = map[int32]string{
		0: "PlayerGameStatus_None",
		1: "PlayerGameStatus_GameLogin",
		2: "PlayerGameStatus_GamePlaying",
		3: "PlayerGameStatus_GameWaitLogout",
		4: "PlayerGameStatus_GameLogout",
	}
	PlayerGameStatus_value = map[string]int32{
		"PlayerGameStatus_None":           0,
		"PlayerGameStatus_GameLogin":      1,
		"PlayerGameStatus_GamePlaying":    2,
		"PlayerGameStatus_GameWaitLogout": 3,
		"PlayerGameStatus_GameLogout":     4,
	}
)
...
const (
	PlayerOfflineReason_OFFLINE_NONE         PlayerOfflineReason = 0
	PlayerOfflineReason_OFFLINE_GAME_ERROR   PlayerOfflineReason = 1
	PlayerOfflineReason_OFFLINE_DRIVING      PlayerOfflineReason = 2
	PlayerOfflineReason_OFFLINE_TIMEOUT      PlayerOfflineReason = 3
	PlayerOfflineReason_OFFLINE_REPEAT_LOGIN PlayerOfflineReason = 4
	PlayerOfflineReason_OFFLINE_GATE_GS      PlayerOfflineReason = 5
	PlayerOfflineReason_OFFLINE_GATE_ERROR   PlayerOfflineReason = 6
)
...
var (
	PlayerOfflineReason_name = map[int32]string{
		...
		2: "OFFLINE_DRIVING",
		3: "OFFLINE_TIMEOUT",
		4: "OFFLINE_REPEAT_LOGIN",
		5: "OFFLINE_GATE_GS",
		6: "OFFLINE_GATE_ERROR",
	}
	PlayerOfflineReason_value = map[string]int32{
		...
		"OFFLINE_DRIVING":      2,
		"OFFLINE_TIMEOUT":      3,
		"OFFLINE_REPEAT_LOGIN": 4,
		"OFFLINE_GATE_GS":      5,
		"OFFLINE_GATE_ERROR":   6,
	}
)
...
var file_enum_server_proto_rawDesc = []byte{
	...
	0x43, 0x45, 0x5f, 0x4d, 0x55, 0x49, 0x50, 0x10, 0x06, 0x2a, 0xba, 0x01, 0x0a, 0x0c, 0x50, 0x6c,
	...
	,
	...
	0x49, 0x53, 0x48, 0x10, 0x04, 0x2a, 0x40, 0x0a, 0x07, 0x52, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65,
	...
	0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x70, 0x72,
...
var file_enum_server_proto_enumTypes = make([]protoimpl.EnumInfo, 15)
var file_enum_server_proto_goTypes = []interface{}{
	...
	(PlayerGateStatus)(0),    // 9: proto.PlayerGateStatus
	(PlayerGameStatus)(0),    // 10: proto.PlayerGameStatus
	(PlayerOfflineReason)(0), // 11: proto.PlayerOfflineReason
	(RogueAreaStatus)(0),     // 12: proto.RogueAreaStatus
	(RoomStatus)(0),          // 13: proto.RoomStatus
	(Retcode)(0),             // 14: proto.Retcode
}
